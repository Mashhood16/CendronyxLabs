...
export const LAB_MODULES = [
  ...
  { id: 'p11_deriv_doppler_source_away', classLevel: '11', subject: 'physics', title: 'Derivation: Doppler Effect (Source Moving Away)', desc: 'Apparent frequency when source moves away from listener: f\' = v/(v + v_S) × f', built: true, bg: 'from-red-500 to-rose-600' },
  ...
  { id: 'p11_deriv_dirac_momentum', classLevel: '11', subject: 'physics', title: 'Derivation: Dirac Momentum from Energy-Momentum Relation', desc: 'Relativistic momentum from Einstein\'s energy relation: p = âˆš(E² - m²câ´)/c', built: true, bg: 'from-indigo-500 to-purple-600' },
  ...
  { id: 'm10_theorem_quadratic_formula', classLevel: '10', subject: 'math', title: 'Theorem: Quadratic Formula', desc: 'Derive x = [âˆ’b ± âˆš(b²âˆ’4ac)]/2a with an interactive parabolic arch simulation.', built: true, bg: 'from-blue-500 to-indigo-600' },
  ...
  { id: 'm10_theorem_law_cosines', classLevel: '10', subject: 'math', title: 'Theorem: Law of Cosines', desc: 'Prove a² = b² + c² âˆ’ 2bc cos Î± with an interactive land surveyor simulation.', built: true, bg: 'from-rose-500 to-red-600' },
  ...
  { id: 'm10_theorem_area_sas', classLevel: '10', subject: 'math', title: 'Theorem: Area of Triangle (SAS)', desc: 'Prove Î” = ½ bc sin Î± with an interactive surveyor plot simulation.', built: true, bg: 'from-violet-500 to-purple-700' },
  { id: 'm10_theorem_area_aas', classLevel: '10', subject: 'math', title: 'Theorem: Area of Triangle (AAS)', desc: 'Prove Î” = ½ a² sin Î² sin Î³ / sin Î± for mountain profile measurements.', built: true, bg: 'from-violet-600 to-fuchsia-700' },
