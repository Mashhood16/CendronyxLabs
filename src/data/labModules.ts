...
export const LAB_MODULES = [
  ...
  { id: 'c8c_3_2', classLevel: '8', subject: 'computer', title: 'Act 3.2: Dice Algorithm', desc: 'Implement and execute a turn-based loop with conditional rules.', built: true, bg: 'from-indigo-800 to-indigo-900' },
  ...
  { id: 'c8c_6_1', classLevel: '8', subject: 'computer', title: 'Act 6.1: Business Plan', desc: 'Draft your startup pitch deck and present it to partners.', built: true, bg: 'from-indigo-600 to-fuchsia-700' },
  ...
  { id: 'c8s_3_1', classLevel: '8', subject: 'science', title: 'Act 3.1: DNA Extraction', desc: 'Extract visible DNA strands from a strawberry.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'c8s_3_2', classLevel: '8', subject: 'science', title: 'Act 3.2: Human Variations', desc: 'Sort traits by their variation type.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  ...
  { id: 'c8s_5_4', classLevel: '8', subject: 'science', title: 'Act 5.4: Flexibility', desc: 'Test flexibility and brittleness of materials.', built: true, bg: 'from-violet-500 to-indigo-600' },
  ...
  { id: 'c8s_7_3', classLevel: '8', subject: 'science', title: 'Act 7.3: Neutralization', desc: 'Mix acid and alkali to create salt and water.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'c8s_9_3', classLevel: '8', subject: 'science', title: 'Act 9.3: Periscope', desc: 'See over obstacles using two 45 degree mirrors.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  ...
  { id: 'c8s_9_5', classLevel: '8', subject: 'science', title: 'Act 9.5: Concave Mirror', desc: 'Observe focal point and magnification in a shaving mirror.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'c7c_1_2', classLevel: '7', subject: 'computer', title: 'Act 1.2: Emerging Tech', desc: 'Present an emerging technology mini-project.', built: true, bg: 'from-indigo-600 to-indigo-800' },
  { id: 'c7c_1_3', classLevel: '7', subject: 'computer', title: 'Act 1.3: Generations', desc: 'Map out the generations of computers over time.', built: true, bg: 'from-indigo-600 to-fuchsia-800' },
  ...
  { id: 'c7c_5_1', classLevel: '7', subject: 'computer', title: 'Act 5.1: Cybercrime Pres', desc: 'Prepare a presentation on a movie about cybercrime.', built: true, bg: 'from-indigo-600 to-indigo-800' },
  ...
  { id: 'c7s_3_1', classLevel: '7', subject: 'science', title: 'Act 3.1: Immune Roleplay', desc: 'Simulate pathogens attacking white blood cells.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'c7s_3_2', classLevel: '7', subject: 'science', title: 'Unit 3: Immunity Projects', desc: 'Design health campaigns and infographics.', built: true, bg: 'from-indigo-600 to-indigo-700' },
  ...
  { id: 'c7s_7_3', classLevel: '7', subject: 'science', title: 'Act 7.3: Rock Candy', desc: 'Observe crystallization in a supersaturated solution.', built: true, bg: 'from-fuchsia-500 to-indigo-600' },
  ...
  { id: 'c7s_9_1', classLevel: '7', subject: 'science', title: 'Act 9.1: Pitch & Length', desc: 'Pluck a rubber band at different lengths.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  { id: 'c7s_9_2', classLevel: '7', subject: 'science', title: 'Unit 9: Waves Projects', desc: 'Build a custom rubber band instrument.', built: true, bg: 'from-indigo-600 to-fuchsia-700' },
  ...
  { id: 'c7s_12_1', classLevel: '7', subject: 'science', title: 'Act 12.1: Earth Seasons', desc: 'Observe how axial tilt causes the seasons.', built: true, bg: 'from-indigo-600 to-indigo-800' },
  ...
  { id: 'c6s_5_1', classLevel: '6', subject: 'science', title: 'Unit 5: Particle Models', desc: 'Simulate dissolving sugar and diffusing gases.', built: true, bg: 'from-fuchsia-500 to-indigo-600' },
  { id: 'c6s_6_1', classLevel: '6', subject: 'science', title: 'Unit 6: Molecular Builder', desc: 'Construct 3D molecular models of H2O, CO2, and CH4.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  ...
  { id: 'c6c_2_2', classLevel: '6', subject: 'computer', title: 'Act 2.2: File Mgmt 1', desc: 'Create, copy, and rename folders.', built: true, bg: 'from-indigo-500 to-indigo-700' },
  { id: 'c6c_2_3', classLevel: '6', subject: 'computer', title: 'Act 2.3: File Mgmt 2', desc: 'Create files and recover from Recycle Bin.', built: true, bg: 'from-indigo-500 to-fuchsia-700' },
  ...
  { id: 'm6_4', classLevel: '6', subject: 'math', title: 'Unit 4: Set Theory', desc: 'Organize biological groups in Venn diagrams.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'm7_4', classLevel: '7', subject: 'math', title: 'Unit 5 & 6: Sets & Algebra', desc: 'Organize Venn diagrams and deduce pattern rules.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'm8_4', classLevel: '8', subject: 'math', title: 'Unit 7: Equations & Inequalities', desc: 'Optimize business costs visually with linear graphs.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'p10_deriv_specific_heat_mixtures', classLevel: '10', subject: 'physics', title: 'Derivation: Specific Heat (Mixtures)', desc: 'Step-by-step derivation of c_s using the method of mixtures calorimetry.', built: true, bg: 'from-orange-500 to-red-600' },
  { id: 'p10_deriv_specific_heat_electrical', classLevel: '10', subject: 'physics', title: 'Derivation: Specific Heat (Electrical)', desc: 'Derive c_l = (VIt - m_c c_c dT) / (m_l dT) using electrical heating.', built: true, bg: 'from-violet-500 to-purple-600' },
  { id: 'p10_deriv_linear_expansion', classLevel: '10', subject: 'physics', title: 'Derivation: Linear Expansion', desc: 'Derive alpha = dL/(L_o dT) for solids with interactive rod expansion.', built: true, bg: 'from-red-500 to-orange-600' },
  { id: 'p10_deriv_volumetric_expansion', classLevel: '10', subject: 'physics', title: 'Derivation: Volumetric Expansion', desc: 'Derive beta = dV/(V_o dT) and the relation beta = 3alpha.', built: true, bg: 'from-rose-500 to-pink-600' },
  { id: 'p10_deriv_expansion_liquids', classLevel: '10', subject: 'physics', title: 'Derivation: Real vs Apparent Expansion', desc: 'Understand gamma_r = gamma_a + gamma_g for liquid expansion in containers.', built: true, bg: 'from-teal-500 to-emerald-600' },
  { id: 'p10_deriv_wave_equation', classLevel: '10', subject: 'physics', title: 'Derivation: Wave Equation v = f\u03BB', desc: 'Derive the universal wave equation from basic speed formula v = d/t.', built: true, bg: 'from-cyan-500 to-blue-600' },
  { id: 'p10_deriv_echo', classLevel: '10', subject: 'physics', title: 'Derivation: Echo/Ultrasound Depth', desc: 'Derive d = vt/2 from the basic speed formula for echo ranging.', built: true, bg: 'from-sky-500 to-blue-600' },
  { id: 'p10_deriv_critical_angle', classLevel: '10', subject: 'physics', title: 'Derivation: Critical Angle', desc: 'Derive theta_c = sin^-1(n2/n1) from Snell law for total internal reflection.', built: true, bg: 'from-fuchsia-500 to-purple-600' },
  { id: 'p10_deriv_magnification', classLevel: '10', subject: 'physics', title: 'Derivation: Linear Magnification', desc: 'Derive M = I/O = q/p from ray diagram similar triangles.', built: true, bg: 'from-green-500 to-emerald-600' },
  { id: 'p10_deriv_resistivity', classLevel: '10', subject: 'physics', title: 'Derivation: Resistivity', desc: 'Derive rho = RA/L from the relationship between resistance and geometry.', built: true, bg: 'from-amber-500 to-orange-600' },
  { id: 'p10_deriv_temp_coefficient', classLevel: '10', subject: 'physics', title: 'Derivation: Temp Coefficient of Resistivity', desc: 'Derive alpha = (rho_T - rho_0) / (rho_0 dT) for temperature effects.', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p10_deriv_potential_divider', classLevel: '10', subject: 'physics', title: 'Derivation: Potential Divider', desc: 'Derive V_out = R2/(R1+R2) * V_in using Ohm law and series circuits.', built: true, bg: 'from-lime-500 to-green-600' },
  { id: 'p10_deriv_series_resistance', classLevel: '10', subject: 'physics', title: 'Derivation: Series Resistance', desc: 'Derive R_eq = R1 + R2 + R3 from conservation of voltage.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p10_deriv_parallel_resistance', classLevel: '10', subject: 'physics', title: 'Derivation: Parallel Resistance', desc: 'Derive 1/R_eq = 1/R1 + 1/R2 + 1/R3 from conservation of current.', built: true, bg: 'from-purple-500 to-violet-600' },
  { id: 'p10_deriv_electrical_energy', classLevel: '10', subject: 'physics', title: 'Derivation: Electrical Energy', desc: 'Derive E = IVt = I^2Rt = V^2t/R from potential difference and Ohm law.', built: true, bg: 'from-indigo-500 to-blue-600' },
  { id: 'p10_deriv_electric_power', classLevel: '10', subject: 'physics', title: 'Derivation: Electric Power', desc: 'Derive P = IV = I^2R = V^2/R from energy and time.', built: true, bg: 'from-pink-500 to-rose-600' },
  { id: 'p10_deriv_transistor_gain', classLevel: '10', subject: 'physics', title: 'Derivation: Transistor Gain', desc: 'Derive beta = I_C/I_B and alpha = I_C/I_E from transistor current relations.', built: true, bg: 'from-stone-500 to-zinc-600' },
  { id: 'p10_deriv_transformer', classLevel: '10', subject: 'physics', title: 'Derivation: Transformer Power', desc: 'Derive I_p V_p = I_s V_s from conservation of power in ideal transformers.', built: true, bg: 'from-slate-500 to-zinc-600' },
  { id: 'p10_deriv_photon_energy', classLevel: '10', subject: 'physics', title: 'Derivation: Photon Energy & Momentum', desc: 'Derive E = hf = hc/lambda and p = h/lambda from Planck equation.', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p10_deriv_radioactive_decay', classLevel: '10', subject: 'physics', title: 'Derivation: Radioactive Decay', desc: 'Derive N = N_0/2^n from the half-life pattern of exponential decay.', built: true, bg: 'from-emerald-500 to-green-600' },
  ...
  { id: 'p10_10_3', classLevel: '10', subject: 'physics', title: 'Unit 10: Specific Heat (Electrical)', desc: 'Calculate heat energy using an immersion heater in an insulated metal block.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'p10_10_5', classLevel: '10', subject: 'physics', title: 'Unit 10: Convection Currents', desc: 'Observe a colored stream of potassium permanganate travel upward as water is heated.', built: true, bg: 'from-violet-500 to-indigo-600' },
  ...
  { id: 'p10_13_1', classLevel: '10', subject: 'physics', title: 'Unit 13: Sound Production', desc: 'Strike a tuning fork and touch it to water to visualize physical vibrations.', built: true, bg: 'from-indigo-500 to-indigo-700' },
  ...
  { id: 'p10_13_4', classLevel: '10', subject: 'physics', title: 'Unit 13: Speaker Project', desc: 'Wrap a wire coil around a cup and add a magnet to play music.', built: true, bg: 'from-indigo-600 to-fuchsia-800' },
  ...
  { id: 'p10_17_2', classLevel: '10', subject: 'physics', title: 'Unit 17: Electromagnetism', desc: 'Observe how a current-carrying wire behaves in a magnetic field.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  ...
  { id: 'c10_6_4', classLevel: '10', subject: 'chemistry', title: 'Unit 6: Salt via Excess Carbonate', desc: 'Prepare CaCl2 from Calcium Carbonate and HCl.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  { id: 'c10_7_1', classLevel: '10', subject: 'chemistry', title: 'Unit 7: Metal Reactivity', desc: 'Compare reactivity of Mg, Zn, Fe, and Cu with HCl.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'c10_5_2', classLevel: '10', subject: 'chemistry', title: 'Unit 5: Concentration Kinetics', desc: 'Effect of concentration on antacid neutralization rate.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  
  { id: 'c10_8_1', classLevel: '10', subject: 'chemistry', title: 'Unit 8: Esterification', desc: 'React an alcohol with a carboxylic acid to produce a fruity ester.', built: true, bg: 'from-fuchsia-500 to-indigo-600' },
  ...
  { id: 'c10_12_2', classLevel: '10', subject: 'chemistry', title: 'Unit 12: Condensation Polymerisation', desc: 'React diol with dicarboxylic acid to form PET.', built: true, bg: 'from-violet-500 to-indigo-600' },
  ...
  { id: 'cs10_4_1', classLevel: '10', subject: 'computer', title: 'Unit 4: Data Visualization', desc: 'Clean datasets, calculate mean/median, and render interactive charts.', built: true, bg: 'from-indigo-600 to-fuchsia-800' },
  ...
  { id: 'm10_7_1', classLevel: '10', subject: 'math', title: 'Unit 7: Vectors in Plane', desc: 'Categorize physical measurements into Scalar and Vector quantities.', built: true, bg: 'from-indigo-600 to-indigo-800' },
  ...
  { id: 'm10_11_3', classLevel: '10', subject: 'math', title: 'Unit 11: Common Tangents', desc: 'Draft direct and transverse common tangents for multi-circle systems.', built: true, bg: 'from-violet-600 to-indigo-800' },
  ...
  { id: 'm10_app_4', classLevel: '10', subject: 'math', title: 'Unit 4: Inequality Apps', desc: 'Graph feasible regions for budgeting and absolute deviation limits.', built: true, bg: 'from-indigo-600 to-fuchsia-800' },
  ...
  { id: 'b10_4', classLevel: '10', subject: 'biology', title: 'Unit 4: Urinary System', desc: 'Dissect a virtual goat kidney to identify the cortex, medulla, and pelvis.', built: true, bg: 'from-fuchsia-600 to-indigo-800' },
  ...
  { id: 'b9_6', classLevel: '9', subject: 'biology', title: 'Unit 6: Biochemistry', desc: 'Use reagents to test for proteins, lipids, and carbohydrates.', built: true, bg: 'from-indigo-600 to-fuchsia-800' },
  ...
  { id: 'c9_3', classLevel: '9', subject: 'chemistry', title: 'Unit 7-8: Electrochemistry', desc: 'Perform KMnO4 redox titrations and track exothermic temperature changes.', built: true, bg: 'from-indigo-600 to-fuchsia-800' },
  ...
  { id: 'p9_deriv_force_momentum', classLevel: '9', subject: 'physics', title: 'Derivation: Force & Momentum', desc: 'Step-by-step derivation of F = \u0394p/\u0394t from Newton\'s Second Law with interactive sliders.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p9_deriv_recoil', classLevel: '9', subject: 'physics', title: 'Derivation: Recoil Velocity', desc: 'Interactive derivation of vg = -(mb\u00d7vb)/mg using conservation of momentum.', built: true, bg: 'from-amber-500 to-orange-600' },
  { id: 'p9_deriv_orbital', classLevel: '9', subject: 'physics', title: 'Derivation: Orbital Speed', desc: 'Derive v = 2\u03c0r/T for satellites with an animated orbital simulator.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'p9_deriv_liquid_pressure', classLevel: '9', subject: 'physics', title: 'Derivation: Liquid Pressure', desc: 'Derive P = \u03c1gh with an interactive water tank and pressure gauge.', built: true, bg: 'from-cyan-500 to-blue-600' },
  { id: 'p9_deriv_hydraulic', classLevel: '9', subject: 'physics', title: 'Derivation: Hydraulic Lift', desc: 'Derive F\u2082 = (A\u2082/A\u2081)\u00d7F\u2081 with animated pistons and force visualization.', built: true, bg: 'from-rose-500 to-red-600' },
  { id: 'p9_deriv_ke', classLevel: '9', subject: 'physics', title: 'Derivation: Kinetic Energy', desc: 'Derive E\u2096 = \u00bdmv\u00b2 with energy bar visualization and the v\u00b2 effect.', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p9_deriv_gpe', classLevel: '9', subject: 'physics', title: 'Derivation: Gravitational PE', desc: 'Derive E\u209A = mgh with a lifting animation and height markers.', built: true, bg: 'from-emerald-500 to-teal-600' },
  ...
  { id: 'p9_7', classLevel: '9', subject: 'physics', title: 'Unit 5: Springs', desc: 'Hang multiple spring balances in series to observe force readings.', built: true, bg: 'from-violet-600 to-indigo-800' },
  ...
  { id: 'cs9_1', classLevel: '9', subject: 'computer', title: 'Unit 1: Computer Systems', desc: 'Assemble hardware components and assign roles in the OSI Model.', built: true, bg: 'from-slate-700 to-gray-900' },
  { id: 'cs9_2', classLevel: '9', subject: 'computer', title: 'Unit 2: Algorithms', desc: 'Build logic flowcharts and IPO charts to solve computational problems.', built: true, bg: 'from-blue-700 to-indigo-900' },
  { id: 'cs9_3', classLevel: '9', subject: 'computer', title: 'Unit 3: Web Basics', desc: 'Write HTML/CSS to build lists and tables with a live browser preview.', built: true, bg: 'from-emerald-700 to-teal-900' },
  { id: 'cs9_4', classLevel: '9', subject: 'computer', title: 'Unit 3: JavaScript', desc: 'Write JavaScript grading logic and run it against an automated test suite.', built: true, bg: 'from-yellow-500 to-amber-700' },
  { id: 'cs9_5', classLevel: '9', subject: 'computer', title: 'Unit 3: Web Projects', desc: 'Develop major web projects like an E-Commerce Food website.', built: true, bg: 'from-cyan-700 to-sky-900' },
  { id: 'cs9_6', classLevel: '9', subject: 'computer', title: 'Unit 4: Data Analysis', desc: 'Enter survey data to generate dynamic Bar and Pie charts.', built: true, bg: 'from-indigo-700 to-fuchsia-900' },
  { id: 'cs9_7', classLevel: '9', subject: 'computer', title: 'Unit 5: AI Applications', desc: 'Explore the functional and ethical issues of AI in various industries.', built: true, bg: 'from-rose-600 to-pink-800' },
  { id: 'cs9_8', classLevel: '9', subject: 'computer', title: 'Unit 6: Cyber Safety', desc: 'Navigate scenario-based challenges involving fake news and cyberbullying.', built: true, bg: 'from-red-600 to-orange-800' },
  { id: 'cs9_9', classLevel: '9', subject: 'computer', title: 'Unit 7: Entrepreneurship', desc: 'Calculate cost of production and build digital business plans.', built: true, bg: 'from-emerald-600 to-green-800' },

  // Class 9 Mathematics
  { id: 'm9_1', classLevel: '9', subject: 'math', title: 'Unit 1: Real Numbers', desc: 'Calculate fractions and distances for financial and real-world logistics.', built: true, bg: 'from-blue-700 to-indigo-900' },
  { id: 'm9_2', classLevel: '9', subject: 'math', title: 'Unit 2: Logarithms', desc: 'Measure earthquakes on the Richter Scale and use Scientific Notation.', built: true, bg: 'from-emerald-700 to-teal-900' },
  { id: 'm9_3', classLevel: '9', subject: 'math', title: 'Unit 3: Sets & Relations', desc: 'Categorize demographic survey data into overlapping Venn Diagrams.', built: true, bg: 'from-amber-600 to-orange-800' },
  { id: 'm9_4', classLevel: '9', subject: 'math', title: 'Unit 4-5: Algebraic Manipulation', desc: 'Optimize architectural volume and focal lengths using algebraic inequalities.', built: true, bg: 'from-rose-700 to-pink-900' },
  { id: 'm9_5', classLevel: '9', subject: 'math', title: 'Unit 6: Trigonometry', desc: 'Measure tree heights with shadow angles and plot ship bearings.', built: true, bg: 'from-cyan-700 to-blue-900' },
  { id: 'm9_6', classLevel: '9', subject: 'math', title: 'Unit 7: Coordinate Geometry', desc: 'Plot maps and use distance formulas for urban planning scenarios.', built: true, bg: 'from-violet-700 to-fuchsia-900' },
  { id: 'm9_7', classLevel: '9', subject: 'math', title: 'Unit 8: Linear Graphs', desc: 'Calculate linear slopes for taxi fares and pollution indexing.', built: true, bg: 'from-red-700 to-rose-900' },
  { id: 'm9_8', classLevel: '9', subject: 'math', title: 'Unit 9-10: Geometry & Polygons', desc: 'Estimate landscaping costs and interactively find the Centroid of a triangle.', built: true, bg: 'from-orange-500 to-amber-700' },
  { id: 'm9_9', classLevel: '9', subject: 'math', title: 'Unit 11: Basic Statistics', desc: 'Plot histograms and determine probability flaws in factory shipments.', built: true, bg: 'from-slate-700 to-gray-900' },
  ...
  { id: 'c11_6', classLevel: '11', subject: 'chemistry', title: 'Ch 8 & 11: Industrial Eq.', desc: 'Master Le Chateliers Principle in Haber & Contact process control panels.', built: true, bg: 'from-indigo-700 to-fuchsia-900' },
  ...
  { id: 'p11_deriv_dimensional_wavelength', classLevel: '11', subject: 'physics', title: 'Derivation: Dimensional Analysis (Wavelength)', desc: 'Derive lambda = h/mv from dimensional analysis with interactive sliders.', built: true, bg: 'from-indigo-500 to-purple-600' },
  { id: 'p11_deriv_dimensional_pendulum', classLevel: '11', subject: 'physics', title: 'Derivation: Time Period of Pendulum', desc: 'Derive T = 2pi sqrt(l/g) from dimensional analysis with interactive sliders.', built: true, bg: 'from-emerald-500 to-teal-600' },
  { id: 'p11_deriv_rectangular_components', classLevel: '11', subject: 'physics', title: 'Derivation: Rectangular Components', desc: 'Derive Ax = A cos theta and Ay = A sin theta with interactive sliders.', built: true, bg: 'from-sky-500 to-blue-600' },
  { id: 'p11_deriv_first_equation', classLevel: '11', subject: 'physics', title: 'Derivation: First Equation of Motion', desc: 'Derive v_f = v_i + at from acceleration definition with interactive sliders.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p11_deriv_second_equation', classLevel: '11', subject: 'physics', title: 'Derivation: Second Equation of Motion', desc: 'Derive S = v_i t + 0.5at^2 from v-t graph area with interactive sliders.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'p11_deriv_third_equation', classLevel: '11', subject: 'physics', title: 'Derivation: Third Equation of Motion', desc: 'Derive 2aS = v_f^2 - v_i^2 with interactive sliders.', built: true, bg: 'from-violet-500 to-purple-600' },
  { id: 'p11_deriv_projectile_height', classLevel: '11', subject: 'physics', title: 'Derivation: Max Height of Projectile', desc: 'Derive H = v_i^2 sin^2 theta / 2g with interactive sliders.', built: true, bg: 'from-rose-500 to-pink-600' },
  { id: 'p11_deriv_projectile_range', classLevel: '11', subject: 'physics', title: 'Derivation: Range of Projectile', desc: 'Derive R = v_i^2 sin(2theta)/g with interactive sliders.', built: true, bg: 'from-pink-500 to-rose-600' },
  { id: 'p11_deriv_elastic_collision', classLevel: '11', subject: 'physics', title: 'Derivation: Elastic Collision Velocities', desc: 'Derive v1 = (m1-m2)u1/(m1+m2) with interactive sliders.', built: true, bg: 'from-amber-500 to-orange-600' },
  { id: 'p11_deriv_linear_angular', classLevel: '11', subject: 'physics', title: 'Derivation: Linear-Angular Relations', desc: 'Derive v = r omega and a = r alpha with interactive sliders.', built: true, bg: 'from-teal-500 to-cyan-600' },
  { id: 'p11_deriv_centripetal_acceleration', classLevel: '11', subject: 'physics', title: 'Derivation: Centripetal Acceleration', desc: 'Derive a_c = v^2/r from similar triangles with interactive sliders.', built: true, bg: 'from-cyan-500 to-sky-600' },
  { id: 'p11_deriv_kinetic_energy', classLevel: '11', subject: 'physics', title: 'Derivation: Kinetic Energy', desc: 'Derive KE = 0.5 mv^2 from work-energy theorem with interactive sliders.', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p11_deriv_archimedes', classLevel: '11', subject: 'physics', title: 'Derivation: Archimedes Upthrust', desc: 'Derive F = rho g V from pressure difference with interactive sliders.', built: true, bg: 'from-sky-500 to-blue-600' },
  { id: 'p11_deriv_continuity', classLevel: '11', subject: 'physics', title: 'Derivation: Equation of Continuity', desc: 'Derive A1 v1 = A2 v2 from mass conservation with interactive sliders.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p11_deriv_bernoulli', classLevel: '11', subject: 'physics', title: 'Derivation: Bernoulli Equation', desc: 'Derive P + 0.5 rho v^2 + rho g h = constant with interactive sliders.', built: true, bg: 'from-indigo-500 to-blue-600' },
  { id: 'p11_deriv_carnot_efficiency', classLevel: '11', subject: 'physics', title: 'Derivation: Carnot Efficiency', desc: 'Derive eta = 1 - T2/T1 from heat engine cycle with interactive sliders.', built: true, bg: 'from-red-500 to-orange-600' },
  { id: 'p11_deriv_doppler_listener_towards', classLevel: '11', subject: 'physics', title: 'Derivation: Doppler Effect', desc: 'Derive f\' = (v+v_L)/v x f for listener moving toward source with interactive sliders.', built: true, bg: 'from-fuchsia-500 to-pink-600' },
  { id: 'p11_deriv_stationary_waves_string', classLevel: '11', subject: 'physics', title: 'Derivation: Stationary Waves in Strings', desc: 'Derive f_n = nv/2L for stretched string harmonics with interactive sliders.', built: true, bg: 'from-pink-500 to-rose-600' },
  { id: 'p11_deriv_electric_field_point', classLevel: '11', subject: 'physics', title: 'Derivation: Electric Field of Point Charge', desc: 'Derive E = kQ/r^2 from Coulomb law with interactive sliders.', built: true, bg: 'from-violet-500 to-purple-600' },
  { id: 'p11_deriv_drift_velocity', classLevel: '11', subject: 'physics', title: 'Derivation: Drift Velocity & Current', desc: 'Derive I = n e A v_d from charge transport with interactive sliders.', built: true, bg: 'from-amber-500 to-orange-600' },
  { id: 'p11_deriv_magnetic_force', classLevel: '11', subject: 'physics', title: 'Derivation: Magnetic Force on Conductor', desc: 'Derive F = B I L sin theta from Lorentz force with interactive sliders.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'p11_deriv_faraday_law', classLevel: '11', subject: 'physics', title: 'Derivation: Faraday\'s Law', desc: 'Derive epsilon = -N dPhi/dt from electromagnetic induction with interactive sliders.', built: true, bg: 'from-fuchsia-500 to-pink-600' },
  ...
  { id: 'p11_10', classLevel: '11', subject: 'physics', title: 'Unit 10: Electrostatics', desc: 'Shield objects inside Faraday cages and manipulate MRI ferrofluids.', built: true, bg: 'from-fuchsia-700 to-indigo-900' },
  ...
  { id: 'b11_3', classLevel: '11', subject: 'biology', title: 'Unit 3: Enzymes', desc: 'Filter lactose with alginate beads and evaluate diagnostic blood panels.', built: true, bg: 'from-indigo-700 to-fuchsia-900' },
  ...
  { id: 'b12_7', classLevel: '12', subject: 'biology', title: 'Unit 10: Biotechnology', desc: 'Splice human insulin into bacterial plasmids and run a PCR thermocycler.', built: true, bg: 'from-indigo-700 to-indigo-900' },
  ...
  { id: 'p11_deriv_artificial_gravity', classLevel: '11', subject: 'physics', title: 'Derivation: Artificial Gravity / Satellite Velocity', desc: 'Creating artificial gravity via rotation: v = \u221A(gR), \u03C9 = \u221A(g/R)', built: true, bg: 'from-teal-500 to-green-600' },
  { id: 'p11_deriv_terminal_velocity', classLevel: '11', subject: 'physics', title: 'Derivation: Terminal Velocity', desc: 'Maximum speed reached by a falling object through a fluid: v_t = 2\u03C1gr\u00B2 / 9\u03B7', built: true, bg: 'from-sky-500 to-blue-600' },
  { id: 'p11_deriv_resistance_series', classLevel: '11', subject: 'physics', title: 'Derivation: Equivalent Resistance (Series)', desc: 'Total resistance in series = sum of individual resistances: R_eq = R\u2081 + R\u2082 + R\u2083', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p11_deriv_resistance_parallel', classLevel: '11', subject: 'physics', title: 'Derivation: Equivalent Resistance (Parallel)', desc: 'Total resistance in parallel = reciprocal of sum of reciprocals: 1/R_eq = 1/R\u2081 + 1/R\u2082 + 1/R\u2083', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'p11_deriv_venturi_meter', classLevel: '11', subject: 'physics', title: 'Derivation: Venturi Meter Flow Rate', desc: 'Fluid velocity from pressure difference in a Venturi tube: v\u2081 = \u221A(2gh / ((A\u2081/A\u2082)\u00B2 \u2212 1))', built: true, bg: 'from-cyan-500 to-blue-600' },
  { id: 'p11_deriv_elastic_potential_energy', classLevel: '11', subject: 'physics', title: 'Derivation: Elastic Potential Energy', desc: 'Energy stored in a deformed spring: U = \u00BD k x\u00B2', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p11_deriv_work_done_gas', classLevel: '11', subject: 'physics', title: 'Derivation: Work Done by a Gas', desc: 'Work done during expansion or compression: W = P\u0394V', built: true, bg: 'from-orange-500 to-red-600' },
  { id: 'p11_deriv_cop_refrigerator', classLevel: '11', subject: 'physics', title: 'Derivation: Coefficient of Performance (Refrigerator)', desc: 'Efficiency measure for a refrigerator (reverse Carnot cycle): COP = T\u2082 / (T\u2081 \u2212 T\u2082)', built: true, bg: 'from-cyan-500 to-teal-600' },
  { id: 'p11_deriv_doppler_listener_away', classLevel: '11', subject: 'physics', title: 'Derivation: Doppler Effect (Listener Moving Away)', desc: 'Apparent frequency when listener moves away from source: f_n = n v / 2L', built: true, bg: 'from-pink-500 to-rose-600' },
  { id: 'p11_deriv_doppler_source_towards', classLevel: '11', subject: 'physics', title: 'Derivation: Doppler Effect (Source Moving Towards)', desc: 'Apparent frequency when source moves toward listener: E = \u2212\u0394V/\u0394r', built: true, bg: 'from-rose-500 to-red-600' },
  { id: 'p11_deriv_stationary_waves_air_column', classLevel: '11', subject: 'physics', title: 'Derivation: Stationary Waves in Air Columns (Open Pipe)', desc: 'Harmonics of an open pipe (both ends antinodes): P_max = \u03B5\u00B2 / 4r', built: true, bg: 'from-violet-500 to-purple-600' },
  { id: 'p11_deriv_potential_gradient', classLevel: '11', subject: 'physics', title: 'Derivation: Electric Potential Gradient', desc: 'Electric field equals negative potential gradient: R = PS/Q', built: true, bg: 'from-purple-500 to-indigo-600' },
  { id: 'p11_deriv_maximum_power_output', classLevel: '11', subject: 'physics', title: 'Derivation: Maximum Power Output', desc: 'Maximum power delivered when load = internal resistance: F/L = \u03BC\u2080 I\u2081 I\u2082 / 2\u03C0r', built: true, bg: 'from-amber-500 to-orange-600' },
  { id: 'p11_deriv_wheatstone_bridge', classLevel: '11', subject: 'physics', title: 'Derivation: Wheatstone Bridge Balance', desc: 'Balance condition: P/Q = R/S: r = mv/qB', built: true, bg: 'from-lime-500 to-green-600' },
  { id: 'p11_deriv_force_between_conductors', classLevel: '11', subject: 'physics', title: 'Derivation: Force Between Two Current-Carrying Conductors', desc: 'Force per unit length between parallel conductors: v = E/B', built: true, bg: 'from-blue-500 to-violet-600' },
  { id: 'p11_deriv_charged_particle_b_field', classLevel: '11', subject: 'physics', title: 'Derivation: Charged Particle in Magnetic Field', desc: 'Radius of circular path of a charge in a magnetic field: ', built: true, bg: 'from-indigo-500 to-purple-600' },
  { id: 'p11_deriv_velocity_selector', classLevel: '11', subject: 'physics', title: 'Derivation: Velocity Selector', desc: 'Velocity for undeflected motion through crossed fields: ', built: true, bg: 'from-cyan-500 to-blue-600' },  // Class 11 Physics (batch 3)
  { id: 'p11_deriv_doppler_source_away', classLevel: '11', subject: 'physics', title: 'Derivation: Doppler Effect (Source Moving Away)', desc: 'Apparent frequency when source moves away from listener: f\' = v/(v + v_S) Ã— f', built: true, bg: 'from-red-500 to-rose-600' },
  { id: 'p11_deriv_potentiometer', classLevel: '11', subject: 'physics', title: 'Derivation: Potentiometer EMF Comparison', desc: 'Ratio of EMFs equals ratio of balancing lengths: Îµâ‚‚/Îµâ‚ = lâ‚‚/lâ‚', built: true, bg: 'from-green-500 to-teal-600' },
  { id: 'p11_deriv_dirac_momentum', classLevel: '11', subject: 'physics', title: 'Derivation: Dirac Momentum from Energy-Momentum Relation', desc: 'Relativistic momentum from Einstein\'s energy relation: p = âˆš(EÂ² - mÂ²câ´)/c', built: true, bg: 'from-indigo-500 to-purple-600' },



  // Class 12 Physics Derivations
  { id: 'p12_deriv_gravitation_law', classLevel: '12', subject: 'physics', title: 'Derivation: Newton\'s Law of Universal Gravitation', desc: 'Interactive step-by-step derivation of F_g = Gm1m2/r^2 with sliders and live simulation.', built: true, bg: 'from-indigo-500 to-purple-600' },
  { id: 'p12_deriv_g_on_surface', classLevel: '12', subject: 'physics', title: 'Derivation: g on Earth\'s Surface', desc: 'Interactive step-by-step derivation of g = GM_E/R_E^2 with live simulation.', built: true, bg: 'from-emerald-500 to-teal-600' },
  { id: 'p12_deriv_g_variation', classLevel: '12', subject: 'physics', title: 'Derivation: Variation of g with Altitude', desc: 'Interactive step-by-step derivation of g_h = GM_E/(R_E+h)^2 with live simulation.', built: true, bg: 'from-sky-500 to-blue-600' },
  { id: 'p12_deriv_orbital_velocity', classLevel: '12', subject: 'physics', title: 'Derivation: Orbital Velocity', desc: 'Interactive step-by-step derivation of v_o = sqrt(GM_E/r) with live simulation.', built: true, bg: 'from-violet-500 to-indigo-600' },
  { id: 'p12_deriv_geostationary', classLevel: '12', subject: 'physics', title: 'Derivation: Geostationary Orbit Radius', desc: 'Interactive step-by-step derivation of r = (GM_ET^2/4pi^2)^(1/3) with live simulation.', built: true, bg: 'from-cyan-500 to-sky-600' },
  { id: 'p12_deriv_absolute_gpe', classLevel: '12', subject: 'physics', title: 'Derivation: Absolute Gravitational PE', desc: 'Interactive step-by-step derivation of U = -GM_Em/r with live simulation.', built: true, bg: 'from-teal-500 to-emerald-600' },
  { id: 'p12_deriv_gravitational_potential', classLevel: '12', subject: 'physics', title: 'Derivation: Gravitational Potential', desc: 'Interactive step-by-step derivation of V = -GM_E/r with live simulation.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p12_deriv_ideal_gas_pressure', classLevel: '12', subject: 'physics', title: 'Derivation: Pressure of an Ideal Gas', desc: 'Interactive step-by-step derivation of P = (1/3)p<v^2> with live simulation.', built: true, bg: 'from-red-500 to-orange-600' },
  { id: 'p12_deriv_pressure_ke', classLevel: '12', subject: 'physics', title: 'Derivation: Pressure and Kinetic Energy', desc: 'Interactive step-by-step derivation of P = (2/3)N*KE_avg/V with live simulation.', built: true, bg: 'from-orange-500 to-amber-600' },
  { id: 'p12_deriv_temperature_ke', classLevel: '12', subject: 'physics', title: 'Derivation: Temperature and Kinetic Energy', desc: 'Interactive step-by-step derivation of KE_avg = (3/2)kT with live simulation.', built: true, bg: 'from-amber-500 to-yellow-600' },
  { id: 'p12_deriv_rms_speed', classLevel: '12', subject: 'physics', title: 'Derivation: RMS Speed', desc: 'Interactive step-by-step derivation of v_rms = sqrt(3kT/m) with live simulation.', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p12_deriv_shm_mass_spring', classLevel: '12', subject: 'physics', title: 'Derivation: Mass-Spring SHM', desc: 'Interactive step-by-step derivation of omega = sqrt(k/m) with live simulation.', built: true, bg: 'from-green-500 to-emerald-600' },
  { id: 'p12_deriv_shm_displacement', classLevel: '12', subject: 'physics', title: 'Derivation: SHM Displacement & Velocity', desc: 'Interactive step-by-step derivation of x = x_o cos(wt) with live simulation.', built: true, bg: 'from-emerald-500 to-teal-600' },
  { id: 'p12_deriv_simple_pendulum', classLevel: '12', subject: 'physics', title: 'Derivation: Simple Pendulum Period', desc: 'Interactive step-by-step derivation of T = 2pi*sqrt(L/g) with live simulation.', built: true, bg: 'from-teal-500 to-cyan-600' },
  { id: 'p12_deriv_shm_energy', classLevel: '12', subject: 'physics', title: 'Derivation: Energy Conservation in SHM', desc: 'Interactive step-by-step derivation of E = (1/2)kx_o^2 with live simulation.', built: true, bg: 'from-cyan-500 to-sky-600' },
  { id: 'p12_deriv_youngs_double_slit', classLevel: '12', subject: 'physics', title: 'Derivation: Young\'s Double Slit', desc: 'Interactive step-by-step derivation of fringe spacing dy = lambda*L/d with live simulation.', built: true, bg: 'from-fuchsia-500 to-pink-600' },
  { id: 'p12_deriv_diffraction_grating', classLevel: '12', subject: 'physics', title: 'Derivation: Diffraction Grating', desc: 'Interactive step-by-step derivation of d sin(theta) = m*lambda with live simulation.', built: true, bg: 'from-pink-500 to-rose-600' },
  { id: 'p12_deriv_electric_potential_point', classLevel: '12', subject: 'physics', title: 'Derivation: Electric Potential of Point Charge', desc: 'Interactive step-by-step derivation of V = kQ/r with live simulation.', built: true, bg: 'from-purple-500 to-violet-600' },
  { id: 'p12_deriv_capacitance', classLevel: '12', subject: 'physics', title: 'Derivation: Capacitance of Parallel Plate', desc: 'Interactive step-by-step derivation of C = epsilon_0 A/d with live simulation.', built: true, bg: 'from-violet-500 to-purple-600' },
  { id: 'p12_deriv_equivalent_capacitance', classLevel: '12', subject: 'physics', title: 'Derivation: Equivalent Capacitance', desc: 'Interactive step-by-step derivation of series and parallel capacitance with live simulation.', built: true, bg: 'from-indigo-500 to-blue-600' },
  { id: 'p12_deriv_capacitor_energy', classLevel: '12', subject: 'physics', title: 'Derivation: Energy Stored in Capacitor', desc: 'Interactive step-by-step derivation of E = 1/2 CV^2 with live simulation.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'p12_deriv_rc_circuit', classLevel: '12', subject: 'physics', title: 'Derivation: RC Circuit Charging/Discharging', desc: 'Interactive step-by-step derivation of Q(t) = Q_o(1-e^{-t/RC}) with live simulation.', built: true, bg: 'from-sky-500 to-indigo-600' },
  { id: 'p12_deriv_ac_power', classLevel: '12', subject: 'physics', title: 'Derivation: Mean Power in AC Circuit', desc: 'Interactive step-by-step derivation of <P> = (1/2)I_o^2R with live simulation.', built: true, bg: 'from-rose-500 to-pink-600' },
  { id: 'p12_deriv_inductive_reactance', classLevel: '12', subject: 'physics', title: 'Derivation: Inductive Reactance', desc: 'Interactive step-by-step derivation of X_L = omega*L = 2pifL with live simulation.', built: true, bg: 'from-orange-500 to-red-600' },
  { id: 'p12_deriv_capacitive_reactance', classLevel: '12', subject: 'physics', title: 'Derivation: Capacitive Reactance', desc: 'Interactive step-by-step derivation of X_C = 1/(omega*C) with live simulation.', built: true, bg: 'from-red-500 to-rose-600' },
  { id: 'p12_deriv_impedance', classLevel: '12', subject: 'physics', title: 'Derivation: Impedance in RL/RC Circuits', desc: 'Interactive step-by-step derivation of Z = sqrt(R^2 + X^2) with live simulation.', built: true, bg: 'from-rose-500 to-red-600' },
  { id: 'p12_deriv_photoelectric', classLevel: '12', subject: 'physics', title: 'Derivation: Einstein\'s Photoelectric Equation', desc: 'Interactive step-by-step derivation of KE_max = hf - phi with live simulation.', built: true, bg: 'from-yellow-500 to-amber-600' },
  { id: 'p12_deriv_de_broglie', classLevel: '12', subject: 'physics', title: 'Derivation: De Broglie Wavelength', desc: 'Interactive step-by-step derivation of lambda = h/p with live simulation.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  { id: 'p12_deriv_mass_defect', classLevel: '12', subject: 'physics', title: 'Derivation: Mass Defect & Binding Energy', desc: 'Interactive step-by-step derivation of E = delta m c^2 with live simulation.', built: true, bg: 'from-emerald-500 to-green-600' },
  { id: 'p12_deriv_decay_law', classLevel: '12', subject: 'physics', title: 'Derivation: Radioactive Decay Law', desc: 'Interactive step-by-step derivation of N = N_o e^{-lambda t} with live simulation.', built: true, bg: 'from-green-500 to-emerald-600' },
  { id: 'p12_deriv_half_life', classLevel: '12', subject: 'physics', title: 'Derivation: Half-Life & Decay Constant', desc: 'Interactive step-by-step derivation of T_1/2 = 0.693/lambda with live simulation.', built: true, bg: 'from-teal-500 to-emerald-600' },
  { id: 'p12_deriv_wien_law', classLevel: '12', subject: 'physics', title: 'Derivation: Wien\'s Displacement Law', desc: 'Interactive step-by-step derivation of lambda_max * T = 2.9e-3 with live simulation.', built: true, bg: 'from-amber-500 to-yellow-600' },
  { id: 'p12_deriv_hubble_law', classLevel: '12', subject: 'physics', title: 'Derivation: Hubble\'s Law & Age of Universe', desc: 'Interactive step-by-step derivation of v = H_o d with live simulation.', built: true, bg: 'from-purple-500 to-indigo-600' },
  { id: 'p12_deriv_coriolis', classLevel: '12', subject: 'physics', title: 'Derivation: Coriolis Force', desc: 'Interactive step-by-step derivation of F_c = 2mvw sin(theta) with live simulation.', built: true, bg: 'from-sky-500 to-blue-600' },
  { id: 'p12_deriv_newton_cannon', classLevel: '12', subject: 'physics', title: 'Derivation: Newton\'s Cannonball', desc: 'Interactive step-by-step derivation of orbital condition v^2/r = g with live simulation.', built: true, bg: 'from-slate-500 to-zinc-600' },
  ...
  { id: 'p12_7', classLevel: '12', subject: 'physics', title: 'Unit 21-22: Quantum/Nuclear', desc: 'Control Nuclear Fission reactors and track PET Scan Pair Annihilation.', built: true, bg: 'from-indigo-700 to-indigo-900' },
  ...
  { id: 'p12_capstone_solar', classLevel: '12', subject: 'physics', title: 'Capstone: Design a Solar Cell', desc: 'Multi-lab project connecting photon energy, semiconductors, and band gap engineering to design an efficient photovoltaic cell.', built: true, bg: 'from-amber-600 to-yellow-800' },
  ...
  { id: 'c12_4', classLevel: '12', subject: 'chemistry', title: 'Unit 7-14: Organic Synthesis', desc: 'Synthesize Azo-Dyes and run AI Retrosynthetic Drug Analysis.', built: true, bg: 'from-violet-700 to-indigo-900' },
  ...
  { id: 'cs12_3', classLevel: '12', subject: 'computer', title: 'Unit 3: Programming', desc: 'Model OOP Encapsulation and execute SQLite 3NF Database Normalization.', built: true, bg: 'from-violet-800 to-indigo-900' },
  ...
  { id: 'e6_2', classLevel: '6', subject: 'english', title: 'Unit 2: Sentences & Affixes', desc: 'Attach word prefixes and construct sentences.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'e7_2', classLevel: '7', subject: 'english', title: 'Unit 2: Figures of Speech', desc: 'Analyze poetry for Metaphors and Similes.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'e8_2', classLevel: '8', subject: 'english', title: 'Unit 2: Pronouns & Morphology', desc: 'Snap Root Words with Affixes and map Pronouns.', built: true, bg: 'from-indigo-500 to-fuchsia-600' },
  ...
  { id: 'c9e_4', classLevel: '9', subject: 'english', title: 'Unit 4: Phrase Dissector', desc: 'Identify Adjectival, Adverbial, and Prepositional phrases.', built: true, bg: 'from-indigo-500 to-indigo-600' },
  ...
  { id: 'c9e_6', classLevel: '9', subject: 'english', title: 'Unit 6: Clause Collider', desc: 'Merge independent and dependent clauses using conditional logic.', built: true, bg: 'from-indigo-600 to-fuchsia-700' },
  ...
  { id: 'c10e_5', classLevel: '10', subject: 'english', title: 'Unit 5: Possibility Engine', desc: 'Build logical chains using modals and conditional sentences.', built: true, bg: 'from-indigo-500 to-fuchsia-700' },
  ...
  { id: 'm10_theorem_quadratic_formula', classLevel: '10', subject: 'math', title: 'Theorem: Quadratic Formula', desc: 'Derive x = [âˆ’b Â± âˆš(bÂ²âˆ’4ac)]/2a with an interactive parabolic arch simulation.', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'm10_theorem_vector_diff', classLevel: '10', subject: 'math', title: 'Theorem: Vector from Position Vectors', desc: 'Prove AB = b âˆ’ a with an interactive drone tracking simulation.', built: true, bg: 'from-amber-500 to-orange-600' },
  { id: 'm10_theorem_law_cosines', classLevel: '10', subject: 'math', title: 'Theorem: Law of Cosines', desc: 'Prove aÂ² = bÂ² + cÂ² âˆ’ 2bc cos Î± with an interactive land surveyor simulation.', built: true, bg: 'from-rose-500 to-red-600' },
  { id: 'm10_theorem_law_sines', classLevel: '10', subject: 'math', title: 'Theorem: Law of Sines', desc: 'Prove a/sin Î± = b/sin Î² = c/sin Î³ with an interactive mountain expedition simulation.', built: true, bg: 'from-sky-500 to-cyan-600' },
  { id: 'm10_theorem_law_tangents', classLevel: '10', subject: 'math', title: 'Theorem: Law of Tangents', desc: 'Prove (a+b)/(aâˆ’b) = tan[(Î±+Î²)/2]/tan[(Î±âˆ’Î²)/2] with interactive navigation.', built: true, bg: 'from-indigo-500 to-purple-600' },
  { id: 'm10_theorem_half_angle_cos', classLevel: '10', subject: 'math', title: 'Theorem: Half Angle Cosine Formula', desc: 'Prove cos(Î±/2) = âˆš[S(Sâˆ’a)/bc] using Law of Cosines and double-angle identity.', built: true, bg: 'from-emerald-500 to-green-600' },
  { id: 'm10_theorem_half_angle_sin', classLevel: '10', subject: 'math', title: 'Theorem: Half Angle Sine Formula', desc: 'Prove sin(Î±/2) = âˆš[(Sâˆ’b)(Sâˆ’c)/bc] and connect to Heros formula.', built: true, bg: 'from-emerald-600 to-teal-700' },
  { id: 'm10_theorem_area_sas', classLevel: '10', subject: 'math', title: 'Theorem: Area of Triangle (SAS)', desc: 'Prove Î” = Â½ bc sin Î± with an interactive surveyor plot simulation.', built: true, bg: 'from-violet-500 to-purple-700' },
  { id: 'm10_theorem_area_aas', classLevel: '10', subject: 'math', title: 'Theorem: Area of Triangle (AAS)', desc: 'Prove Î” = Â½ aÂ² sin Î² sin Î³ / sin Î± for mountain profile measurements.', built: true, bg: 'from-violet-600 to-fuchsia-700' },
  { id: 'm10_theorem_heros', classLevel: '10', subject: 'math', title: "Theorem: Hero's Formula (SSS)", desc: 'Prove Î” = âˆš[S(Sâˆ’a)(Sâˆ’b)(Sâˆ’c)] with an interactive triangular garden simulation.', built: true, bg: 'from-emerald-500 to-teal-600' },
  { id: 'm10_theorem_circum_radius', classLevel: '10', subject: 'math', title: 'Theorem: Circum-Radius', desc: 'Prove R = abc/(4Î”) with an interactive circumcircle construction.', built: true, bg: 'from-orange-500 to-amber-600' },
  { id: 'm10_theorem_in_radius', classLevel: '10', subject: 'math', title: 'Theorem: In-Radius', desc: 'Prove r = Î”/S with an interactive incircle construction.', built: true, bg: 'from-teal-500 to-emerald-600' },
  { id: 'm10_theorem_ex_radius', classLevel: '10', subject: 'math', title: 'Theorem: Ex-Radius', desc: 'Prove râ‚ = Î”/(Sâˆ’a) with an interactive excircle demonstration.', built: true, bg: 'from-teal-600 to-cyan-700' },
  ...
  { id: 'm10_theorem_centre_bisects', classLevel: '10', subject: 'math', title: 'Theorem 9.2: Centre to Midpoint âŸ‚ Chord', desc: 'Prove the line from centre to the midpoint of a chord is perpendicular.', built: true, bg: 'from-indigo-500 to-indigo-700' },
  ...
  { id: 'm10_theorem_congruent_arcs', classLevel: '10', subject: 'math', title: 'Theorem 9.6: Congruent Arcs â†’ Equal Chords', desc: 'Prove congruent arcs subtend equal chords.', built: true, bg: 'from-indigo-500 to-teal-700' },
  { id: 'm10_theorem_equal_chords_arcs', classLevel: '10', subject: 'math', title: 'Theorem 9.7: Equal Chords â†’ Congruent Arcs', desc: 'Prove equal chords subtend congruent arcs.', built: true, bg: 'from-indigo-500 to-rose-700' },
  { id: 'm10_theorem_equal_chords_angles', classLevel: '10', subject: 'math', title: 'Theorem 9.8: Equal Chords â†’ Equal Angles', desc: 'Prove equal chords subtend equal angles at the centre.', built: true, bg: 'from-indigo-500 to-amber-700' },
  { id: 'm10_theorem_equal_angles_chords', classLevel: '10', subject: 'math', title: 'Theorem 9.9: Equal Angles â†’ Equal Chords', desc: 'Prove equal central angles subtend equal chords.', built: true, bg: 'from-indigo-500 to-orange-700' },
  ...
  { id: 'm10_theorem_tangent_perp_radius', classLevel: '10', subject: 'math', title: 'Theorem 10.2: Tangent âŸ‚ Radius', desc: 'Prove the tangent is perpendicular to the radius at point of contact.', built: true, bg: 'from-purple-500 to-pink-600' },
  ...
  { id: 'm10_theorem_external_touching', classLevel: '10', subject: 'math', title: 'Theorem 10.4: External Touching Circles', desc: 'Prove d = râ‚ + râ‚‚ when circles touch externally.', built: true, bg: 'from-purple-500 to-rose-600' },
  { id: 'm10_theorem_internal_touching', classLevel: '10', subject: 'math', title: 'Theorem 10.5: Internal Touching Circles', desc: 'Prove d = |râ‚ âˆ’ râ‚‚| when circles touch internally.', built: true, bg: 'from-purple-500 to-amber-600' },
  ...
  { id: 'm10_theorem_semicircle', classLevel: '10', subject: 'math', title: 'Theorem 10.9: Angle in Semicircle', desc: 'Prove the angle in a semicircle is always a right angle (90Â°).', built: true, bg: 'from-blue-500 to-indigo-600' },
  { id: 'm10_theorem_major_segment', classLevel: '10', subject: 'math', title: 'Theorem 10.10: Major Segment Angle < 90Â°', desc: 'Prove angles in a major segment are acute.', built: true, bg: 'from-cyan-500 to-teal-600' },
  { id: 'm10_theorem_minor_segment', classLevel: '10', subject: 'math', title: 'Theorem 10.11: Minor Segment Angle > 90Â°', desc: 'Prove angles in a minor segment are obtuse.', built: true, bg: 'from-cyan-500 to-violet-600' },
  { id: 'm10_theorem_cyclic_quad', classLevel: '10', subject: 'math', title: 'Theorem 10.12: Cyclic Quadrilateral', desc: 'Prove opposite angles of a cyclic quadrilateral sum to 180Â°.', built: true, bg: 'from-cyan-500 to-emerald-600' },
