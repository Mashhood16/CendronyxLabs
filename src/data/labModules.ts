...
export const LAB_MODULES = [
  ...
  { id: 'p11_deriv_potentiometer', classLevel: '11', subject: 'physics', title: 'Derivation: Potentiometer EMF Comparison', desc: 'Ratio of EMFs equals ratio of balancing lengths: ε₂/ε₁ = l₂/l₁', built: true, bg: 'from-green-500 to-teal-600' },
  { id: 'p11_deriv_dirac_momentum', classLevel: '11', subject: 'physics', title: 'Derivation: Dirac Momentum from Energy-Momentum Relation', desc: 'Relativistic momentum from Einstein\'s energy relation: p = √(E² - m²c⁴)/c', built: true, bg: 'from-indigo-500 to-purple-600' },
