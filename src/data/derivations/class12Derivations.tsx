...
export const CLASS12_DERIVATIONS: Record<string, DerivationConfig> = {
  ...
  gravitation_law: {
    ...
    keyInsight: 'The gravitational force between two 1 kg masses 1 m apart is just 6.67×10â»¹¹ N — a billionth of a Newton. Gravity is by far the weakest fundamental force, yet it dominates the cosmos at large scales.',
    steps: [
      { label: 'Force Proportional to Masses', formula: 'F\u2091 \u221D m\u2081 \u00D7 m\u2082', detail: 'ðŸŽ It\'s 1666, and Isaac Newton sits under an apple tree at Woolsthorpe Manor. An apple falls — but what if the same force that pulls the apple extends to the Moon? Newton realized the gravitational force between any two masses depends on how much matter each has: F_g âˆ mâ‚ × mâ‚‚. Double one mass = double the pull. A 50 kg person and a 70 kg friend feel 1.4× the force of two 50 kg people.' },
      { label: 'Force Inversely Proportional to Distance\u00B2', formula: 'F\u2091 \u221D 1 / r\u00B2', detail: 'ðŸ“ But as objects get farther apart, gravity weakens rapidly. Newton figured: F_g âˆ 1/r². If you double the distance, the force drops to 1/4. This inverse-square law explains why astronauts on the ISS (400 km up) feel about 90% of Earth\'s surface gravity despite appearing weightless — they\'re in free fall!' },
      { label: 'Combine Both Proportionalities', formula: 'F\u2091 \u221D (m\u2081\u00D7m\u2082) / r\u00B2', detail: 'ðŸ§® Combine both insights: F_g âˆ (mâ‚ × mâ‚‚)/r². The force is proportional to the product of masses divided by the square of the distance. Newton had the form — but he needed a constant to make it an equation.' },
      { label: 'Insert Gravitational Constant G', formula: 'F\u2091 = G \u00D7 (m\u2081\u00D7m\u2082) / r\u00B2', detail: 'âœ… F_g = G × (mâ‚ × mâ‚‚)/r². The constant G = 6.67×10â»¹¹ N·m²/kg² is tiny — it took Henry Cavendish 71 years after Newton\'s death to measure it using a delicate torsion balance with lead spheres. Two 1 kg masses 1 m apart attract with just 6.67×10â»¹¹ N — that\'s billionths of a Newton! Gravity truly is the weakest force.' },
    ],
    sliders: [
  ...
  g_on_surface: {
    ...
    steps: [
      ...
      { label: 'Cancel Object Mass', formula: 'g = G \u00D7 M_E / R_E\u00B2', detail: 'ðŸ§® Cancel mass m: g = G × M_E / R_E². This is why Galileo\'s legendary Leaning Tower of Pisa experiment works — a feather and a hammer fall at the same rate in vacuum. Mass doesn\'t matter!' },
      { label: 'Plug in Earth Values', formula: 'g = 6.67\u00D710\u207B\u00B9\u00B9 \u00D7 5.97\u00D710\u00B2\u2074 / (6.37\u00D710\u2076)\u00B2', detail: 'ðŸ“ Plug in Earth\'s values: M_E = 5.97×10²â´ kg (about 6 sextillion tons), R_E = 6.37×10â¶ m (6370 km). G = 6.67×10â»¹¹. Calculate: g = 6.67×10â»¹¹ × 5.97×10²â´ / (6.37×10â¶)² = 9.81 m/s².' },
      { label: 'Final Value', formula: 'g = 9.81 m/s\u00B2', detail: 'ðŸŒ g = 9.81 m/s². Every second in free fall, your speed increases by 9.81 m/s. But g varies: at the equator (9.78 m/s²) due to Earth\'s rotation, at the poles (9.83 m/s²) due to flattening. On Mount Everest, g is 9.79 m/s² — 0.2% less. On Mars, g is just 3.71 m/s² — you\'d weigh only 38% of your Earth weight!' },
    ],
    sliders: [
  ...
  g_variation: {
    ...
    steps: [
      { label: 'Replace R with R + h', formula: 'g_h = G \u00D7 M_E / (R_E + h)\u00B2', detail: 'ðŸ”ï¸ You\'re climbing Mount Everest. At the summit (8,848 m), you\'d expect gravity to be weaker because you\'re farther from Earth\'s center. Indeed: g_h = G × M_E / (R_E + h)². At the top of Everest: g_h = 6.67×10â»¹¹ × 5.97×10²â´ / (6.37×10â¶ + 8848)² = 9.79 m/s² — just a bit less than sea level\'s 9.81.' },
      { label: 'Compare to Surface g', formula: 'g_h / g = R_E\u00B2 / (R_E + h)\u00B2', detail: 'ðŸ“ Divide by surface g: g_h/g = R_E²/(R_E + h)². As h increases, the ratio drops. For small heights compared to R_E (6370 km), we can approximate using binomial expansion.' },
      { label: 'Approximation for Small h', formula: 'g_h \u2248 g(1 \u2212 2h/R_E)', detail: 'ðŸ§® For h << R_E: (1 + h/R_E)â»² â‰ˆ 1 âˆ’ 2h/R_E. So g_h â‰ˆ g(1 âˆ’ 2h/R_E). At 10 km altitude (airliner cruising): g_h = 9.81 × (1 âˆ’ 2×10/6370) = 9.81 × 0.9969 = 9.78 m/s² — only 0.3% less. That\'s why you don\'t feel noticeably lighter on a plane!' },
  ...
  orbital_velocity: {
    ...
    steps: [
      { label: 'Centripetal = Gravitational Force', formula: 'm v_o\u00B2 / r = G m M_E / r\u00B2', detail: 'ðŸš€ You\'re a SpaceX engineer preparing a Falcon 9 launch. The satellite needs to reach Low Earth Orbit. But how fast must it go? For a satellite in circular orbit, the centripetal force (mv²/r) must exactly equal the gravitational force (GMm/r²). If it\'s too slow, it falls back to Earth. Too fast, it flies away.' },
      { label: 'Cancel Satellite Mass m', formula: 'v_o\u00B2 / r = G M_E / r\u00B2', detail: 'ðŸ§® Set mv²/r = GMm/r². The satellite\'s mass m cancels out completely — orbital velocity doesn\'t depend on the satellite\'s mass! A tiny CubeSat and a massive ISS need the same speed at the same altitude. Cancel m: v²/r = GM/r².' },
      { label: 'Solve for v_o', formula: 'v_o\u00B2 = G M_E / r', detail: 'ðŸ“ Multiply by r: v² = GM/r. For low Earth orbit (r = 6,570 km, just 200 km above surface): v² = 6.67×10â»¹¹ × 5.97×10²â´ / 6.57×10â¶ = 60.6×10â¶. v = âˆš(60.6×10â¶) = 7,790 m/s â‰ˆ 7.8 km/s.' },
  ...
  geostationary: {
    ...
    steps: [
      ...
      { label: 'Orbital Period Formula', formula: 'v_o = 2\u03C0r / T', detail: 'ðŸ“ Orbital speed: v = 2Ï€r/T (circumference ÷ period). For geostationary, T = 86,400 s (24 hours). From orbital velocity: v = âˆš(GM/r). Set them equal: 2Ï€r/T = âˆš(GM/r).' },
      { label: 'Equate Both Expressions', formula: '2\u03C0r/T = \u221A(G M_E / r)', detail: 'ðŸ§® Square both sides: 4Ï€²r²/T² = GM/r. Multiply by r: 4Ï€²r³/T² = GM. So r³ = GMT²/4Ï€². The cube of the radius is proportional to the square of the period — Kepler\'s Third Law!' },
      { label: 'Solve for r', formula: 'r\u00B3 = G M_E T\u00B2 / 4\u03C0\u00B2', detail: 'âœ… r = (GMT²/4Ï€²)^(1/3). Plugging in: r = (6.67×10â»¹¹ × 5.97×10²â´ × 86400² / 4Ï€²)^(1/3) = 42,164 km from Earth\'s center. Subtract R_E = 6,370 km: height = 35,786 km above the surface. At this altitude, the satellite covers about 1/3 of Earth\'s surface — just 3 satellites can cover the entire globe!' },
    ],
    sliders: [
  ...
  absolute_gpe: {
    ...
    keyInsight: 'A 1000 kg satellite at 7000 km has âˆ’5.69×10¹â° J of gravitational PE — it needs that much kinetic energy to escape Earth. This is why reaching escape velocity (11.2 km/s) is far harder than orbital velocity (7.9 km/s).',
    steps: [
      { label: 'Work Against Gravity', formula: 'W = F_av \u00D7 \u0394r', detail: 'ðŸŒ You\'re calculating how much energy is needed to launch a rocket to infinity — to escape Earth\'s gravity completely. But there\'s a catch: gravity weakens with distance (1/r²), so the force isn\'t constant. You can\'t just use W = Fd. You need calculus to sum up the work over an infinite path.' },
      { label: 'Integrate from R to \u221E', formula: 'U = \u222B_R^\u221E G M_E m / r\u00B2 dr', detail: 'ðŸ“ The work done against gravity from Earth\'s surface R to infinity is the integral: U = âˆ«â‚š^âˆž (GMm/r²) dr. This integral sums up the tiny bits of work at each distance, where the force gets weaker and weaker the farther you go.' },
      { label: 'Evaluate the Integral', formula: 'U = \u2212G M_E m / r', detail: 'ðŸ§® The integral of 1/r² is âˆ’1/r. Evaluating from R to âˆž: U = [âˆ’GMm/r]â‚š^âˆž = (âˆ’GMm/âˆž) âˆ’ (âˆ’GMm/R) = 0 + GMm/R = âˆ’GMm/R. Wait — the reference point matters. We define U = 0 at infinity (where gravity is negligible). So at Earth\'s surface, U = âˆ’GMm/R. The negative sign means you\'re bound!' },
      { label: 'Physical Meaning', formula: 'U < 0 means bound system', detail: 'âœ… U = âˆ’GMm/r. A satellite at r = 7,000 km: U = âˆ’6.67×10â»¹¹ × 5.97×10²â´ × 1000 / 7×10â¶ = âˆ’5.69×10¹â° J. The negative value means it\'s gravitationally bound — you need to ADD 5.69×10¹â° J of kinetic energy to make U = 0 (escape). This is why reaching escape velocity (11.2 km/s) is so much harder than orbital velocity (7.9 km/s)!' },
    ],
    sliders: [
  ...
  gravitational_potential: {
    ...
    steps: [
      { label: 'Definition of Potential', formula: 'V = U / m', detail: 'ðŸ•³ï¸ You\'re studying black holes — regions where gravity is so intense that nothing, not even light, can escape. Gravitational potential V = U/m tells you the \'gravitational energy per kilogram\' at any point in space, independent of the test mass.' },
      ...
      { label: 'Simplify', formula: 'V = \u2212G M_E / r', detail: 'ðŸ§® At Earth\'s surface: V = âˆ’6.67×10â»¹¹ × 5.97×10²â´ / 6.37×10â¶ = âˆ’62.5×10â¶ J/kg = âˆ’62.5 MJ/kg. Every kilogram of you has âˆ’62.5 MJ of gravitational potential energy relative to infinity. To escape Earth, each kg needs 62.5 MJ of kinetic energy — that\'s the energy in 1.5 liters of gasoline!' },
      { label: 'Potential Difference', formula: '\u0394V = V\u2082 \u2212 V\u2081', detail: 'âš« The potential well near a black hole is incredibly deep. For a black hole with mass 10× the Sun, at its event horizon (r = 30 km): V = âˆ’GM/r = âˆ’6.67×10â»¹¹ × 2×10³¹ / 30000 = âˆ’4.4×10¹â¶ J/kg. That\'s 700 million times deeper than Earth\'s well! No wonder light can\'t escape.' },
    ],
    sliders: [
      { label: 'Distance from Center (r)', key: 'r', min: 6400, max: 50000, step: 100, default: 6370, unit: ' km' },
    ],
  ...
  ideal_gas_pressure: {
    ...
    steps: [
      ...
      { label: 'Force from One Molecule', formula: 'F = \u0394p / \u0394t = 2mv_x / (2L/v_x)', detail: 'ðŸ“ When a molecule of mass m hits the wall with x-velocity v_x, it bounces back with âˆ’v_x. Momentum change per collision: Î”p = âˆ’2mv_x. The force from one molecule = Î”p/Î”t. Time between hits on the same wall: Î”t = 2L/v_x. So F_one = mv_x²/L.' },
      { label: 'Sum Over All Molecules', formula: 'F_total = m/L \u00D7 \u03A3(v_x\u00B2)', detail: 'ðŸ§® Summing over all N molecules: F_total = (m/L) × Î£v_x². Since motion is random, <v_x²> = <v_y²> = <v_z²> = <v²>/3. So Î£v_x² = N<v²>/3. Total force F = (Nm<v²>)/(3L). Pressure P = F/A = (Nm<v²>)/(3LA) = (Nm<v²>)/(3V).' },
      { label: 'Pressure = Force/Area', formula: 'P = \\frac{1}{3} (N/V) m <v\u00B2> = \\frac{1}{3} \u03C1 <v\u00B2>', detail: 'âœ… P = (1/3)(N/V)m<v²> = (1/3)Ï<v²>. For air at sea level (Ï = 1.2 kg/m³, <v²> = (483 m/s)²): P = (1/3)×1.2×233,000 = 93,200 Pa â‰ˆ 0.92 atm. Close to 1 atm! Each square centimeter of your tire wall is struck by about 2.5×10²³ molecules per second. That\'s 250 billion billion impacts — every single second!' },
    ],
    sliders: [
  ...
  pressure_ke: {
    ...
    steps: [
      ...
      { label: 'Multiply and Divide by 2', formula: 'P = \\frac{2}{3} (N/V) \\frac{1}{2} m <v\u00B2>', detail: 'ðŸ“ From kinetic theory: P = (1/3)(N/V)m<v²>. Multiply and divide by 2: P = (2/3)(N/V)×(½)m<v²>. The term (½)m<v²> is the average translational kinetic energy per molecule!' },
      { label: 'Recognize Translational KE', formula: 'P = \\frac{2}{3} (N/V) \u00D7 KE_avg', detail: 'ðŸ§® P = (2/3)(N/V)×KE_avg. Pressure is directly proportional to both the number density of molecules and their average kinetic energy. In a pressure cooker, as you heat the contents, KE_avg increases, so pressure rises — that\'s why the safety valve is critical!' },
      { label: 'Final Relation', formula: 'P \u221D \\frac{2}{3} \u00D7 n \u00D7 KE_avg', detail: 'âœ… P âˆ (2/3) × (number density) × KE_avg. At room temperature (KE_avg = 6.2×10â»²¹ J, N/V = 2.5×10²âµ mâ»³): P = (2/3)×2.5×10²âµ×6.2×10â»²¹ = 103,000 Pa â‰ˆ 1 atm. The pressure doubles if you double either the density or the temperature!' },
    ],
    sliders: [
  ...
  temperature_ke: {
    ...
    steps: [
      ...
      { label: 'Kinetic Theory Pressure', formula: 'PV = \\frac{2}{3} N KE_avg', detail: 'ðŸ“ PV from ideal gas law: PV = NkT. PV from kinetic theory: PV = (2/3)N×KE_avg. Here k = 1.38×10â»²³ J/K is Boltzmann\'s constant — it connects the macroscopic world (temperature) to the microscopic world (molecular energy).' },
      { label: 'Equate Both Expressions', formula: 'NkT = \\frac{2}{3} N KE_avg', detail: 'ðŸ§® Equate: NkT = (2/3)N×KE_avg. The number N cancels! Temperature is directly proportional to average kinetic energy per molecule, independent of how many molecules there are.' },
      { label: 'Solve for KE_avg', formula: 'KE_avg = \\frac{3}{2} kT', detail: 'âœ… KE_avg = (3/2)kT. At 300 K (room temp): KE_avg = (3/2)×1.38×10â»²³×300 = 6.21×10â»²¹ J. At 0 K (âˆ’273°C), all molecular motion stops — absolute zero! This is why you can\'t reach absolute zero: to extract that last bit of kinetic energy would require infinite work. The coldest temperature ever achieved in a lab is about 100 pK (picokelvin)!' },
    ],
    sliders: [
  ...
  rms_speed: {
    ...
    steps: [
      { label: 'Start with KE-Temperature Relation', formula: '\\frac{1}{2} m <v\u00B2> = \\frac{3}{2} kT', detail: 'ðŸ‘ƒ You walk into a room and smell freshly baked bread. The aroma molecules travel from the kitchen to your nose — but how fast are individual molecules actually moving? Start with KE_avg = (3/2)kT = (½)m<v²>. This relates temperature to molecular motion.' },
      { label: 'Solve for <v\u00B2>', formula: '<v\u00B2> = 3kT / m', detail: 'ðŸ“ Solve for mean square speed: <v²> = 3kT/m. The mean square speed is 3kT divided by molecular mass. Lighter molecules move faster at the same temperature. Hydrogen (Hâ‚‚) molecules at room temperature have about 16× the mean square speed of oxygen (Oâ‚‚)!' },
      { label: 'Take Square Root', formula: 'v_rms = \u221A(3kT / m)', detail: 'ðŸ§® RMS speed v_rms = âˆš(3kT/m). For oxygen (m = 5.3×10â»²â¶ kg) at 300 K: v_rms = âˆš(3×1.38×10â»²³×300/5.3×10â»²â¶) = âˆš(2.34×10âµ) = 483 m/s.' },
      { label: 'Using Molar Mass', formula: 'v_rms = \u221A(3RT / M)', detail: 'âœ… v_rms = âˆš(3kT/m) = âˆš(3RT/M). Oxygen molecules zip around at 483 m/s = 1,740 km/h — faster than a jet fighter! But they don\'t travel far in a straight line; they collide with other molecules about 7 billion times per second, each collision changing direction. This zigzag path (diffusion) is why smell takes seconds to cross a room, not milliseconds.' },
    ],
    sliders: [
  ...
  shm_mass_spring: {
    ...
    keyInsight: 'Your car suspension uses springs with kâ‰ˆ40,000 N/m total, giving a bounce period of about 1 second. Race cars use stiffer springs for sharper handling — that\'s why they feel harsh on bumps.',
    steps: [
      { label: 'Hooke\'s Law', formula: 'F = \u2212kx', detail: 'ðŸš— Your car hits a bump and the suspension bounces. The spring pushes back with a force proportional to how much it\'s compressed — Hooke\'s Law: F = âˆ’kx. The negative sign means the force always pushes toward equilibrium. This restoring force is the heart of Simple Harmonic Motion.' },
      { label: 'Newton\'s Second Law', formula: 'ma = \u2212kx', detail: 'ðŸ“ Newton\'s Second Law: F = ma. So ma = âˆ’kx. But for SHM, acceleration is proportional to displacement in the opposite direction: a = âˆ’Ï‰²x (Ï‰ is angular frequency). Substitute: m(âˆ’Ï‰²x) = âˆ’kx.' },
      { label: 'Compare to SHM Definition', formula: '\u2212\u03C9\u00B2x = \u2212(k/m)x', detail: 'ðŸ§® Cancel âˆ’x from both sides: mÏ‰² = k, so Ï‰² = k/m. The angular frequency depends on the spring constant and mass. A stiffer spring (higher k) = faster oscillation. A heavier mass = slower oscillation. Ï‰ = âˆš(k/m).' },
      { label: 'Solve for \u03C9 and T', formula: '\u03C9 = \u221A(k/m), T = 2\u03C0\u221A(m/k)', detail: 'âœ… Ï‰ = âˆš(k/m), T = 2Ï€âˆš(m/k). For a car with 1000 kg on springs with k = 40,000 N/m total: Ï‰ = âˆš(40000/1000) = 6.32 rad/s, T = 2Ï€/6.32 = 0.99 s. Your car bounces about once per second. Race cars use stiffer springs (higher k) for better handling — that\'s why they feel harsh on bumpy roads!' },
    ],
    sliders: [
  ...
  shm_displacement: {
    ...
    steps: [
      { label: 'Projection of Circular Motion', formula: 'x = x_o cos(\u03B8) = x_o cos(\u03C9t)', detail: 'ðŸŽµ A metronome ticks back and forth, marking time for a pianist. Its motion is SHM — the projection of uniform circular motion onto a diameter. Imagine a point moving around a circle at constant angular speed Ï‰. Its x-coordinate traces out a cosine wave over time.' },
      { label: 'Velocity from Derivative', formula: 'v = \u2212\u03C9 x_o sin(\u03C9t) = \u2212\u03C9\u221A(x_o\u00B2 \u2212 x\u00B2)', detail: 'ðŸ“ Displacement: x = xâ‚€ cos(Ï‰t). At t = 0, x = xâ‚€ (fully right). At t = Ï€/(2Ï‰), x = 0 (center). At t = Ï€/Ï‰, x = âˆ’xâ‚€ (fully left). Velocity is the derivative: v = âˆ’Ï‰xâ‚€ sin(Ï‰t). Using sin² + cos² = 1: v = ±Ï‰âˆš(xâ‚€² âˆ’ x²). At the center, speed is maximum. At extremes, speed is zero.' },
      { label: 'Acceleration from Derivative', formula: 'a = \u2212\u03C9\u00B2 x_o cos(\u03C9t) = \u2212\u03C9\u00B2x', detail: 'ðŸ“ Acceleration is the derivative of velocity: a = âˆ’Ï‰²xâ‚€ cos(Ï‰t) = âˆ’Ï‰²x. This is the hallmark of SHM — acceleration is always proportional to displacement and opposite in direction. At the extremes, acceleration is maximum. At center, acceleration is zero.' },
      { label: 'Key SHM Property', formula: 'a = \u2212\u03C9\u00B2x', detail: 'âœ… x = xâ‚€ cos(Ï‰t), v = ±Ï‰âˆš(xâ‚€²âˆ’x²), a = âˆ’Ï‰²x. For a metronome with Ï‰ = 2Ï€ rad/s and xâ‚€ = 0.1 m: at t = 0.2 s, x = 0.1×cos(2Ï€×0.2) = 0.1×cos(72°) = 0.031 m, v = âˆ’2Ï€×0.1×sin(72°) = âˆ’0.6 m/s, a = âˆ’(2Ï€)²×0.031 = âˆ’1.22 m/s². This simple pattern describes everything from guitar strings to swaying buildings!' },
    ],
    sliders: [
  ...
  simple_pendulum: {
    ...
    steps: [
      { label: 'Restoring Force on Bob', formula: 'F = \u2212mg sin\u03B8', detail: 'ðŸ•°ï¸ You\'re watching a grandfather clock. The pendulum swings majestically — and it keeps near-perfect time because its period doesn\'t depend on how wide it swings (for small angles). Galileo supposedly discovered this watching a swinging chandelier in Pisa Cathedral, timing it with his pulse.' },
      { label: 'Small Angle Approximation', formula: 'F \u2248 \u2212mg \u03B8 = \u2212mg (x/l)', detail: 'ðŸ“ The restoring force is the component of gravity along the arc: F = âˆ’mg sin Î¸. For small angles (Î¸ < 15°), sin Î¸ â‰ˆ Î¸. And arc length x = LÎ¸, so Î¸ = x/L. Therefore F â‰ˆ âˆ’mg(x/L) = âˆ’(mg/L)x. The force is proportional to displacement — SHM!' },
      { label: 'Apply Newton\'s Second Law', formula: 'ma = \u2212(mg/l) \\times \u21D2 a = \u2212(g/l) x', detail: 'ðŸ§® Using F = ma: ma = âˆ’(mg/L)x. The mass m cancels! a = âˆ’(g/L)x. Comparing with a = âˆ’Ï‰²x: Ï‰² = g/L. The period depends only on length and gravity — not on mass or amplitude.' },
      { label: 'Solve for Period', formula: 'T = 2\u03C0 / \u03C9 = 2\u03C0 \u221A(l/g)', detail: 'âœ… T = 2Ï€âˆš(L/g). A 1 m pendulum: T = 2Ï€âˆš(1/9.81) = 2.01 s. This is why grandfather clocks have pendulums about 1 m long — each swing takes one second. On the Moon (g = 1.62 m/s²), the same pendulum would take T = 2Ï€âˆš(1/1.62) = 4.93 s — nearly 5 seconds per swing!' },
    ],
    sliders: [
  ...
  shm_energy: {
    ...
    steps: [
      { label: 'Elastic Potential Energy', formula: 'PE = \\frac{1}{2} k x\u00B2', detail: 'ðŸªƒ You\'re bouncing on a trampoline. At the top, you\'re momentarily motionless — all your energy is gravitational potential. As you fall, PE converts to KE. At the bottom, the mat stretches and stores elastic energy. Then you\'re launched back up. Total mechanical energy is conserved throughout.' },
      { label: 'Kinetic Energy', formula: 'KE = \\frac{1}{2} m v\u00B2', detail: 'ðŸ“ For a mass-spring system: Elastic PE = ½kx². KE = ½mv². At any point, total E = PE + KE = ½kx² + ½mv². Energy sloshes back and forth between these two forms.' },
      { label: 'Substitute SHM Velocity', formula: 'v\u00B2 = \u03C9\u00B2(x_o\u00B2 \u2212 x\u00B2)', detail: 'ðŸ§® Substituting SHM velocity: v² = Ï‰²(xâ‚€² âˆ’ x²) and Ï‰² = k/m: KE = ½m × (k/m)(xâ‚€² âˆ’ x²) = ½k(xâ‚€² âˆ’ x²). Total E = PE + KE = ½kx² + ½k(xâ‚€² âˆ’ x²) = ½kxâ‚€².' },
      { label: 'Total Energy Constant', formula: 'E = \\frac{1}{2}k x_o\u00B2', detail: 'âœ… E_total = ½kxâ‚€² = constant! For a trampoline with k = 5000 N/m bouncing 0.5 m amplitude: E = ½×5000×0.25 = 625 J. This energy is always conserved — it just trades between potential at the extremes and kinetic at the center. A real trampoline loses energy to air resistance and internal friction, which is why you need to keep pumping your legs!' },
    ],
    sliders: [
  ...
  youngs_double_slit: {
    ...
    steps: [
      ...
      { label: 'Constructive Interference (Bright)', formula: 'd sin\u03B8 = m\u03BB, y = m\u03BBL/d', detail: 'ðŸ“ The path difference from the two slits to a point on the screen is Î” = d sin Î¸. If this equals a whole number of wavelengths (mÎ»), the waves arrive in phase and interfere constructively — bright fringe. If it\'s a half-wavelength (m+½)Î», they cancel — dark fringe.' },
      ...
      { label: 'Fringe Spacing', formula: '\u0394y = y_{m+1} \u2212 y_m = \u03BBL/d', detail: 'âœ… Î”y = Î»L/d. For red light (Î» = 650 nm) with d = 0.5 mm, L = 2 m: Î”y = 650×10â»â¹×2/0.0005 = 2.6 mm. Young measured these tiny fringe spacings and calculated the wavelength of light — less than a micrometer! This experiment settled the centuries-old debate: light is a wave.' },
    ],
    sliders: [
  ...
  diffraction_grating: {
    ...
    steps: [
      { label: 'Grating Spacing', formula: 'd = 1 / N', detail: 'ðŸ’¿ You hold a CD up to the light and see a rainbow of colors. The CD\'s surface has a spiral track with grooves spaced 1.6 Î¼m apart — it acts as a diffraction grating! When white light hits it, different wavelengths (colors) bend at different angles, creating the rainbow.' },
      ...
      { label: 'Maxima Condition', formula: 'd sin\u03B8 = m\u03BB', detail: 'ðŸ§® For a grating with 500 lines/mm: d = 1/500 mm = 2×10â»â¶ m. For green light (Î» = 550 nm), m = 1: sin Î¸ = 1×550×10â»â¹/2×10â»â¶ = 0.275, so Î¸â‚ = 16.0°. For red light (Î» = 650 nm): sin Î¸ = 0.325, Î¸â‚ = 19.0°. The colors spread out!' },
      { label: 'Maximum Orders', formula: 'm_max < d/\u03BB', detail: 'âœ… Maximum order: m_max < d/Î». For d = 2 Î¼m, Î» = 550 nm: m_max = floor(2×10â»â¶/550×10â»â¹) = floor(3.64) = 3. You can see up to 3rd order on each side — 6 bright spots plus the central maximum! CD rainbows, spectrometers, and even the beautiful colors of butterfly wings all use diffraction gratings.' },
    ],
    sliders: [
  ...
  electric_potential_point: {
    ...
    keyInsight: 'A Van de Graaff generator dome at 1 Î¼C charge creates 60,000 V — enough to make your hair stand on end. Near a proton at 1 Ã…ngstrÃ¶m, the potential is 14.4 V, enormous at atomic scale.',
    steps: [
      ...
      { label: 'Coulomb\'s Law Field', formula: 'E = (1/4\u03C0\u03B5\u2080) Q / r\u00B2', detail: 'ðŸ“ To find V from a point charge Q, calculate the work to bring a test charge q from infinity to distance r: W = âˆ«_âˆž^r F dr = âˆ«_âˆž^r (kQq/r²) dr. The integral of 1/r² is âˆ’1/r.' },
      ...
      { label: 'Final Result', formula: 'V = kQ / r', detail: 'âœ… V = kQ/r = Q/(4Ï€Îµâ‚€r). For a Van de Graaff generator dome (Q = 1 Î¼C, r = 0.15 m): V = 9×10â¹ × 10â»â¶/0.15 = 60,000 V = 60 kV! That\'s enough to make your hair stand on end. Potential is positive for positive charges, negative for negative. Near a proton (Q = 1.6×10â»¹â¹ C, r = 1 Ã…): V = 14.4 V — a huge potential at the atomic scale!' },
    ],
    sliders: [
  ...
  capacitance: {
    ...
    steps: [
      ...
      { label: 'Equate Both E Expressions', formula: 'V/d = Q/(A\u03B5\u2080)', detail: 'ðŸ§® Solve for Q: Q = (Îµâ‚€A/d)V. Since C = Q/V: C = Îµâ‚€A/d. For a touchscreen sensor (A = 4 mm², d = 0.1 mm glass): C = 8.85×10â»¹²×4×10â»â¶/1×10â»â´ = 3.5×10â»¹³ F = 0.35 pF. Tiny!' },
      { label: 'Capacitance C = Q/V', formula: 'C = \u03B5\u2080 A / d', detail: 'âœ… C = Îµâ‚€A/d. With a dielectric (like glass) of relative permittivity Îµáµ£: C = Îµâ‚€Îµáµ£A/d. For a typical capacitor with A = 0.01 m², d = 0.1 mm: C = 8.85×10â»¹²×0.01/0.0001 = 8.85×10â»¹â° F â‰ˆ 885 pF. Larger plates, closer spacing, and higher-Îµáµ£ dielectrics all increase capacitance.' },
    ],
    sliders: [
  ...
  equivalent_capacitance: {
    ...
    steps: [
      ...
      { label: 'Series: Voltages Add', formula: 'V = V\u2081 + V\u2082 + V\u2083 = Q/C\u2081 + Q/C\u2082 + Q/C\u2083', detail: 'ðŸ“ In SERIES: The same charge Q flows through each capacitor. Q = Qâ‚ = Qâ‚‚ = Qâ‚ƒ. Voltages add: V = Vâ‚ + Vâ‚‚ + Vâ‚ƒ = Q/Câ‚ + Q/Câ‚‚ + Q/Câ‚ƒ = Q(1/Câ‚ + 1/Câ‚‚ + 1/Câ‚ƒ). Since V = Q/C_eq: 1/C_eq = 1/Câ‚ + 1/Câ‚‚ + 1/Câ‚ƒ. Series capacitance is LESS than the smallest individual — like making a thicker insulator.' },
      { label: 'Parallel: Voltage is Constant', formula: 'V = V\u2081 = V\u2082 = V\u2083', detail: 'ðŸ“ In PARALLEL: Voltage is the SAME across each: V = Vâ‚ = Vâ‚‚ = Vâ‚ƒ. Charges add: Q = Qâ‚ + Qâ‚‚ + Qâ‚ƒ = Câ‚V + Câ‚‚V + Câ‚ƒV = V(Câ‚ + Câ‚‚ + Câ‚ƒ). Since Q = C_eqV: C_eq = Câ‚ + Câ‚‚ + Câ‚ƒ. Parallel capacitance ADDS — like making larger plates.' },
  ...
  capacitor_energy: {
    ...
    keyInsight: 'A defibrillator stores 1250 J in a 100 Î¼F capacitor charged to 5000 V — released in 5 ms, that\'s 250,000 W of power for an instant, enough to restart a stopped heart.',
    steps: [
      ...
      { label: 'Area of Triangle', formula: 'E = \\frac{1}{2} Q V', detail: 'ðŸ§® The area is a triangle: Area = ½ × base × height = ½ × Q × V. This area equals the stored energy E. Using Q = CV: E = ½QV = ½CV² = Q²/2C.' },
      { label: 'Using Q = CV', formula: 'E = \\frac{1}{2} C V\u00B2 = Q\u00B2 / 2C', detail: 'âœ… E = ½CV². A defibrillator capacitor: C = 100 Î¼F, charged to 5000 V: E = ½×100×10â»â¶×5000² = 1250 J. That 1250 J is delivered in about 5 ms — a power of 250,000 W for an instant! This is why the patient\'s chest jumps. The same physics powers camera flashes (E = ½×200×10â»â¶×300² = 9 J per flash), delivering a brilliant burst of light.' },
    ],
    sliders: [
  ...
  rc_circuit: {
    ...
    steps: [
      { label: 'Kirchhoff\'s Voltage Law', formula: 'V = IR + Q/C', detail: 'ðŸš— Your car\'s windshield wipers have an intermittent setting — wipe, pause, wipe again. The timing is controlled by an RC circuit: a resistor and capacitor work together to create a precise time delay. The capacitor charges through the resistor, and when it reaches a threshold voltage, the wipers activate.' },
      ...
      { label: 'Charging Solution', formula: 'Q(t) = Q_o(1 \u2212 e\u207B\u1D56/\u1D43\u1D36)', detail: 'ðŸ§® The solution: Q(t) = CV(1 âˆ’ eâ»áµ—/á´¿á¶œ). The charge approaches Qâ‚€ = CV exponentially. Ï„ = RC is the time constant — the time to reach 63% of full charge. After 3Ï„: 95%. After 5Ï„: 99.3% — essentially fully charged.' },
      { label: 'Discharging Solution', formula: 'Q(t) = Q_o e\u207B\u1D56/\u1D43\u1D36', detail: 'âœ… Ï„ = RC. For the wiper circuit (R = 100 kÎ©, C = 100 Î¼F): Ï„ = 100,000 × 100×10â»â¶ = 10 s. The capacitor reaches the threshold at about 7 s, triggering the wiper sweep. Discharging: Q(t) = Qâ‚€eâ»áµ—/á´¿á¶œ. After t = RC, only 37% remains. RC circuits are everywhere — from pacemakers to audio filters to the 60 Hz debounce filter on your keyboard!' },
    ],
    sliders: [
  ...
  ac_power: {
    ...
    keyInsight: 'Your "120 V" household outlet actually swings from +170 V to âˆ’170 V, 60 times per second. The 120 V is the RMS value — the DC voltage that would deliver the same average power to a heater.',
    steps: [
      ...
      { label: 'Using Trig Identity', formula: 'sin\u00B2\u03C9t = (1 \u2212 cos 2\u03C9t)/2', detail: 'ðŸ“ Instantaneous power in a resistor: P(t) = I²R = (Iâ‚€ sin Ï‰t)²R = Iâ‚€²R sin²Ï‰t. The power pulses at twice the frequency — it\'s always positive (heating is the same regardless of current direction), but varies between 0 and Iâ‚€²R.' },
      { label: 'Average Over One Cycle', formula: '<P> = \u00BD I_o\u00B2 R', detail: 'ðŸ§® Average of sin²Ï‰t over a full cycle = ½. So <P> = ½Iâ‚€²R. Define RMS (Root Mean Square) current: I_rms = âˆš(<I²>) = Iâ‚€/âˆš2. Then <P> = I_rms²R = I_rmsV_rms.' },
      { label: 'RMS Current', formula: 'I_rms = I_o/\u221A2, P = I_rms\u00B2 R', detail: 'âœ… <P> = I_rmsV_rms. For US household supply (V_rms = 120 V, I_rms = 10 A): <P> = 1200 W. Peak voltage Vâ‚€ = 120×âˆš2 = 170 V. Peak-to-peak = 340 V! Your \'120 V\' outlet actually swings from +170 V to âˆ’170 V, 60 times per second. The 120 V you read is the RMS value — the DC voltage that would deliver the same average power.' },
    ],
    sliders: [
  ...
  inductive_reactance: {
    ...
    steps: [
      ...
      { label: 'Sinusoidal Current', formula: 'I = I_o sin(\u03C9t)', detail: 'ðŸ“ The voltage across an inductor: V = L(dI/dt). For sinusoidal current I = Iâ‚€ sin Ï‰t: V = L × d(Iâ‚€ sin Ï‰t)/dt = Ï‰LIâ‚€ cos Ï‰t. Notice: voltage involves cos, current involves sin — they\'re 90° out of phase! Voltage LEADS current by 90°.' },
      { label: 'Voltage Leads Current', formula: 'V = L \u00D7 d(I_o sin\u03C9t)/dt = \u03C9L I_o cos(\u03C9t)', detail: 'ðŸ§® The peak voltage Vâ‚€ = Ï‰LIâ‚€. By analogy with Ohm\'s Law (V = IR), define inductive reactance X_L = Vâ‚€/Iâ‚€ = Ï‰L = 2Ï€fL. Like resistance, its unit is ohms. But X_L depends on frequency — at DC (f=0), X_L = 0 (inductor acts as a short). At high frequencies, X_L is huge (inductor blocks AC).' },
      { label: 'Inductive Reactance', formula: 'X_L = V_o / I_o = \u03C9L = 2\u03C0fL', detail: 'âœ… X_L = 2Ï€fL. For a fan motor inductor (L = 0.5 H) at 50 Hz: X_L = 2Ï€×50×0.5 = 157 Î©. At 60 Hz: X_L = 188 Î©. At 1000 Hz: X_L = 3142 Î© — 20× more! This is why inductors are used in audio crossovers: they block high frequencies from reaching the woofer and let low frequencies pass through.' },
    ],
    sliders: [
  ...
  capacitive_reactance: {
    ...
    keyInsight: 'Radio tuners use variable capacitors: at 100 pF, FM frequencies (100 MHz) pass easily (X_C=16 Î©) while AM (1 MHz) is blocked (X_C=1592 Î©) — selecting exactly one station.',
    steps: [
      ...
      { label: 'Sinusoidal Voltage', formula: 'V = V_o sin(\u03C9t)', detail: 'ðŸ“ The current through a capacitor: I = C(dV/dt). For sinusoidal voltage V = Vâ‚€ sin Ï‰t: I = C × d(Vâ‚€ sin Ï‰t)/dt = Ï‰CVâ‚€ cos Ï‰t. Current involves cos, voltage involves sin — also 90° out of phase, but current LEADS voltage (opposite of inductor)!' },
      { label: 'Current Leads Voltage', formula: 'I = C \u00D7 d(V_o sin\u03C9t)/dt = \u03C9C V_o cos(\u03C9t)', detail: 'ðŸ§® Peak current Iâ‚€ = Ï‰CVâ‚€. Define capacitive reactance X_C = Vâ‚€/Iâ‚€ = 1/(Ï‰C) = 1/(2Ï€fC). At DC (f=0), X_C → âˆž (capacitor blocks DC). At high frequencies, X_C → 0 (capacitor passes AC easily). This is why capacitors are used to couple AC signals while blocking DC bias.' },
      { label: 'Capacitive Reactance', formula: 'X_C = V_o / I_o = 1/(\u03C9C) = 1/(2\u03C0fC)', detail: 'âœ… X_C = 1/(2Ï€fC). For a radio tuning capacitor (C = 100 pF) at 1 MHz (AM band): X_C = 1/(2Ï€×10â¶×100×10â»¹²) = 1/(6.28×10â»â´) = 1592 Î©. At 100 MHz (FM band): X_C = 1/(2Ï€×10â¸×10â»¹â°) = 15.9 Î©. The capacitor passes FM easily but resists AM — exactly what a radio tuner needs!' },
    ],
    sliders: [
      { label: 'Frequency (f)', key: 'f', min: 10, max: 1000, step: 10, default: 50, unit: ' Hz' },
      { label: 'Capacitance (C)', key: 'C', min: 1, max: 1000, step: 1, default: 100, unit: ' \u03BCF' },
  ...
  impedance: {
    ...
    keyInsight: 'Speaker crossovers split audio: at 1 kHz the woofer path (with inductor) has Z=32.5 Î© while the tweeter path (with capacitor) has Z=17.8 Î© — each driver gets the frequencies it handles best.',
    steps: [
      ...
      { label: 'Using Ohm\'s Law for Each', formula: 'V_R = IR, V_X = IX_X', detail: 'ðŸ“ In a series RL or RC circuit, the voltages across R and X are 90° out of phase. They add as vectors (Pythagorean theorem), not as simple numbers. The total voltage squared = V_R² + V_X².' },
      { label: 'Substitute', formula: '(IZ)\u00B2 = (IR)\u00B2 + (IX_X)\u00B2', detail: 'ðŸ§® Using Ohm\'s Law for each: V_R = IR (in phase), V_L = IX_L (leading 90°), V_C = IX_C (lagging 90°). Substituting: (IZ)² = (IR)² + (IX)². Cancel I²: Z² = R² + X².' },
      { label: 'Impedance Formula', formula: 'Z = \u221A(R\u00B2 + X\u00B2)', detail: 'âœ… Z = âˆš(R² + X²). For a speaker crossover: woofer path has L = 5 mH (X_L = 2Ï€×1000×0.005 = 31.4 Î© at 1 kHz) and R = 8 Î©: Z_woofer = âˆš(8² + 31.4²) = âˆš1057 = 32.5 Î©. The tweeter path uses a capacitor C = 10 Î¼F (X_C = 1/(2Ï€×1000×10â»âµ) = 15.9 Î© at 1 kHz): Z_tweeter = âˆš(8² + 15.9²) = 17.8 Î©. At 100 Hz, the woofer impedance drops (easier to drive) while the tweeter impedance skyrockets — effectively directing frequencies to the right driver!' },
    ],
    sliders: [
      { label: 'Resistance (R)', key: 'R', min: 10, max: 200, step: 5, default: 100, unit: ' \u03A9' },
  ...
  photoelectric: {
    ...
    steps: [
      ...
      { label: 'Work Function (\u03A6)', formula: '\u03A6 = hf_o', detail: 'ðŸ“ Planck proposed that light comes in discrete packets (quanta) called photons, each with energy E = hf. Here h = 6.63×10â»³â´ J·s is Planck\'s constant — a fundamental constant of nature. Blue light (f â‰ˆ 6.5×10¹â´ Hz) has more energy per photon than red light (f â‰ˆ 4.5×10¹â´ Hz).' },
      { label: 'Conservation of Energy', formula: 'hf = \u03A6 + KE_max', detail: 'ðŸ§® Each metal has a work function Î¦ = hfâ‚€ — the minimum energy needed to eject an electron. For sodium: Î¦ â‰ˆ 2.3 eV. A photon with energy > Î¦ can eject an electron; the excess becomes kinetic energy. Conservation of energy: hf = Î¦ + KE_max.' },
      { label: 'Photoelectric Equation', formula: 'KE_max = hf \u2212 \u03A6', detail: 'âœ… KE_max = hf âˆ’ Î¦. This is Einstein\'s photoelectric equation, for which he won the Nobel Prize. If hf < Î¦, no electrons are ejected — regardless of intensity! Solar panels use this: photons knock electrons loose, creating current. Silicon\'s work function (â‰ˆ 1.1 eV) means it responds to infrared through visible light — perfectly matched to the Sun\'s spectrum!' },
    ],
    sliders: [
  ...
  de_broglie: {
    ...
    keyInsight: 'Electron microscopes achieve 0.0037 nm resolution — 100,000× sharper than visible light — because high-energy electrons have wavelengths far smaller than atoms. A cricket ball\'s wavelength is 10â»³â´ m, undetectably tiny.',
    steps: [
      ...
      { label: 'Equate Both Energies', formula: 'hc/\u03BB = pc \u21D2 h/\u03BB = p', detail: 'ðŸ§® De Broglie\'s bold hypothesis: this applies to ALL matter, not just photons! Any object with momentum p has a wavelength Î» = h/p = h/(mv). An electron (m = 9.11×10â»³¹ kg) moving at v = 10â¶ m/s: Î» = 6.63×10â»³â´/(9.11×10â»³¹×10â¶) = 7.28×10â»¹â° m = 0.73 nm. That\'s smaller than atomic spacing!' },
      { label: 'De Broglie Formula', formula: '\u03BB = h/p = h/(mv)', detail: 'âœ… Î» = h/p = h/(mv). Electron microscopes use this: electrons accelerated to 100,000 eV have Î» â‰ˆ 0.0037 nm — 100,000× smaller than visible light! This is why they can resolve individual atoms. A cricket ball (m = 0.16 kg) moving at 30 m/s has Î» = 1.4×10â»³â´ m — so tiny it\'s undetectable, which is why macroscopic objects don\'t show obvious wave behavior.' },
    ],
    sliders: [
  ...
  mass_defect: {
    ...
    steps: [
      ...
      { label: 'Actual Mass of Nucleus', formula: 'm_nucleus < m_total', detail: 'ðŸ“ A nucleus is made of Z protons and (Aâˆ’Z) neutrons. The total mass of these separate nucleons: m_total = Zm_p + (Aâˆ’Z)m_n. For helium-4 (2 protons, 2 neutrons): m_total = 2×1.00728 + 2×1.00866 = 4.03188 amu.' },
      { label: 'Mass Defect', formula: '\u0394m = [(A\u2212Z)m_n + Zm_p] \u2212 m_nucleus', detail: 'ðŸ§® But the actual mass of a helium-4 nucleus is 4.00151 amu. Mass defect Î”m = 4.03188 âˆ’ 4.00151 = 0.03037 amu = 5.04×10â»²â¹ kg. Using E = Î”m × c²: E = 5.04×10â»²â¹ × (3×10â¸)² = 4.54×10â»¹² J = 28.3 MeV.' },
      { label: 'Einstein\'s E = mc\u00B2', formula: 'E_binding = \u0394m \u00D7 c\u00B2', detail: 'âœ… E_binding = Î”m × c². For helium-4, 28.3 MeV of binding energy holds the nucleus together — that\'s about 7.1 MeV per nucleon. To put this in perspective: 1 kg of nuclear fuel (uranium) releases about 2.5 million times more energy than 1 kg of coal! This is the principle behind both nuclear power and nuclear weapons — harnessing Einstein\'s most famous equation.' },
    ],
    sliders: [
  ...
  decay_law: {
    ...
    keyInsight: 'Carbon-14 dating works because after 5730 years (one half-life), exactly half the ¹â´C remains. By measuring the ratio in ancient wood, archaeologists date samples up to 50,000 years old.',
    steps: [
      ...
      { label: 'Exponential Decay Formula', formula: 'N = N_o e\u207B\u03BB\u1D56', detail: 'âœ… N = Nâ‚€eâ»Ë¡áµ—. For carbon-14 (Î» = 1.21×10â»â´ yearâ»¹), after 5730 years (one half-life): N = Nâ‚€eâ»â°·â¶â¹³ = Nâ‚€/2 — exactly half remains. By measuring the remaining ¹â´C in the ancient wooden tool, you can calculate when the tree was cut down. This works for samples up to about 50,000 years old — beyond that, too little ¹â´C remains.' },
    ],
    sliders: [
  ...
  half_life: {
    ...
    steps: [
      ...
      { label: 'Substitute into Decay Law', formula: 'N_o/2 = N_o e\u207B\u03BB T_{\u00BD}', detail: 'ðŸ“ By definition: at t = T_½, N = Nâ‚€/2. Substitute into the decay law: Nâ‚€/2 = Nâ‚€eâ»Ë¡áµ€_½. Cancel Nâ‚€: 1/2 = eâ»Ë¡áµ€_½.' },
      { label: 'Cancel N_o and Take ln', formula: 'ln\\frac{1}{2} = \u2212\u03BB T_{\u00BD}', detail: 'ðŸ§® Take natural log: ln(1/2) = âˆ’Î»T_½. Since ln(1/2) = âˆ’ln(2) = âˆ’0.693: âˆ’0.693 = âˆ’Î»T_½. So T_½ = 0.693/Î».' },
      { label: 'Solve for T_{\u00BD}', formula: 'T_{\u00BD} = ln(2)/\u03BB = 0.693/\u03BB', detail: 'âœ… T_½ = ln(2)/Î» = 0.693/Î». For fluor-18 (T_½ = 110 min): Î» = 0.693/110 = 0.00630 minâ»¹. If prepared at 8:00 AM and injected at 10:00 AM (2 hours later): N/Nâ‚€ = eâ»â°·â°â°â¶³â°×¹²â° = eâ»â°·â·âµâ¶ = 0.47. Only 47% of the tracer remains active! Different half-lives: uranium-238 (4.5 billion years — Earth\'s age), iodine-131 (8 days — medical treatment), polonium-214 (164 microseconds — barely exists!).' },
    ],
    sliders: [
      { label: 'Decay Constant (\u03BB)', key: 'lam', min: 0.1, max: 2, step: 0.1, default: 0.5, unit: ' s\u207B\u00B9' },
    ],
  ...
  wien_law: {
    ...
    steps: [
      { label: 'Blackbody Radiation', formula: 'Hot objects emit radiation across a spectrum', detail: 'ðŸ”¥ A blacksmith heats a piece of iron. First it glows dull red, then orange, then yellow, then white-hot — and would turn blue if it didn\'t melt first. The color of hot objects tells us their temperature. Wien\'s Displacement Law: the peak wavelength Î»_max is inversely proportional to temperature T.' },
      { label: 'Wien\'s Observation', formula: '\u03BB_max \u221D 1/T', detail: 'ðŸ“ All objects emit thermal radiation. The spectrum has a peak — the wavelength where most energy is emitted. As temperature increases, this peak shifts to shorter (bluer) wavelengths: Î»_max âˆ 1/T.' },
      { label: 'Insert Proportionality Constant', formula: '\u03BB_max \u00D7 T = 2.9\u00D710\u207B\u00B3 m\u00B7K', detail: 'ðŸ§® Wien\'s constant: b = 2.9×10â»³ m·K. Î»_max × T = b. For the Sun (T = 5800 K): Î»_max = 2.9×10â»³/5800 = 500 nm — that\'s green light! Our eyes evolved to be most sensitive to the Sun\'s peak wavelength. For a red star (T = 3000 K): Î»_max = 967 nm (infrared). For a blue star (T = 30,000 K): Î»_max = 97 nm (ultraviolet).' },
      { label: 'Applications', formula: 'T = 2.9\u00D710\u207B\u00B3 / \u03BB_max', detail: 'âœ… Î»_max × T = 2.9×10â»³ m·K. A blacksmith\'s forge at 1300 K: Î»_max = 2.9×10â»³/1300 = 2230 nm (far infrared — you FEEL the heat before you see it glow). At 800 K: Î»_max = 3625 nm. The human body (310 K): Î»_max = 9350 nm — we glow in the infrared! This is how thermal imaging cameras and night vision work.' },
    ],
    sliders: [
  ...
  hubble_law: {
    ...
    steps: [
      { label: 'Hubble\'s Observation', formula: 'v \u221D d', detail: 'ðŸŒŒ You\'re an astronomer at the Mount Wilson Observatory in 1929. Edwin Hubble makes a shocking discovery: every distant galaxy is moving away from us, and the farther away they are, the faster they recede. The universe is expanding! v âˆ d — recession velocity is proportional to distance.' },
      { label: 'Hubble\'s Law', formula: 'v = H_o \u00D7 d', detail: 'ðŸ“ Hubble\'s Law: v = Hâ‚€ × d. Hâ‚€ (the Hubble constant) â‰ˆ 70 km/s/Mpc. A galaxy at 100 Mpc (326 million light-years) recedes at 7000 km/s. A galaxy at 1000 Mpc recedes at 70,000 km/s — that\'s 23% of the speed of light!' },
      { label: 'Age of Universe', formula: 't = d/v = d/(H_o d) = 1/H_o', detail: 'ðŸ§® If the universe has been expanding at a constant rate, we can rewind: time = distance/speed = d/(Hâ‚€d) = 1/Hâ‚€. This gives the age of the universe! t = 1/(70 km/s/Mpc). Convert: 1 Mpc = 3.086×10¹â¹ km, so t = 3.086×10¹â¹/70 = 4.41×10¹â· s â‰ˆ 14 billion years.' },
      { label: 'Calculate Approximate Age', formula: 'T_o = 1/(70 km/s/Mpc) \u2248 13.8 billion years', detail: 'âœ… v = Hâ‚€d, Age â‰ˆ 1/Hâ‚€ â‰ˆ 13.8 billion years. The current best estimate from the Planck satellite: Hâ‚€ = 67.4 km/s/Mpc, giving age = 13.8 billion years. Everything in the universe was once concentrated at a single point — the Big Bang! This discovery transformed our view of the cosmos and earned Hubble a place among the greatest scientists in history.' },
    ],
    sliders: [
  ...
  coriolis: {
    ...
    steps: [
      ...
      { label: 'Velocity on Surface', formula: 'v = \u03C9 R cos(\u03B8)', detail: 'ðŸ“ Earth rotates once per 24 hours: Ï‰ = 2Ï€/86400 = 7.27×10â»âµ rad/s. A point on the equator moves at v = Ï‰R = 7.27×10â»âµ × 6.37×10â¶ = 463 m/s (1670 km/h). At latitude 45°, the rotational speed is v = Ï‰R cos 45° = 327 m/s.' },
      { label: 'Conservation of Angular Momentum', formula: 'L = mvR = \\text{constant}', detail: 'ðŸ§® When air moves toward the equator, it conserves angular momentum: L = mvR cos Î¸ = constant. As latitude decreases, R cos Î¸ increases, so v must decrease — but the air retains its higher eastward speed from higher latitudes, so it appears to deflect to the right in the Northern Hemisphere. The force: F_c = 2mvÏ‰ sin Î¸.' },
      { label: 'Coriolis Force', formula: 'F_c = 2 m v \u03C9 sin\u03B8', detail: 'âœ… F_c = 2mvÏ‰ sin Î¸. For a hurricane-force wind (m = 1 kg of air, v = 50 m/s) at latitude 30°: F_c = 2×1×50×7.27×10â»âµ×0.5 = 0.0036 N/kg. Tiny, but over hundreds of kilometers, it deflects air masses enough to create cyclones! Northern Hemisphere: deflection right. Southern: left. Zero at equator — hurricanes can\'t form there. This is why the Coriolis effect determines global wind patterns and ocean currents.' },
    ],
    sliders: [
  ...
  newton_cannon: {
    ...
    steps: [
      ...
      { label: 'Vertical Fall', formula: 'y = \\frac{1}{2}gt\u00B2', detail: 'ðŸ“ Horizontal motion: x = vt. The ball moves at constant speed horizontally with no air resistance. Vertical motion: y = ½gt². It falls under gravity just like any dropped object. Combining: y = (g/2v²)x² — the path is a parabola.' },
      { label: 'Curved Path', formula: 'y = (g/2v\u00B2) x\u00B2', detail: 'ðŸ§® But Earth is round! It curves away with drop = x²/(2R) over horizontal distance x. For the cannonball to stay at constant height, its fall must match Earth\'s curvature: ½gt² = x²/(2R). Using x = vt: ½gt² = (vt)²/(2R). Cancel ½t²: g = v²/R.' },
      { label: 'Orbital Condition', formula: 'v\u00B2/r = g', detail: 'âœ… Orbital condition: a_c = v²/r = g. Solving: v = âˆš(gR) = âˆš(9.81 × 6.37×10â¶) = 7905 m/s â‰ˆ 7.9 km/s! Newton realized this in the 1680s — more than 250 years before the first rocket reached orbit in 1957 (Sputnik 1). Today, the ISS orbits at about 7.66 km/s, completing a lap around Earth every 90 minutes. Newton\'s thought experiment was the birth of orbital mechanics!' },
    ],
    sliders: [
