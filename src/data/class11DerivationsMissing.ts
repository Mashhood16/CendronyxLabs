// This file contains the missing Class 11 Physics derivations from the original list.
// It will be appended to class11Derivations.ts by the add-missing-class11.mjs script.
// Each entry follows the same DerivationConfig interface.

import { createElement } from 'react';
import { Zap } from 'lucide-react';

const MISSING_DERIVATIONS: Record<string, any> = {
  // ── Unit 3: Projectile Time of Flight ──
  projectile_time_flight: {
    title: "Derivation: Time of Flight of Projectile",
    icon: createElement(Zap, { className: "w-5 h-5 text-white" }),
...
export default MISSING_DERIVATIONS;
