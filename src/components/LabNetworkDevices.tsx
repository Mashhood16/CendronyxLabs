        ...
        <div className="flex-1 bg-slate-950 p-12 flex flex-col items-center justify-center relative shadow-inner bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]">
          ...
          <div className="w-[600px] h-[600px] bg-slate-800 rounded border-8 border-slate-700 shadow-2xl p-4 flex flex-col gap-6 relative">
             ...
             {cables.routerToSwitch && (
               <div className="absolute right-12 top-24 w-2 h-24 bg-blue-500 z-10 shadow-lg border-x border-blue-600"></div>
             )}
             ...
             >
                ...
                <div className="absolute right-[100px] top-[-10px] w-6 h-6 bg-orange-500 border border-orange-400 rounded flex items-center justify-center opacity-50"></div>
             ...
             >
                ...
                <div className="absolute right-[-10px] bottom-4 w-8 h-20 bg-green-800 border border-green-600 rounded flex items-center justify-center rotate-y-12">
                   ...
                   {wifiOnline && <div className="absolute -right-2 top-2 w-1 h-8 bg-sky-400 rounded-full animate-pulse shadow-[0_0_10px_#38bdf8]"></div>} {/* wifi antenna receiving */}
                </div>
             </div>
