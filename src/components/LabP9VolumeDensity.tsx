      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col gap-4">
          ...
          <div className="prose prose-sm">
            ...
            <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 text-blue-900 my-2 flex justify-center text-lg dark:bg-teal-950/20 dark:border-teal-900 dark:text-[#ffffff]">
              &rho; = m / V
            </div>
            <p>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col items-center relative">
          ...
          <div className="flex gap-2 w-full justify-center mb-6">
            ...
            <button 
              ...
              className="px-3 py-1 rounded border text-sm ml-auto flex items-center gap-1 hover:bg-slate-100 dark:bg-[#121212]"
            >
          ...
          <div className="relative w-full h-[300px] bg-slate-100 dark:bg-[#121212] rounded-lg border flex items-end justify-center p-4">
            ...
            {/* Balance */}
            <div className="absolute left-10 bottom-4 w-32 h-16 bg-slate-300 dark:bg-[#121212] rounded flex flex-col items-center shadow-md border border-slate-400 dark:border-[#1c1b1b]">
            ...
            {/* Cylinder */}
            <div className="absolute right-20 bottom-4 w-16 h-48 border-x-2 border-b-2 border-slate-400 dark:border-[#1c1b1b] bg-slate-50 dark:bg-[#121212]/50 rounded-b-lg relative overflow-hidden">
              {/* Ticks */}
