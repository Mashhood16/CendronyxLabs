...
export default function LabP9VolumeDensity({ onExit }: { onExit?: () => void }) {
 ...
 {/* Cylinder */}
 <div className={`absolute right-20 bottom-4 w-16 h-48 border-x-2 border-b-2 border-slate-400 dark:border-[#1c1b1b] bg-slate-50 dark:bg-[#121212]/50 rounded-b-lg relative flex-col `}>
 {/* Ticks */}
