...
export default function LabS8SoapMaking({ onExit }: LabProps) {
 ...
 <div className="lg:overflow-y-auto flex flex-col min- lg: bg-slate-50 dark:!bg-[#000000] font-sans select-none min-h-screen lg:h-screen overflow-x-hidden w-full">
  ...
  {/* Progress Bar */}
  <div className="flex justify-between items-center bg-slate-50 dark:!bg-[#121212] p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b]">
   {steps.map((s, i) => (
  ...
  <div className="flex-1 bg-slate-50 dark:!bg-[#121212] rounded-3xl shadow-lg border border-slate-200 dark:border-[#1c1b1b] p-8 flex flex-col items-center justify-center relative min-h-[400px]">
   ...
   <div className="flex flex-col items-center gap-4">
    <div className="w-64 h-32 bg-[#121212] dark:!bg-[#121212] rounded-xl relative flex justify-center shadow-xl border-b-8 border-slate-900 dark:border-[#1c1b1b]">
     {/* Pan */}
     <div className="absolute -top-8 w-48 h-16 bg-slate-400 dark:bg-[#121212] rounded-b-xl border-x-4 border-b-4 border-slate-500 dark:border-[#1c1b1b] flex flex-col justify-end overflow-hidden">
     <div className="w-full h-10 bg-amber-200/90" />
     </div>
     {/* Handle */}
     <div className="absolute top-[-20px] -right-16 w-20 h-4 bg-[#000000] dark:bg-[#121212] rounded-r-full" />
