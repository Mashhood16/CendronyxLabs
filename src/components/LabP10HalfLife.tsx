...
import { ArrowLeft, RefreshCw, Play, Pause, Activity, Table2, Info, BookOpen } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      <div className="bg-white border-b p-4 flex items-center justify-between sticky top-0 shadow-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">Unit 20: Half-Life Simulation</h1>
            <p className="text-sm text-slate-500">Quantitative analysis of radioactive decay curves.</p>
          </div>
        </div>
        <button onClick={initAtoms} className="flex items-center gap-2 bg-slate-200 px-4 py-2 rounded-md hover:bg-slate-300 font-medium">
