        ...
        <div className="w-[800px] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden border border-slate-300">
           ...
           <div className="flex-1 p-8 overflow-y-auto">
              ...
              <div className="flex items-center gap-4 mb-8 border-b-2 border-green-600 pb-4">
                 ...
                 <div>
                    <h2 className="text-2xl font-bold text-slate-800 uppercase tracking-wider">Cyber Scout Program</h2>
                    <p className="text-slate-500">National Response Centre for Cyber Crime</p>
                 </div>
              </div>
                 ...
                 <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                       <div>
                          ...
                          <input 
                            type="text" 
                            className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-sky-500 ${errors.name ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
                       ...
                       <div>
                          ...
                          <input 
                            type="email" 
                            className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-sky-500 ${errors.email ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
                    ...
                    <div className="grid grid-cols-2 gap-6">
                       <div>
                          ...
                          <input 
                            type="date" 
                            className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-sky-500 ${errors.dob ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
                            value={form.dob} onChange={e => setForm({...form, dob: e.target.value})}
                          />
                          {errors.dob && <p className="text-red-500 text-xs mt-1">{errors.dob}</p>}
                       </div>
                       <div>
                          <label className="block text-sm font-bold text-slate-700 mb-1">Form B / CNIC No.</label>
                          <input 
                            type="text" 
                            maxLength={13}
                            placeholder="13 digits"
                            className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-sky-500 ${errors.cnic ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
                    ...
                    <div className="bg-slate-50 p-4 border border-slate-200 rounded-lg">
                       <h4 className="font-bold text-slate-700 mb-4 text-sm border-b pb-2">Account Security</h4>
                       <div className="space-y-4">
                          <div>
                            <label className="block text-sm font-bold text-slate-700 mb-1">Strong Password</label>
                            <input 
                              type="password" 
                              className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-sky-500 ${errors.password ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
                          ...
                          <div>
                            ...
                            <input 
                              type="password" 
                              className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-sky-500 ${errors.confirmPassword ? 'border-red-500 bg-red-50' : 'border-slate-300'}`}
                              value={form.confirmPassword} onChange={e => setForm({...form, confirmPassword: e.target.value})}
                            />
                            {errors.confirmPassword && <p className="text-red-500 text-xs mt-1">{errors.confirmPassword}</p>}
                          </div>
                       </div>
                       <ul className="text-xs text-slate-500 mt-4 list-disc pl-4">
