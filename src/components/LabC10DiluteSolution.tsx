    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col items-center relative">
            ...
            <div className="w-full bg-[#000000] dark:bg-[#121212] text-green-400 font-mono p-4 rounded-lg shadow-inner mb-8 min-h-[80px] flex items-center justify-center text-center text-lg">{equation}</div>
            <div className="flex gap-8 mb-12">
                <button onClick={addStock} disabled={totalVolume >= maxVolume} className="flex flex-col items-center gap-2 group disabled:opacity-50">
                    <div className="w-16 h-24 bg-blue-100 border-4 border-slate-300 dark:border-[#1c1b1b] rounded-t-lg rounded-b-md relative overflow-hidden group-hover:-translate-y-1 transition-transform shadow-md">
