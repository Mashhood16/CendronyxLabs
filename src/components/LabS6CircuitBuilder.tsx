...
export default function LabS6CircuitBuilder({ onExit }: LabProps) {
 ...
 return (
 <div className="lg:overflow-y-auto flex flex-col min- font-sans bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-white min-h-screen lg:h-screen overflow-x-hidden w-full">
