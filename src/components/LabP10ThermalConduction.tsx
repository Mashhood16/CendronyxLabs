...
export default function LabP10ThermalConduction({ onExit }: LabProps) {
  ...
  const renderGraph = () => {
    ...
    return (
      <svg viewBox="0 0 300 200" className="w-full h-48 bg-white border rounded-md shadow-inner">
        {/* Axes */}
    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      <div className="bg-white border-b p-4 flex items-center justify-between sticky top-0 shadow-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">Unit 10: Thermal Conduction</h1>
            <p className="text-sm text-slate-500">Determine the thermal conductivity of materials using Fourier's Law.</p>
          </div>
        </div>
