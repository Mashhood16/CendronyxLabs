        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col h-full overflow-hidden">
            <div className="p-6 bg-emerald-50 dark:bg-emerald-900/30 border-b border-emerald-100 dark:border-emerald-800/50 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-slate-300">Verbs & Adjectives</h2>
            </div>
            <div className="p-6 overflow-y-auto flex-1 space-y-6 text-slate-700 dark:text-slate-300">
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Transitive vs Intransitive Verbs</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Active vs Passive Voice</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Order of Adjectives</h3>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 flex flex-col h-full overflow-hidden">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-200 dark:border-slate-800">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-slate-300">Sentence Transformer</h2>
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-8">
              ...
              <div>
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-lg font-medium text-slate-900 dark:text-slate-100 text-center py-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">Arrange the words in the correct order to describe the car:</p>
              ...
              {!assessmentSubmitted ? (
                <div className="space-y-6">
                        ...
                        {q.options.map((opt, oIdx) => (
                          <label key={oIdx} className="flex items-start gap-3 cursor-pointer group">
                            <input
                              type="radio"
                              name={`question-${qIdx}`}
                              className="mt-1 w-4 h-4 text-emerald-600 dark:text-emerald-400 bg-slate-100 dark:bg-slate-900/50 border-slate-300 dark:border-slate-600"
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2 px-4 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 dark:bg-slate-900 disabled:dark:bg-slate-700 text-white rounded-lg font-medium transition-colors"
                  >
                    Submit Evaluation
                  </button>
                </div>
