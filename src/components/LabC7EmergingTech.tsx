...
export default function LabC7EmergingTech({ onExit }: LabProps) {
 ...
 className={`p-6 rounded-xl border-2 text-left transition-all ${selectedTech === tech.id ? 'border-blue-500 bg-slate-50 dark:bg-[#121212] shadow-md' : 'border-slate-200 dark:border-[#1c1b1b] bg-slate-50 dark:bg-[#121212]/50 hover:bg-slate-50 dark:bg-[#121212] hover:border-blue-300'}`}
 >
 <h3 className="font-bold text-lg mb-2">{tech.name}</h3>
 <p className="text-sm text-slate-500 dark:text-[#71717a]">{tech.desc}</p>
 </button>
 ))}
 </div>
 ...
 {submitted && (
 <div className="bg-slate-50 dark:!bg-[#121212] p-8 rounded-xl shadow-xl text-center border border-slate-200 dark:border-[#1c1b1b] border-t-8 border-t-blue-500">
