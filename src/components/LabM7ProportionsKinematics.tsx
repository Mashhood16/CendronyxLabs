      ...
      <main className="flex-1 min-w-0 flex lg:overflow-hidden">
        ...
        <div className="w-[400px] lg:w-[450px] flex flex-col border-r border-slate-200 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] p-6 lg:overflow-y-auto z-10 shadow-[2px_0_10px_rgba(0,0,0,0.05)]">
          ...
          <div className="flex bg-slate-200 dark:bg-slate-700 rounded-lg p-1 mb-6 shrink-0">
            <button 
              className={`flex-1 py-2 px-4 rounded-md text-sm font-semibold transition-colors ${activeTab === 'proportions' ? 'bg-white dark:bg-[#121212] text-blue-600 dark:text-blue-400 shadow' : 'text-slate-600 dark:text-[#ffffff] hover:text-slate-800 dark:hover:text-white'}`}
              onClick={() => setActiveTab('proportions')}
            >
              Proportions
            </button>
            <button 
              className={`flex-1 py-2 px-4 rounded-md text-sm font-semibold transition-colors ${activeTab === 'kinematics' ? 'bg-white dark:bg-[#121212] text-blue-600 dark:text-blue-400 shadow' : 'text-slate-600 dark:text-[#ffffff] hover:text-slate-800 dark:hover:text-white'}`}
