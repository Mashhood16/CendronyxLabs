          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-[#1c1b1b]">
            ...
            {feedback.message && (
              <div className={`mt-4 p-4 rounded-lg flex items-start gap-3 ${
                feedback.type === 'success' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200'
              }`}>
