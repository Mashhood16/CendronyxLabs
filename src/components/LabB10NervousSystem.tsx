  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 lg:overflow-hidden">
        {/* Left Column: Theory */}
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 lg:overflow-y-auto">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col items-center relative">
          <div className="flex items-center justify-between w-full mb-4">
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 text-white px-4 py-2 rounded-lg font-medium transition-colors shadow-sm dark:text-white dark:text-white dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-indigo-500/40"
            >
              Strike Knee
            </button>
          </div>

          <div className="bg-[#121212] dark:bg-[#121212] w-full flex-1 rounded-xl flex items-center justify-center overflow-hidden border-4 border-[#1c1b1b] dark:border-[#1c1b1b] relative">
            ...
            <div className="absolute top-4 left-4 bg-[#000000] dark:bg-[#121212]/80 text-white px-4 py-3 rounded-xl backdrop-blur-sm shadow-lg w-64 border border-[#1c1b1b] dark:border-[#1c1b1b]">
