          ...
          {activeTab === 'LCM' ? (
              ...
              <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700 mt-auto">
                ...
                {lcmFeedback.status && (
                  <div className={`mt-4 p-3 rounded-lg flex items-start gap-2 ${
                    lcmFeedback.status === 'correct' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'
                  }`}>
            ...
            <>
              ...
              <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700 mt-auto">
                ...
                {hcfFeedback.status && (
                  <div className={`mt-4 p-3 rounded-lg flex items-start gap-2 ${
                    hcfFeedback.status === 'correct' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'
                  }`}>
              ...
              <div className="flex-1 min-w-0 relative flex justify-center items-end pb-12">
                ...
                <div className="flex justify-around w-full max-w-lg relative z-10">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {/* Light Bulb */}
                    <div className={`absolute top-[-24px] w-24 h-24 rounded-full blur-xl transition-opacity duration-300 ${
                      time > 0 && time % lh1 === 0 ? 'bg-yellow-300 opacity-100' : 'bg-transparent opacity-0'
                    }`}></div>
                    <div className={`absolute top-[-16px] w-12 h-12 rounded-full z-10 border-2 border-slate-300 transition-colors duration-100 flex items-center justify-center ${
                      time > 0 && time % lh1 === 0 ? 'bg-yellow-100 shadow-[0_0_50px_rgba(253,224,71,1)]' : 'bg-slate-200 dark:bg-slate-700'
                    }`}>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {/* Light Bulb */}
                    <div className={`absolute top-[-24px] w-24 h-24 rounded-full blur-xl transition-opacity duration-300 ${
                      time > 0 && time % lh2 === 0 ? 'bg-yellow-300 opacity-100' : 'bg-transparent opacity-0'
                    }`}></div>
                    <div className={`absolute top-[-16px] w-12 h-12 rounded-full z-10 border-2 border-slate-300 transition-colors duration-100 flex items-center justify-center ${
                      time > 0 && time % lh2 === 0 ? 'bg-yellow-100 shadow-[0_0_50px_rgba(253,224,71,1)]' : 'bg-slate-200 dark:bg-slate-700'
                    }`}>
