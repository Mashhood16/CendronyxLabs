...
export default function LabM6Factors({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col min- bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff] font-sans transition-colors duration-300 min-h-screen lg:h-screen overflow-x-hidden w-full">
 {/* Header */}
