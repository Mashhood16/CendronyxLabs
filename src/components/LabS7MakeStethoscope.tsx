...
export default function LabS7MakeStethoscope({ onExit }: LabProps) {
 ...
 <LabHeader onExit={onExit} title={t('lab.s7makestethoscope_unit_11_make_a_stethoscope')} />
 ...
 <h2 className="text-2xl font-bold text-blue-800 mb-4 dark:text-[#ffffff]">{t('lab.s7makestethoscope_amplifying_sound')}</h2>
 <p className="text-slate-600 dark:text-[#a1a1aa] mb-6">{t('lab.s7makestethoscope_a_homemade_stethoscope_is_buil')}</p>
 ...
 {t('lab.s7makestethoscope_hold_against_chest')}
 </button>
 </div>
 </div>
 ...
 <div className="text-slate-700 dark:text-[#ffffff] text-xs font-bold uppercase">{t('lab.s7makestethoscope_no_signal')}</div>
 )}
 </div>
 </div>
