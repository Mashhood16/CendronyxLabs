...
export default function LabC10StandardizationTitration({ onExit }: { onExit?: () => void }) {
 ...
 {/* Tap Controls */}
 <div className="flex gap-2 mb-4 flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex lg:flex-1 overflow-y-auto min-h-0 lg:overflow-hidden rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t">
