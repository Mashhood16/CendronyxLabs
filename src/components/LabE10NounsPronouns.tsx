      ...
      <div className="flex-1 lg:overflow-hidden">
        <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 flex flex-col h-full overflow-hidden">
            <div className="p-6 bg-slate-100 dark:bg-[#121212]/50 border-b border-slate-200 dark:border-neutral-900 flex items-center gap-3">
              <BookOpen className="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Nouns & Pronouns</h2>
            </div>
            <div className="p-6 lg:overflow-y-auto flex-1 space-y-6 text-slate-700 dark:text-[#a1a1aa]">
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Types of Nouns</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Types of Pronouns</h3>
                <ul className="list-disc pl-5 space-y-2 text-sm">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 p-6 flex flex-col h-full overflow-hidden">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-200 dark:border-neutral-900">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Classification Matrix</h2>
            </div>
            
            <div className="mb-4">
              <p className="text-sm text-slate-600 dark:text-[#71717a] mb-3">1. Select a word from the pool below:</p>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${
                      selectedWordId === w.id
                        ...
                        : 'bg-slate-100 dark:bg-[#121212] text-slate-700 dark:text-[#ffffff] hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-[#1c1b1b]'
                    }`}
                  >
                    {w.word}
                  </button>
            ...
            <div className="flex-1 lg:overflow-y-auto mt-4">
              <p className="text-sm text-slate-600 dark:text-[#71717a] mb-3">2. Assign it to the correct category:</p>
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left transition-all ${
                        isHovered 
                          ...
                          : 'border-slate-200 dark:border-[#1c1b1b] bg-slate-50 dark:bg-[#121212]/50 opacity-80 cursor-default'
                      }`}
                    >
                      <h4 className="text-xs font-bold text-slate-500 dark:text-[#71717a] uppercase tracking-wider mb-2">{cat}</h4>
