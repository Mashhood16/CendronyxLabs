                        ...
                        <div className="mt-6 bg-orange-50 p-4 rounded-lg border border-orange-100">
                            ...
                            <div className="space-y-4">
                                ...
                                <button 
                                    ...
                                    className="w-full py-2 bg-orange-600 text-white font-medium rounded-md hover:bg-orange-700 transition dark:text-white dark:text-white dark:bg-orange-500 dark:hover:bg-orange-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-orange-500/40"
                                >
                                    Recalculate Model
                                </button>
                            </div>
