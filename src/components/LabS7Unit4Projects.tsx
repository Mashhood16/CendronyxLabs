      ...
      <div className="flex-1 p-8 flex flex-col items-center">
        <div className="bg-slate-50 dark:!bg-[#121212] p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] max-w-4xl w-full">
          <div className="flex items-center mb-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-slate-800 dark:text-[#ffffff]">Comparative Poster Assignment</h2>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <div className="grid grid-cols-2 gap-8 mt-6">
              <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
                ...
                <p className="text-sm text-slate-600 dark:text-[#a1a1aa]">No new substance is formed. The change is usually reversible.</p>
                <ul>
                  <li>Melting ice</li>
                  <li>Tearing paper</li>
                  <li>Chopping wood</li>
              ...
              <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
                ...
                <p className="text-sm text-slate-600 dark:text-[#a1a1aa]">A new substance with different properties is formed. Usually irreversible.</p>
                <ul>
                  <li>Burning wood</li>
                  <li>Rusting iron</li>
                  <li>Baking a cake</li>
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200 mt-8 dark:bg-teal-950/20 dark:border-teal-900">
              <h4 className="text-blue-800 font-bold mt-0 dark:text-[#ffffff]">Design Requirements</h4>
