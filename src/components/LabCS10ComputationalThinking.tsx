              ...
              {activeTab === 'abstraction' && (
                <div className="flex flex-col h-full gap-4">
                  ...
                  <div className="flex items-center gap-4 text-sm font-medium">
                    Abstraction Level: 
                    <div className="flex-1 h-3 bg-slate-200 dark:bg-[#121212] rounded-full lg:overflow-hidden">
                  ...
                  {/* Visual Map */}
                  <div className="flex-1 border-2 border-dashed border-slate-300 dark:border-[#1c1b1b] rounded-xl relative overflow-hidden bg-amber-50 mt-2 p-4 dark:bg-[#121212] dark:border-[#1c1b1b]">
                    {mapDetails.roads && (
                      <div className="absolute top-1/2 left-0 right-0 h-8 bg-slate-400 dark:bg-[#121212] transform -translate-y-1/2 flex items-center justify-center text-white text-xs font-bold tracking-widest opacity-80">
                        MAIN ROAD
                      </div>
                    )}
                    {mapDetails.parks && (
