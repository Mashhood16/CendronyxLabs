...
export default function LabS8DNAExtraction({ onExit }: LabS8DNAExtractionProps) {
 ...
 <div className="flex-1 bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col items-center justify-end relative ">
 ...
 <div 
 key={step.id} 
 className={`p-4 rounded-xl border-2 transition-all ${ isActive ? 'border-blue-500 bg-blue-50' : isCompleted ? 'border-green-200 bg-green-50 opacity-70' : 'border-slate-100 bg-slate-50 dark:bg-[#121212] opacity-50' }`}
 >
