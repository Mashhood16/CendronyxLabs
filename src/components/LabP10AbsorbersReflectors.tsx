    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col gap-6">
          ...
          <div className="flex-1 relative bg-slate-800 border-2 border-slate-700 rounded-xl flex items-center justify-between px-8 py-4 h-80 overflow-hidden shadow-inner">
            ...
            {/* Shiny Silver Can */}
            <div className="flex flex-col items-center gap-3 z-10">
              <div className="w-24 h-32 bg-slate-200 rounded-lg shadow-xl border-l-4 border-white/70 relative flex items-center justify-center bg-gradient-to-r from-slate-300 via-white to-slate-400">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col gap-6">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-slate-600">Scrub time & record.</span>
            <button 
              onClick={recordData}
          ...
          <div className="max-h-32 overflow-y-auto border border-slate-200 rounded-md">
            <table className="w-full text-sm text-left">
              <thead className="bg-slate-50 sticky top-0 shadow-sm z-10">
                <tr>
                  <th className="px-3 py-2 font-semibold text-slate-700">t (min)</th>
                  <th className="px-3 py-2 font-semibold text-slate-700">Power</th>
                  <th className="px-3 py-2 font-semibold text-slate-700">T_Black</th>
                  <th className="px-3 py-2 font-semibold text-slate-700">T_Silver</th>
                </tr>
              </thead>
