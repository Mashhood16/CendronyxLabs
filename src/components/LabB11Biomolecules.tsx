      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 lg:overflow-hidden">
        ...
        <section className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 lg:overflow-y-auto flex flex-col gap-4">
          ...
          <div className="space-y-4 text-sm text-slate-700 dark:text-[#ffffff]">
            ...
            <div className="bg-slate-100 dark:bg-[#121212] border-l-4 border-[#1c1b1b] dark:border-[#1c1b1b] p-3">
        ...
        <section className="bg-slate-100 dark:bg-[#121212] rounded-xl shadow-inner border border-slate-300 dark:border-[#1c1b1b] p-6 flex flex-col items-center">
          ...
          {/* Controls */}
          <div className="w-full space-y-4 bg-slate-50 dark:!bg-[#121212] p-4 rounded-lg shadow-sm">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                {[
                  ...
                  <button 
                    ...
                    className={`text-sm py-1 rounded border transition-colors ${selectedSample === s.id ? 'bg-emerald-100 border-emerald-500 text-emerald-800 font-bold' : 'bg-slate-50 dark:bg-[#121212] border-slate-200 dark:border-[#1c1b1b] hover:bg-slate-100 dark:bg-[#121212]'}`}
                  >
                    {s.label}
                  </button>
                ))}
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                {[
                  ...
                  <button 
                    ...
                    className={`text-sm py-1 rounded border transition-colors ${selectedReagent === r.id ? 'bg-blue-100 border-blue-500 text-blue-800 font-bold' : 'bg-slate-50 dark:bg-[#121212] border-slate-200 dark:border-[#1c1b1b] hover:bg-slate-100 dark:bg-[#121212]'}`}
                  >
                    {r.label}
                  </button>
                ))}
