...
export default function LabB11Inheritance({ onExit }: { onExit?: () => void }) {
 ...
 {/* Column 2: Simulator */}
 <div className={`w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b] lg:bg-slate-100 dark:bg-[#121212] lg:dark:bg-[#121212] p-6 flex flex-col 'flex' : 'hidden'} lg:flex rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t`}>
 ...
 <div className={`flex-col items-center justify-center flex-1 relative mb-6 min-h-[150px] bg-slate-50 dark:bg-[#121212] rounded-xl border border-slate-200 dark:border-[#1c1b1b] p-4 ${activeMobileTab === 'theory' ? 'flex' : 'hidden'} lg:flex`}>
