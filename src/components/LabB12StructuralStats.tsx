...
export default function LabB12StructuralStats({ onExit }: { onExit?: () => void }) {
 ...
 <div className={`relative w-64 h-64 bg-[#000000] dark:bg-[#121212] rounded-lg flex items-center justify-center shadow-inner border-4 border-[#1c1b1b] dark:border-[#1c1b1b] flex-col `}>
 {/* X-ray pattern */}
