...
export default function LabC6GroupPresentations({ onExit }: LabProps) {
 ...
 if (isPlaying) {
 return (
 <div className="flex bg-[#000000] dark:!bg-[#000000] text-white flex-col items-center justify-center p-8 relative min-h-screen lg:h-screen overflow-x-hidden w-full">
 <button 
