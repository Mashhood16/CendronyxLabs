...
export default function LabB9Enzymes({ onExit }: { onExit?: () => void }) {
 ...
 <div className={`relative bg-slate-100 dark:bg-[#121212] rounded-xl aspect-video border-2 border-slate-200 dark:border-[#1c1b1b] flex-1 flex-col `}>
 ...
 <div className={`bg-emerald-500 h-2 rounded-full transition-all flex-col `} style={{ width: `${progress}%` }}></div>
 </div>
 </div>
 <div className="flex space-x-2">
