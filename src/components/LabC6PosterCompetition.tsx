                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center justify-center text-center gap-2 p-3 rounded-lg border-2 text-xs font-bold transition-colors h-24 ${
                        topic === t.id ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-slate-200 dark:border-[#1c1b1b] text-slate-600 dark:text-[#ffffff] hover:bg-slate-50 dark:bg-[#121212]'
                      }`}
                    >
