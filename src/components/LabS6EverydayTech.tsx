...
export default function LabS6EverydayTech({ onExit }: LabProps) {
 ...
 <LabHeader onExit={onExit} title={t('lab.s6everydaytech_unit_12_technology_in_everyday')} />
 ...
 >
 <Rocket className="w-5 h-5" /> {t('lab.s6everydaytech_satellites')}
 </button>
 <button 
 ...
 >
 <Map className="w-5 h-5" /> {t('lab.s6everydaytech_gps_systems')}
 </button>
 <button 
 ...
 >
 <Radio className="w-5 h-5" /> {t('lab.s6everydaytech_communication')}
 </button>
 </div>
 ...
 <h2 className="text-2xl font-bold text-indigo-800 mb-6 dark:text-[#ffffff]">{t('lab.s6everydaytech_artificial_satellites')}</h2>
 <div className="flex gap-8">
 <div className="flex-1 space-y-4 text-slate-600 dark:text-[#a1a1aa]">
 <p>{t('lab.s6everydaytech_satellites_are_objects_placed_')}</p>
 <p><strong>{t('lab.s6everydaytech_weather_satellites')}</strong> {t('lab.s6everydaytech_help_meteorologists_track_stor')}</p>
 <p><strong>{t('lab.s6everydaytech_observation_satellites')}</strong> {t('lab.s6everydaytech_used_for_map_making_tracking_e')}</p>
 </div>
 ...
 {activeTech === 'gps' && (
 <div className="animate-fade-in">
 <h2 className="text-2xl font-bold text-emerald-800 mb-6">{t('lab.s6everydaytech_global_positioning_system_gps')}</h2>
 <div className="flex gap-8">
 <div className="flex-1 space-y-4 text-slate-600 dark:text-[#a1a1aa]">
 <p>{t('lab.s6everydaytech_gps_is_a_network_of_satellites')}</p>
 <p>{t('lab.s6everydaytech_the_signals_are_obtained_by_gp')}</p>
 <p>{t('lab.s6everydaytech_it_requires_at_least')} <strong>{t('lab.s6everydaytech_4_satellites')}</strong> {t('lab.s6everydaytech_to_accurately_determine_a_3d_p')}</p>
 </div>
 ...
 <div className="animate-fade-in">
 <h2 className="text-2xl font-bold text-blue-800 mb-6 dark:text-[#ffffff]">{t('lab.s6everydaytech_modern_communication_systems')}</h2>
 <div className="flex gap-8">
 <div className="flex-1 space-y-4 text-slate-600 dark:text-[#a1a1aa]">
 <p>{t('lab.s6everydaytech_information_and_communication_')}</p>
 <p><strong>{t('lab.s6everydaytech_the_internet')}</strong> {t('lab.s6everydaytech_a_global_network_connecting_mi')}</p>
 <p><strong>{t('lab.s6everydaytech_mobile_networks')}</strong> {t('lab.s6everydaytech_enable_wireless_communication_')}</p>
 </div>
 ...
 <span className="text-xs font-bold">{t('lab.s6everydaytech_email')}</span>
 </div>
 ...
 <span className="text-xs font-bold">{t('lab.s6everydaytech_messaging')}</span>
 </div>
 ...
 <span className="text-xs font-bold">{t('lab.s6everydaytech_video_call')}</span>
 </div>
 ...
 <span className="text-xs font-bold">{t('lab.s6everydaytech_voice')}</span>
 </div>
 </div>
 </div>
 </div>
