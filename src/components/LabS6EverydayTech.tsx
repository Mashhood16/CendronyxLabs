      ...
      <div className="flex-1 flex flex-col p-8 items-center overflow-y-auto">
        ...
        <div className="flex gap-4 mb-8">
          <button 
            ...
            className={`px-6 py-3 rounded-xl border-2 font-bold flex items-center gap-2 ${activeTech === 'satellites' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-600 dark:text-slate-300 hover:border-indigo-300'}`}
          >
            <Rocket className="w-5 h-5" /> Satellites
          </button>
          <button 
            onClick={() => setActiveTech('gps')}
            className={`px-6 py-3 rounded-xl border-2 font-bold flex items-center gap-2 ${activeTech === 'gps' ? 'border-emerald-500 bg-emerald-50 text-emerald-700' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-600 dark:text-slate-300 hover:border-emerald-300'}`}
          >
            <Map className="w-5 h-5" /> GPS Systems
          </button>
          <button 
            onClick={() => setActiveTech('communication')}
            className={`px-6 py-3 rounded-xl border-2 font-bold flex items-center gap-2 ${activeTech === 'communication' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-600 dark:text-slate-300 hover:border-blue-300'}`}
          >
            <Radio className="w-5 h-5" /> Communication
          </button>
        </div>

        <div className="w-full max-w-4xl bg-slate-50 dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-8 min-h-[400px]">
          
          {activeTech === 'satellites' && (
            <div className="animate-fade-in">
              <h2 className="text-2xl font-bold text-indigo-800 mb-6">Artificial Satellites</h2>
              <div className="flex gap-8">
                <div className="flex-1 space-y-4 text-slate-600 dark:text-slate-300">
                ...
                <div className="w-64 h-64 bg-slate-900 dark:bg-slate-800 rounded-xl relative overflow-hidden border-4 border-slate-800 dark:border-slate-500 shadow-inner flex items-center justify-center">
                  ...
                  {/* Earth */}
                  <div className="w-32 h-32 bg-blue-500 rounded-full shadow-[inset_-10px_-10px_20px_rgba(0,0,0,0.5)] z-10 flex items-center justify-center overflow-hidden">
                     <div className="w-16 h-24 bg-emerald-500 absolute -left-2 top-2 rounded-full opacity-80 blur-[2px]"></div>
                  ...
                  <div className="absolute w-48 h-48 border border-white/20 rounded-full animate-[spin_10s_linear_infinite]">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-4 bg-slate-300 dark:bg-slate-800 flex items-center justify-between px-1">
          ...
          {activeTech === 'gps' && (
            <div className="animate-fade-in">
              ...
              <div className="flex gap-8">
                ...
                <div className="w-64 h-64 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-300 dark:border-slate-700 dark:border-slate-500 shadow-inner relative flex items-center justify-center">
                  {/* Phone screen */}
                  <div className="w-24 h-48 bg-slate-800 dark:bg-slate-800 rounded-xl border-4 border-slate-700 dark:border-slate-500 relative overflow-hidden flex flex-col">
                    <div className="flex-1 bg-[#e5e3df] relative">
                      {/* Map lines */}
                      <div className="absolute top-1/2 left-0 w-full h-2 bg-slate-50 dark:bg-slate-900 -translate-y-1/2"></div>
                      <div className="absolute top-0 left-1/2 w-2 h-full bg-slate-50 dark:bg-slate-900 -translate-x-1/2"></div>
                      {/* Location dot */}
          ...
          {activeTech === 'communication' && (
            <div className="animate-fade-in">
              <h2 className="text-2xl font-bold text-blue-800 mb-6">Modern Communication Systems</h2>
              <div className="flex gap-8">
                <div className="flex-1 space-y-4 text-slate-600 dark:text-slate-300">
                ...
                <div className="w-64 h-64 bg-blue-50 rounded-xl border border-blue-200 shadow-inner p-4 grid grid-cols-2 grid-rows-2 gap-4">
                   <div className="bg-slate-50 dark:bg-slate-900 rounded-lg shadow flex items-center justify-center text-blue-500 flex-col gap-2">
                   ...
                   <div className="bg-slate-50 dark:bg-slate-900 rounded-lg shadow flex items-center justify-center text-emerald-500 flex-col gap-2">
                   ...
                   <div className="bg-slate-50 dark:bg-slate-900 rounded-lg shadow flex items-center justify-center text-purple-500 flex-col gap-2">
                   ...
                   <div className="bg-slate-50 dark:bg-slate-900 rounded-lg shadow flex items-center justify-center text-rose-500 flex-col gap-2">
