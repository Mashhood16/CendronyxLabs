    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 min-h-0">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col lg:overflow-y-auto">
          ...
          <div className="space-y-4 text-sm text-slate-700 dark:text-[#ffffff]">
            ...
            <div className="p-3 bg-orange-50 rounded-lg border border-orange-100">
              ...
              <p className="mt-2 text-xs font-mono bg-slate-50 dark:bg-[#121212] p-2 rounded">
                NO2 + hv → NO + O<br/>
                O + O2 → O3 (Ozone)<br/>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col lg:overflow-y-auto">
          ...
          {activeTab === 'water' && (
            <div className="flex-1 flex flex-col">
              <h3 className="font-semibold text-slate-700 dark:text-[#ffffff] mb-2">Sequence the Treatment Plant</h3>
              <p className="text-sm text-slate-500 dark:text-[#71717a] mb-4">Click the steps in the correct order to build the plant.</p>
              ...
              <div className="bg-slate-100 dark:bg-[#121212] rounded-xl p-4 flex-1 flex flex-col justify-center items-center relative overflow-hidden border-2 border-dashed border-slate-300 dark:border-[#1c1b1b] min-h-[200px]">
          ...
          {activeTab === 'smog' && (
            <div className="flex-1 flex flex-col">
               <h3 className="font-semibold text-slate-700 dark:text-[#ffffff] mb-4">Photochemical Smog Simulator</h3>
               ...
               <div className="bg-sky-100 rounded-xl flex-1 relative overflow-hidden flex items-end justify-center border border-sky-200 min-h-[200px]">
                  ...
                  <div className="w-full h-1/3 bg-[#121212] dark:bg-[#121212] flex items-end justify-around px-4">
                    ...
                    <div className="w-16 h-20 bg-slate-500 dark:bg-[#121212]" />
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col lg:overflow-y-auto">
          ...
          <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-lg border border-slate-200 dark:border-[#1c1b1b] mb-4 shrink-0">
            <h3 className="font-semibold text-slate-800 dark:text-[#ffffff] mb-2">Water Plant Operations Log</h3>
          ...
          <div className="mt-auto pt-4 border-t border-slate-200 dark:border-[#1c1b1b] shrink-0">
            <h3 className="font-bold text-slate-800 dark:text-[#ffffff] mb-2">Chlorination Calculation</h3>
