  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <main className="flex-1 min-w-0 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4">
        ...
        {/* MIDDLE: Simulator */}
        <div className="bg-slate-50 dark:bg-[#121212] p-6 rounded-lg shadow flex flex-col items-center justify-center border-t-4 border-fuchsia-500 relative">
          <h2 className="text-xl font-bold text-gray-800 dark:text-[#ffffff] absolute top-4 left-6">Transformation Space</h2>
          
          <svg viewBox="-10 -10 20 20" className="w-full h-80 max-w-md mt-6 border border-gray-200 rounded-lg shadow-inner bg-slate-50 dark:bg-[#121212]">
            {/* Grid lines */}
            {[...Array(21)].map((_, i) => (
