    ...
    <div className="flex flex-col min-h-screen lg:h-screen bg-slate-50 dark:bg-[#000000] font-sans select-none text-slate-800 dark:text-white overflow-x-hidden w-full">
      ...
      <div className="lg:hidden w-full px-4 py-4 md:px-6 grid grid-cols-2 gap-2 shrink-0">
        ...
        <button onClick={() => setActiveMobileTab('lab')}
          className={`py-3 text-sm font-bold rounded-xl transition-all text-center ${activeMobileTab === 'lab' ? 'bg-cyan-600 text-white shadow-md' : 'bg-white dark:bg-[#1c1b1b] text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-gray-700'}`}>Simulation</button>
      </div>
            ...
            <div className="space-y-3">
              ...
              <div className="relative h-36 bg-white dark:bg-[#1c1b1b] rounded-lg overflow-hidden border border-slate-300 dark:border-[#2a2a2a]">
                ...
                <div className="absolute top-2 right-2 bg-black/80 rounded-lg px-3 py-1.5 text-center min-w-[110px] border border-[#1c1b1b]">
                  <p className="text-[7px] text-slate-400 font-semibold">PRESSURE</p>
                ...
                <div className="absolute left-2 top-0 bottom-0 flex items-center">
                  ...
                  <div className="absolute bottom-2 left-1.5 text-[7px] text-cyan-400 font-mono">h = {depth}m</div>
                </div>
              </div>
