...
export default function LabCS11Research({ onExit }: { onExit?: () => void }) {
 ...
 <div className={`flex-1 flex-col items-center justify-center bg-slate-50 dark:bg-[#121212] rounded-lg border border-slate-200 dark:border-[#1c1b1b] p-6 relative lg:${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
