  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] lg:overflow-y-auto">
          ...
          <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100 mb-4 dark:bg-[#121212] dark:border-[#1c1b1b]">
          ...
          {view === 'form' ? (
            <div className="flex-1 flex flex-col space-y-4 lg:overflow-y-auto pr-2">
              {questions.map((q, index) => (
                <div key={q.id} className="p-4 border border-slate-200 dark:border-[#1c1b1b] rounded-lg bg-slate-50 dark:bg-[#121212] relative group">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 dark:bg-[#121212] rounded-lg border border-slate-200 dark:border-[#1c1b1b] p-6 relative lg:overflow-hidden">
