      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-grow">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] p-6 rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] lg:overflow-y-auto">
          ...
          <div className="space-y-4 text-slate-600 dark:text-[#a1a1aa] text-sm">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-100 dark:bg-teal-950/20 dark:border-teal-900">
            ...
            <div className="p-4 bg-rose-50 rounded-lg border border-rose-100 dark:bg-[#121212] dark:border-[#1c1b1b]">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] p-6 rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] flex flex-col items-center relative overflow-hidden">
          ...
          <div className="flex-grow flex flex-col items-center justify-center w-full space-y-8">
            {/* Ruler area */}
            <div className="relative w-24 h-64 bg-slate-100 dark:bg-[#121212] border-2 border-slate-300 dark:border-[#1c1b1b] rounded-md overflow-hidden flex justify-center">
              <div 
