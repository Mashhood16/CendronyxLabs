  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 p-4 grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border p-5 flex flex-col gap-6">
          <div>
            ...
            <div className="bg-slate-100 dark:bg-[#121212] p-3 rounded-lg text-sm text-center font-mono text-slate-800 dark:text-[#ffffff] font-bold mb-3 border border-slate-200 dark:border-[#1c1b1b]">
              c = ΔE / (m × ΔT)
            </div>
          ...
          <div className="border-t pt-4">
            ...
            <div className="space-y-5">
              <div>
                ...
                <select 
                  className="w-full p-2 border rounded-md bg-slate-50 dark:bg-[#121212] disabled:opacity-50 outline-none focus:border-blue-500"
                  value={material}
        ...
        <div className="bg-[#000000] dark:!bg-[#121212] rounded-2xl shadow-sm border border-[#1c1b1b] dark:border-[#1c1b1b] p-5 flex flex-col relative overflow-hidden min-h-[400px]">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border flex flex-col overflow-hidden h-[calc(100vh-8rem)] min-h-[500px]">
          ...
          {/* Graph Section */}
          <div className="h-48 border-t border-b bg-slate-50 dark:bg-[#121212] relative p-4 shrink-0">
            {recordedData.length > 0 ? (
