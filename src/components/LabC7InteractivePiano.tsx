...
export default function LabC7InteractivePiano({ onExit }: LabProps) {
 ...
 return (
 <div className="flex flex-col font-sans text-slate-100 min-h-screen lg:h-screen overflow-x-hidden w-full" style={{backgroundColor: '#0f172a'}}>
 ...
 className={`w-16 mx-1 border-2 border-b-8 rounded-b-lg cursor-pointer transition-all flex items-end justify-center pb-4 ${activeKey === key.id ? 'bg-slate-200 dark:bg-[#121212] border-slate-400 dark:border-slate-500 border-b-4 translate-y-2' : 'bg-slate-50 dark:bg-[#121212] border-slate-300 dark:border-[#1c1b1b] shadow-[0_4px_10px_rgba(0,0,0,0.5)] hover:bg-slate-50 dark:bg-[#121212]' }`}
 >
