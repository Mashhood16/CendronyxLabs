  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      <div className="bg-white border-b p-4 flex items-center gap-4 sticky top-0 shadow-sm z-10">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-800">Unit 19: Amplitude Modulation</h1>
          <p className="text-sm text-slate-500">Analyze how a carrier wave is modulated by an information signal.</p>
        </div>
      </div>
