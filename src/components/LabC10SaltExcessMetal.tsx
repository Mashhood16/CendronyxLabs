    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col items-center relative">
            ...
            <div className="w-full bg-[#000000] dark:bg-[#121212] text-green-400 font-mono p-4 rounded-lg shadow-inner mb-6 min-h-[80px] flex items-center justify-center text-center text-lg">{equation}</div>
            ...
            <div className="flex gap-4 mb-8">
                ...
                <button onClick={() => setIsFiltered(true)} disabled={!hasExcessZn || isFiltered} className="flex items-center gap-1 px-3 py-2 bg-blue-100 text-blue-800 border border-blue-300 rounded hover:bg-blue-200 disabled:opacity-50 text-sm font-medium dark:text-[#ffffff]"><Filter size={16}/> Filter</button>
