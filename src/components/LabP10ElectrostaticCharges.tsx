      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col gap-6">
          <div>
            ...
            <div className="bg-slate-100 dark:bg-[#121212] p-3 rounded-lg text-center font-serif text-lg text-slate-800 dark:text-[#ffffff] mb-2">
              F = k · |q₁q₂| / r²
            </div>
        ...
        <div className="bg-[#000000] dark:!bg-[#121212] rounded-2xl shadow-sm border border-[#1c1b1b] dark:border-[#1c1b1b] p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="bg-[#121212] dark:bg-[#121212] p-4 rounded-xl border border-[#1c1b1b] dark:border-[#1c1b1b] flex flex-col items-center">
