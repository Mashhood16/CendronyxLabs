  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 min-h-0">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col relative overflow-hidden">
          <h2 className="text-lg font-bold text-slate-800 dark:text-[#ffffff] mb-2">Reactor Control Panel</h2>
          
          <div className="flex gap-4 mb-4 bg-slate-100 dark:bg-[#121212] p-3 rounded-lg">
          ...
          <div className="flex-1 border-2 border-slate-200 dark:border-[#1c1b1b] rounded-lg bg-[#000000] dark:bg-[#121212] relative overflow-hidden flex items-center justify-center">
            {meltdown ? (
