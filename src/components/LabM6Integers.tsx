              ...
              <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-xl border border-slate-200 dark:border-[#1c1b1b] mt-auto">
                ...
                {tempFeedback.status && (
                  <div className={`mt-4 p-3 rounded-lg flex items-start gap-2 ${
                    tempFeedback.status === 'correct' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'
                  }`}>
            ...
            <>
              ...
              <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-xl border border-slate-200 dark:border-[#1c1b1b] mt-auto">
                ...
                {depthFeedback.status && (
                  <div className={`mt-4 p-3 rounded-lg flex items-start gap-2 ${
                    depthFeedback.status === 'correct' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'
                  }`}>
        ...
        <div className="w-1/2 relative overflow-hidden flex flex-col bg-[#000000]">
          {activeTab === 'TEMP' ? (
            <div className={`w-full h-full flex items-center justify-center transition-colors duration-700 ${
              ...
              tempValue > 0 ? 'bg-gradient-to-b from-yellow-300 to-orange-500' : 
              tempValue > -50 ? 'bg-gradient-to-b from-sky-400 to-blue-600' : 
