...
export default function LabS8LaserMaze({ onExit }: LabProps) {
 ...
 <div className="lg:overflow-y-auto flex flex-col min- lg: bg-slate-50 dark:!bg-[#000000] font-sans select-none min-h-screen lg:h-screen overflow-x-hidden w-full">
  ...
  <div className="w-full bg-[#000000] dark:!bg-[#121212] rounded-2xl shadow-xl border-4 border-[#1c1b1b] dark:border-[#1c1b1b] p-8 flex flex-col items-center relative overflow-hidden h-[500px]">
   
   {/* Laser Source */}
   <div className="absolute left-0 top-[140px] flex items-center">
    <div className="w-12 h-8 bg-slate-700 dark:bg-[#121212] rounded-r-md border border-slate-500 dark:border-[#1c1b1b] flex items-center justify-end pr-1 z-20">
   ...
   {/* Obstacles */}
   <div className="absolute left-[180px] top-0 w-8 h-[120px] bg-[#121212] dark:bg-[#121212] border border-slate-600 dark:border-[#1c1b1b] rounded-b-md" />
   <div className="absolute left-[180px] bottom-0 w-8 h-[120px] bg-[#121212] dark:bg-[#121212] border border-slate-600 dark:border-[#1c1b1b] rounded-t-md" />
   <div className="absolute left-[180px] top-[180px] w-8 h-[40px] bg-[#121212] dark:bg-[#121212] border border-slate-600 dark:border-[#1c1b1b] rounded-sm" />
   ...
   <button 
    ...
    className="absolute w-12 h-12 -translate-x-1/2 -translate-y-1/2 z-30 flex items-center justify-center rounded-full hover:bg-slate-50 dark:bg-[#121212]/10 active:bg-slate-50 dark:bg-[#121212]/20 transition-colors"
   ...
   <button 
    ...
    className={`px-8 py-3 rounded-full font-bold text-lg flex items-center gap-2 shadow-lg transition-all active:scale-95 ${laserOn ? 'bg-red-600 hover:bg-red-700 text-white shadow-red-500/50' : 'bg-slate-200 dark:bg-[#121212] hover:bg-slate-300 dark:bg-[#121212] text-slate-800 dark:text-slate-100'}`}
   >
