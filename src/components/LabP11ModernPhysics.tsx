    ...
    return (
        <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
            ...
            <main className="flex-1 p-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Left Column: Theory */}
                <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col h-full lg:overflow-y-auto">
                    ...
                    {activeTab === 'mass-energy' && (
                        <div className="space-y-4 text-slate-600 dark:text-[#a1a1aa] leading-relaxed">
                            ...
                            <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-lg text-sm font-mono border border-slate-200 dark:border-[#1c1b1b] space-y-1 mt-4">
                    ...
                    {activeTab === 'synchrotron' && (
                        <div className="space-y-4 text-slate-600 dark:text-[#a1a1aa] leading-relaxed">
                            ...
                            <div className="bg-slate-50 dark:bg-[#121212] p-4 rounded-lg text-sm font-mono border border-slate-200 dark:border-[#1c1b1b] mt-4">
                                <p className="text-indigo-700 font-bold mb-2">Reference Data:</p>
