...
export default function LabCS11Impacts({ onExit }: { onExit?: () => void }) {
 ...
 <LabHeader onExit={onExit} title={t('lab.cs11impacts_lab_global_impacts_ethics')} />
 ...
 {t('lab.cs11impacts_theory')}
 </button>
 <button 
 onClick={() => setActiveMobileTab('lab')}
 className={`w-full py-3 text-sm font-bold rounded-xl transition-all text-center ${activeMobileTab === 'lab' ? 'bg-[#4158D1] text-white shadow-md' : 'bg-white dark:bg-[#1c1b1b] text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-gray-700'}`}
 >{t('lab.cs11impacts_lab')}</button>
 </div>
 <div className="lg:flex-1 flex flex-col lg:grid lg:grid-cols-3 gap-0 lg:gap-6 p-6 lg:min-h-0 lg:overflow-hidden">
 {/* Left Col */}
 ...
 <h2 className="text-xl font-bold text-slate-800 dark:text-[#ffffff] border-b pb-2 shrink-0">{t('lab.cs11impacts_concepts_theory')}</h2>
 ...
 {t('lab.cs11impacts_data_bias_evaluator')}
 </button>
 <button 
 ...
 {t('lab.cs11impacts_web_accessibility')}
 </button>
 </div>
 ...
 {activeTab === 'bias' ? (
 <>
 <p><strong>{t('lab.cs11impacts_selection_bias')}</strong> {t('lab.cs11impacts_occurs_when_the_sample_data_co')}</p>
 <p>{t('lab.cs11impacts_consider_a_survey_measuring_in')}</p>
 <ul className="list-disc pl-5 space-y-1">
 <li><strong>{t('lab.cs11impacts_urban_areas')}</strong> {t('lab.cs11impacts_left_generally_have_high_conne')}</li>
 <li><strong>{t('lab.cs11impacts_rural_areas')}</strong> {t('lab.cs11impacts_right_generally_have_low_conne')}</li>
 </ul>
 <div className={`p-3 bg-red-50 border border-red-100 rounded-md mt-4 text-red-900 flex-col `}>
 <p className="font-semibold mb-1">{t('lab.cs11impacts_impact')}</p>
 
 {t('lab.cs11impacts_deploying_a_survey_only_in_eas')}
 </div>
 </>
 ) : (
 <>
 <p><strong>{t('lab.cs11impacts_web_accessibility_a11y')}</strong> {t('lab.cs11impacts_ensures_that_digital_tools_are')}</p>
 <ul className="list-disc pl-5 space-y-2">
 <li><strong>{t('lab.cs11impacts_screen_readers')}</strong> {t('lab.cs11impacts_software_that_dictates_page_co')}</li>
 <li><strong>{t('lab.cs11impacts_semantic_html')}</strong> {t('lab.cs11impacts_critical_for_screen_readers_to')}</li>
 </ul>
 <div className={`p-3 bg-slate-50 dark:bg-[#121212] border border-slate-200 dark:border-[#1c1b1b] rounded-md mt-4 flex-col `}>
 
 {t('lab.cs11impacts_when_designing_applications_we')}
 </div>
 </>
 )}
 </div>
 ...
 {t('lab.cs11impacts_survey_x_position')}
 ...
 {t('lab.cs11impacts_survey_y_position')}
 ...
 <text x="100" y="20" textAnchor="middle" fontSize="12" fill="#3b82f6" fontWeight="bold">{t('lab.cs11impacts_urban_area')}</text>
 <text x="300" y="20" textAnchor="middle" fontSize="12" fill="#d97706" fontWeight="bold">{t('lab.cs11impacts_rural_area')}</text>
 ...
 <text x={boxX + boxW/2} y={boxY - 5} textAnchor="middle" fontSize="10" fill="#16a34a" fontWeight="bold" className="transition-all duration-100">{t('lab.cs11impacts_survey_region')}</text>
 </svg>
 </div>
 ...
 <div className="text-xs text-slate-500 dark:text-[#71717a] font-bold uppercase tracking-wider mb-1">{t('lab.cs11impacts_pop_mean_connectivity')}</div>
 ...
 <div className="text-xs text-green-600 font-bold uppercase tracking-wider mb-1">{t('lab.cs11impacts_sample_mean_n')}{samplePoints.length})</div>
 ...
 <Globe size={18} /> {t('lab.cs11impacts_web_page_preview')}
 </span>
 <button 
 ...
 {t('lab.cs11impacts_screen_reader')} {srMode ? 'ON' : 'OFF'}
 </button>
 </div>
 
 <div className={`flex-1 p-8 bg-slate-50 dark:bg-[#121212] transition-all duration-500 ${srMode ? 'blur-[4px] grayscale opacity-40' : ''}`}>
 <h1 className="text-3xl font-bold mb-4 text-slate-800 dark:text-[#ffffff]">{t('lab.cs11impacts_travel_blog')}</h1>
 <p className="text-slate-600 dark:text-[#a1a1aa] mb-6">{t('lab.cs11impacts_check_out_my_recent_trip_to_pa')}</p>
 ...
 {t('lab.cs11impacts_image_eiffel_tower_pic_final_v')}
 </div>
 <button className="bg-blue-600 hover:bg-blue-700 transition-colors text-white px-6 py-2 rounded-lg font-bold dark:text-white dark:text-white dark:bg-blue-500 dark:hover:bg-blue-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-blue-500/40">{t('lab.cs11impacts_read_more')}</button>
 </div>
 ...
 <EyeOff size={16} className="text-blue-400"/> {t('lab.cs11impacts_screen_reader_audio_transcript')}
 </div>
 <div className="space-y-1.5">
 <p>{t('lab.cs11impacts_gt')} {"<Heading Level 1> Travel Blog"}</p>
 <p>{t('lab.cs11impacts_gt')} {"<Paragraph> Check out my recent trip to Paris!"}</p>
 <p className="text-red-400 bg-red-900/30 inline-block px-1 rounded">{t('lab.cs11impacts_gt')} {"<Image> eiffel underscore tower underscore pic underscore final underscore v2 dot jpg"}</p>
 <p>{t('lab.cs11impacts_gt')} {"<Button> Read More"}</p>
 </div>
 </div>
 )}
 </div>
 ...
 <h2 className="text-xl font-bold text-slate-800 dark:text-[#ffffff] border-b pb-2 mb-4 shrink-0">{t('lab.cs11impacts_assessment_validation')}</h2>
 
 <div className="space-y-6 flex-1 pr-2">
 {activeTab === 'bias' ? (
 <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 dark:bg-teal-950/20 dark:border-teal-900">
 <h3 className="font-semibold text-blue-800 mb-2 dark:text-[#ffffff]">{t('lab.cs11impacts_q_calculating_bias')}</h3>
 <p className="text-sm text-blue-900 mb-4 leading-relaxed dark:text-[#ffffff]">
 
 {t('lab.cs11impacts_move_the_survey_box_completely')}<br/><br/>
 <code className="bg-slate-50 dark:bg-[#121212] px-2 py-1 rounded border">{t('lab.cs11impacts_bias_sample_mean_population_me')}</code>
 </p>
