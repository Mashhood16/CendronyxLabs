...
export default function LabS7XylemTransport({ onExit }: LabProps) {
 ...
 return (
 <div className="lg:overflow-y-auto flex flex-col min- bg-blue-50 font-sans dark:bg-teal-950/20 dark:border-teal-900 min-h-screen lg:h-screen overflow-x-hidden w-full">
