...
export default function LabP10LatentHeat({ onExit }: LabProps) {
 ...
 <div className={`flex-1 bg-slate-50 dark:bg-[#121212] rounded-lg border border-slate-200 dark:border-[#1c1b1b] p-4 relative min-h-[200px] w-full lg:flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
