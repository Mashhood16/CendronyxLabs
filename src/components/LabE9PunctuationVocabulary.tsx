        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="bg-white dark:!bg-[#121212] dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 flex flex-col h-full overflow-hidden">
            <div className="p-6 bg-slate-100 dark:bg-[#121212] dark:bg-[#121212] border-b border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">The Style Guide</h2>
            </div>
            <div className="p-6 lg:overflow-y-auto flex-1 space-y-6 text-slate-700 dark:text-[#a1a1aa] dark:text-[#a1a1aa]">
              
              <div className="space-y-4">
                <h3 className="font-bold text-slate-900 dark:text-[#a1a1aa] dark:text-white border-b border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] pb-2 flex items-center gap-2">
                ...
                <div className="bg-slate-50 dark:bg-[#121212] dark:bg-[#121212] p-3 rounded-lg border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b]">
                ...
                <p className="text-xs text-slate-500 dark:text-[#71717a]">While euphemisms are polite, editors often remove them to ensure clarity and directness in journalistic writing.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-5 text-sm space-y-2">
                  <li><strong>Rule:</strong> Hyphenate before the noun. <br/><span className="text-slate-500 dark:text-[#71717a] italic">"He is a well-known author."</span></li>
                  <li><strong>Rule:</strong> Do NOT hyphenate after the noun. <br/><span className="text-slate-500 dark:text-[#71717a] italic">"The author is well known."</span></li>
                  <li><strong>Rule:</strong> Do NOT hyphenate with '-ly' adverbs. <br/><span className="text-slate-500 dark:text-[#71717a] italic">"A highly regarded expert."</span></li>
                </ul>
              </div>
          ...
          <div className="bg-white dark:!bg-[#121212] dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 flex flex-col h-full overflow-hidden">
             <div className="p-6 bg-slate-100 dark:bg-[#121212] dark:bg-[#121212] border-b border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Proofreading Desk</h2>
            </div>
            
            <div className="flex-1 lg:overflow-y-auto p-6 lg:p-8 flex flex-col justify-center">
              <div className="max-w-md mx-auto w-full space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-5 bg-slate-50 dark:bg-[#121212] dark:bg-[#121212] rounded-xl border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] shadow-inner">
                    <p className="text-lg font-serif text-slate-800 dark:text-[#a1a1aa] leading-relaxed">
                ...
                <div className="space-y-4">
                  <p className="text-sm font-medium text-slate-600 dark:text-[#71717a] dark:text-[#71717a]">{currentData.prompt}</p>
                ...
                {result !== 'idle' && (
                  <div className={`mt-6 p-5 rounded-xl animate-in fade-in zoom-in duration-300 ${
                    ...
                    {result === 'success' && (
                      <button onClick={nextTask} className="mt-4 flex items-center justify-center gap-2 w-full px-6 py-3 bg-[#000000] dark:bg-slate-100 text-white dark:text-slate-900 font-bold rounded-lg hover:bg-[#121212] dark:hover:bg-slate-200 dark:bg-[#121212] transition-colors">
          ...
          <div className="bg-white dark:!bg-[#121212] dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 flex flex-col h-full overflow-hidden">
            <div className="p-6 bg-slate-100 dark:bg-[#121212] dark:bg-[#121212] border-b border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Revision Logs</h2>
            </div>
            
            <div className="flex-1 lg:overflow-y-auto p-6 space-y-8">
              
              <div className="space-y-4">
                <h3 className="font-semibold text-slate-900 dark:text-[#a1a1aa] border-b border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 pb-2">Recent Edits</h3>
                {logs.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {logs.map(log => (
                      <div key={log.id} className="text-sm p-3 rounded-lg border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 bg-slate-50 dark:bg-[#121212] dark:bg-[#121212]/50">
                        <div className="text-slate-500 dark:text-[#71717a] mb-1 italic line-clamp-1">"{log.original}"</div>
              ...
              <div className="space-y-4 pt-4">
                <h3 className="font-semibold text-slate-900 dark:text-[#a1a1aa] border-b border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] dark:border-neutral-900 pb-2">Style Guide Assessment</h3>
