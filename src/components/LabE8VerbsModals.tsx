               ...
               {activeTab === 'verbs' ? (
                 <div className="space-y-6">
                    <div className="flex justify-between items-center bg-slate-100 dark:bg-[#121212]/50 dark:bg-[#121212]/60 dark:bg-[#121212]/50 p-2 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
                       <button onClick={() => setVerbIndex(Math.max(0, verbIndex - 1))} disabled={verbIndex === 0} className="whitespace-nowrap flex-shrink-0 px-3 py-1 rounded bg-white dark:bg-[#121212] dark:bg-slate-700 shadow disabled:opacity-50 text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] transition-opacity">Prev</button>
                ...
                <div className="space-y-6">
                    <div className="flex justify-between items-center bg-slate-100 dark:bg-[#121212]/50 dark:bg-[#121212]/60 dark:bg-[#121212]/50 p-2 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
                       <button onClick={() => setModalIndex(Math.max(0, modalIndex - 1))} disabled={modalIndex === 0} className="whitespace-nowrap flex-shrink-0 px-3 py-1 rounded bg-white dark:bg-[#121212] dark:bg-slate-700 shadow disabled:opacity-50 text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] transition-opacity">Prev</button>
