...
export default function LabP9DerivationGPE({ onExit }: { onExit?: () => void }) {
 ...
 <LabHeader onExit={onExit} title={t("Derivation: Gravitational PE (Eâ‚š = mgh)")} />
