...
function ForceMomentumInteractive({ onAnswer }: { onAnswer: (correct: boolean) => void }) {
 ...
 <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">{t('lab.p9derivations_momentum_change_p_m_vf_vi')} {mass} × ({vf} âˆ’ {vi}) = <strong>{deltaP} {t('lab.p9derivations_kg_m_s')}</strong></p>
...
const DERIVATIONS: DerivationModule[] = [
 ...
 color: 'blue',
 steps: [
 { label: "Newton's Second Law", content: "ðŸš´ You're cycling at 10 m/s down a neighborhood street when a child suddenly runs out chasing a ball. You slam the brakes. Newton's 2nd law says F = ma — the brake pads squeeze the rim, applying a force that decelerates you. This is the force that will save the day." },
 { label: 'Express Acceleration', content: 'Your speed drops from 10 m/s to 0 in just 2 seconds. That rate of change is acceleration: a = (vf âˆ’ vi)/Î”t = (0 âˆ’ 10)/2 = âˆ’5 m/s². Your body lurches forward — that\'s inertia fighting the change. The negative sign? You\'re slowing down, which means the force is backward.' },
 { label: 'Substitute into F = ma', content: 'You + your bike = 80 kg. F = m × (vf âˆ’ vi)/Î”t = 80 × (0 âˆ’ 10)/2 = âˆ’400 N. Distribute the mass: F = (80×0 âˆ’ 80×10)/2 = (0 âˆ’ 800)/2. Your brakes are applying 400 N of force — about the weight of a small adult pushing against your motion!' },
 { label: 'Introduce Momentum', content: 'Momentum p = mv captures your "quantity of motion." You started with p = 80 × 10 = 800 kg·m/s. Over 2 seconds, that momentum drops to zero. So F = Î”p/Î”t = (0 âˆ’ 800)/2 = âˆ’400 N. Force is simply how fast momentum changes. This is why airbags save lives — they increase impact time Î”t, which reduces the force F!' },
 ],
 ...
 formula: 'v_g = âˆ’(m_b · v_b) / m_g',
 formulaDesc: 'Conservation of momentum gives the recoil velocity of a gun when a bullet is fired.',
 color: 'amber',
 steps: [
 { label: 'Conservation of Momentum', content: "ðŸŽ¯ You're at a shooting range, a 4 kg rifle resting on your shoulder. You breathe, aim at the target, and squeeze the trigger. The gun + bullet form an \"isolated system\" — all the momentum before firing must equal all the momentum after." },
 ...
 { label: 'Final Momentum', content: 'BANG! The bullet rockets forward at 400 m/s. Its momentum: 0.01 × 400 = 4 kg·m/s forward. By conservation, the gun must have âˆ’4 kg·m/s momentum backward into your shoulder: m_b·v_b + m_g·v_g = 0.' },
 { label: 'Solve for v_g', content: 'Solving: v_g = âˆ’(m_b·v_b)/m_g = âˆ’(0.01 × 400)/4 = âˆ’1 m/s. The negative sign? The gun kicks backward into your shoulder at 1 m/s. A heavier gun recoils less — that\'s why competition shooters use massive rifles. Rockets work the same way: exhaust shoots down, the rocket goes up!' },
 ],
 ...
 color: 'indigo',
 steps: [
 { label: 'Average Speed Formula', content: "ðŸ›°ï¸ Imagine throwing a baseball horizontally from the top of a 100 km tall mountain. It arcs downward and lands far away. The further you want it to go, the faster you must throw. Average speed = distance / time — this simple idea is the seed of orbital mechanics." },
 { label: 'Distance in One Orbit', content: 'Now imagine throwing at 7.8 km/s — so fast that the Earth curves away beneath the ball at the same rate it falls! The ball never hits the ground — it orbits. In one full orbit, it travels the circumference of a circle: d = 2Ï€r, where r is the distance from Earth\'s center.' },
 ...
 { label: 'Final Formula', content: 'v = 2Ï€r/T = 2Ï€ × 6,779,000 m / 5,562 s â‰ˆ 7,660 m/s — over 27,000 km/h! Higher orbits are slower: the Moon at 384,000 km orbits at just 1 km/s. The higher you go, the more leisurely your journey around Earth.' },
 ],
 ...
 color: 'cyan',
 steps: [
 { label: 'Force on Base Area', content: "ðŸŠ You jump off a boat into the ocean and dive down. Your ears feel an uncomfortable pressure building. Pressure = force / area — the column of water above you has weight, and that weight pushes on every square millimeter of your body." },
 { label: 'Mass in Terms of Density', content: 'The force is the weight of the water: F = mg. But m = ÏV (density × volume). Seawater density is 1,025 kg/m³ — it\'s heavier than fresh water, which is why floating in the ocean is easier! F = Ï × V × g.' },
 { label: 'Volume of Column', content: 'The volume of water above you = area of your body × depth: V = A × h. So F = Ï × A × h × g. Notice the area A appears — a wider person has more water weight above them. But something magical happens next...' },
 { label: 'Substitute and Simplify', content: 'P = F/A = (Ï × A × h × g)/A = Ïgh. The area CANCELS! Pressure at a given depth is the same for everyone regardless of body shape. At just 10 m deep, pressure doubles to 2 atmospheres. Free divers train for years to handle this — the pressure crushes air spaces like your lungs and sinuses.' },
 ],
 ...
 color: 'emerald',
 steps: [
 { label: 'Pressure on Small Piston', content: "ðŸ”§ You're a mechanic with a 1500 kg car that needs lifting. You place a hydraulic jack under the frame and pump the handle. Pushing the small piston (area = 0.005 m²) with just 240 N of force creates Pâ‚ = 240/0.005 = 48,000 Pa — like pressing a pen tip into your palm." },
 { label: 'Pressure on Large Piston', content: 'Under the car, there\'s a large piston (area = 0.25 m²) that will do the heavy lifting. The pressure acting on it is Pâ‚‚ = Fâ‚‚/Aâ‚‚. We don\'t know Fâ‚‚ yet, but that\'s what we\'re solving for.' },
 { label: 'Pascal’s Principle', content: 'Blaise Pascal discovered something amazing: the 48,000 Pa you created at the pump handle is transmitted through the hydraulic fluid WITHOUT LOSING ANY STRENGTH. Pâ‚‚ = Pâ‚ = 48,000 Pa. The fluid carries your force invisibly to where it\'s needed.' },
 { label: 'Solve for Output Force', content: 'Fâ‚‚/Aâ‚‚ = Fâ‚/Aâ‚, so Fâ‚‚ = (Aâ‚‚/Aâ‚) × Fâ‚ = (0.25/0.005) × 240 = 12,000 N! Your puny 240 N push lifts a full car. Mechanical advantage = 50×. This same principle stops your car when you press the brake pedal, controls massive excavators, and even powers dentist chairs!' },
 ],
 ...
 color: 'yellow',
 steps: [
 { label: 'Work-Energy Theorem', content: "ðŸ›¹ You're at the top of a massive half-pipe, heart pounding. You drop in, and gravity takes over. The work gravity does on you transforms into your kinetic energy: E_k = Work = F × d. The steeper the drop, the more work gravity does." },
 ...
 color: 'purple',
 steps: [
 { label: 'Work Done Lifting', content: "ðŸŽ¢ You're strapped into a roller coaster car, clicking up the first massive hill. The chain lift mechanism groans as it pulls you higher. Every meter you rise stores energy. E_p = Work = F × S — the motor does work against gravity to lift you." },
 { label: 'Force Required', content: 'The force needed to lift the 500 kg car (plus you!) at constant speed equals its weight: F = mg. With two passengers, total mass â‰ˆ 700 kg, so F = 700 × 9.81 = 6,867 N — about the weight of a small car.' },
