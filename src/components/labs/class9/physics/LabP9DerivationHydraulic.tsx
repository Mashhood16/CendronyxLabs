...
export default function LabP9DerivationHydraulic({ onExit }: { onExit?: () => void }) {
 ...
 { label: t('lab.hydraulic_step4_label'), formula: 'Fâ‚‚ = (Aâ‚‚ / Aâ‚) × Fâ‚', detail: t('lab.hydraulic_step4_detail') },
 ];
