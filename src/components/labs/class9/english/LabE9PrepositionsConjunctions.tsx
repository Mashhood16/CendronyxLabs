...
export default function LabE9PrepositionsConjunctions({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col bg-slate-50 dark:bg-[#121212] dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#a1a1aa] selection:bg-[#4158D1]/20 min-h-screen lg:h-screen overflow-x-hidden w-full">
 ...
 <VocabularyPanel words={['because', 'although', 'while', 'however', 'therefore', 'despite', 'during', 'through', 'across', 'between', 'since', 'unless']} title="Key Words" />
 ...
 {/* Window 3: Simulation */}
 <section className={`w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b] lg:bg-slate-100 dark:bg-[#121212] lg:dark:bg-[#0a0a0a] rounded-xl shadow-sm border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] relative p-4 md:p-8 lg:min-h-[35vh] flex-col '' : ''} ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
