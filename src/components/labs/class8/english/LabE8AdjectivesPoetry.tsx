...
export default function LabE8AdjectivesPoetry({ onExit }: { onExit?: () => void }) {
 ...
 <LabHeader onExit={onExit} title={t('lab.e8adjectivespoetry_poet_s_workshop_adjective_stud')} />
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['wind', 'wolf', 'night', 'stars', 'diamonds', 'moon', 'trees', 'whisper', 'mountain', 'cheetah', 'friend', 'box', 'wood']}
 title="Key Words"
 />
 {activeTab === 'poetry' ? (
