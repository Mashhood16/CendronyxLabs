...
import { ArrowRight, CheckCircle2, XCircle, Edit3, User, BookOpen, Snowflake, Thermometer, Award, Ticket, Home, Droplet, RefreshCw, Undo } from 'lucide-react';
...
export default function LabE8NarrationConditionals({ onExit }: { onExit?: () => void }) {
 ...
 <LabHeader onExit={onExit} title={t('lab.e8narrationconditionals_class_8_english_narration_cond')} />
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['said', 'asked', 'told', 'book', 'freeze', 'cool', 'study', 'pass', 'win', 'buy', 'lottery', 'mansion', 'water', 'test', 'stand']}
 title="Key Words"
 />
 {/* Tabs */}
