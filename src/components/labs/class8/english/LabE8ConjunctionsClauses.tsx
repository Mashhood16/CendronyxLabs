...
export default function LabE8ConjunctionsClauses({ onExit }: { onExit?: () => void }) {
 ...
 <LabHeader onExit={onExit} title={t('lab.e8conjunctionsclauses_syntax_welder_conjunctions_cla')} />
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['but', 'after', 'because', 'unless', 'although', 'consequently', 'however', 'neither', 'nor', 'either', 'or', 'when', 'temperature']}
 title="Key Words"
 accent="orange"
 />
