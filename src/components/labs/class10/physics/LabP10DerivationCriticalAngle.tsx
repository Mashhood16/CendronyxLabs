...
export default function LabP10DerivationCriticalAngle({ onExit }: { onExit?: () => void }) {
 ...
 const steps = [
 { label: t('lab.p10_critical_step1_label'), formula: 'n₁ sinθc = n₂ sin 90°', detail: t('lab.p10_critical_step1_detail') },
 { label: t('lab.p10_critical_step2_label'), formula: 'n₁ sinθc = n₂', detail: t('lab.p10_critical_step2_detail') },
 { label: t('lab.p10_critical_step3_label'), formula: 'θc = sin⁻¹(n₂ / n₁)', detail: t('lab.p10_critical_step3_detail') }
 ];
 ...
 <div className="text-2xl font-bold text-white mt-1"><MathFormula formula="θc = sin⁻¹(n₂ / n₁)" className="text-xl font-bold" /></div>
