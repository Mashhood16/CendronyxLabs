...
export default function LabP10DerivationEcho({ onExit }: { onExit?: () => void }) {
 ...
 { label: t('lab.p10_echo_step4_label'), formula: 'd = v × t / 2', detail: t('lab.p10_echo_step4_detail') }
 ];
  ...
  {
    "testEquation": "2d = v * t",
    "testHint": "Distance = speed × total round-trip time."
  },
  {
 ...
 <div className="text-2xl font-bold text-white mt-1"><MathFormula formula="d = v × t / 2" className="text-2xl font-bold" /></div>
