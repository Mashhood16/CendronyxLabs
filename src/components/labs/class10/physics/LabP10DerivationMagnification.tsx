...
export default function LabP10DerivationMagnification({ onExit }: { onExit?: () => void }) {
 ...
 { label: t('lab.p10_mag_step3_label'), formula: 'M = −q / p (mirrors)', detail: t('lab.p10_mag_step3_detail') }
  ...
  const testSteps = [
  {
    "testEquation": "h_i / h_o = q / p",
    "testHint": "From similar triangles in the ray diagram, height ratio equals distance ratio."
  },
  {
    "testEquation": "h_i / h_o = q / p",
    "testHint": "Image height h_i to object height h_o equals image distance q to object distance p."
  },
  {
    "testEquation": "M = h_i / h_o",
    "testHint": "Magnification M is defined as image height divided by object height."
  },
  {
    "testEquation": "M = q / p",
    "testHint": "Therefore magnification M = q / p."
  }
];
