...
export default function LabP10DerivationSeriesResistance({ onExit }: { onExit?: () => void }) {
 ...
 const steps = [
 { label: t('lab.p10_ser_step1_label'), formula: 'V = V₁ + V₂ + V₃', detail: t('lab.p10_ser_step1_detail') },
 { label: t('lab.p10_ser_step2_label'), formula: 'R_eq = R₁ + R₂ + R₃', detail: t('lab.p10_ser_step2_detail') },
 { label: t('lab.p10_ser_step3_label'), formula: 'R_eq > R₁, R₂, R₃ individually', detail: t('lab.p10_ser_step3_detail') }
 ];
 ...
 <div className="text-2xl font-bold text-white mt-1"><MathFormula formula="R_eq = R₁ + R₂ + R₃" className="text-2xl font-bold" /></div>
 ...
 <div><div className="flex justify-between text-xs font-semibold"><span>{t('lab.p10_ser_r1_label')}</span><span className="text-blue-600 font-mono">{r1} Ω</span></div><input type="range" min="50" max="500" step="10" value={r1} onChange={e => { setR1(parseFloat(e.target.value)); setCheckResult('idle'); }} className="w-full accent-blue-500" /></div>
 <div><div className="flex justify-between text-xs font-semibold"><span>{t('lab.p10_ser_r2_label')}</span><span className="text-blue-600 font-mono">{r2} Ω</span></div><input type="range" min="50" max="500" step="10" value={r2} onChange={e => { setR2(parseFloat(e.target.value)); setCheckResult('idle'); }} className="w-full accent-blue-500" /></div>
 <div><div className="flex justify-between text-xs font-semibold"><span>{t('lab.p10_ser_r3_label')}</span><span className="text-blue-600 font-mono">{r3} Ω</span></div><input type="range" min="50" max="500" step="10" value={r3} onChange={e => { setR3(parseFloat(e.target.value)); setCheckResult('idle'); }} className="w-full accent-blue-500" /></div>
