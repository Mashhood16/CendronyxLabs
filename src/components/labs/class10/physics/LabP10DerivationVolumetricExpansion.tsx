...
export default function LabP10DerivationVolumetricExpansion({ onExit }: { onExit?: () => void }) {
 ...
 const steps = [
 { label: t('lab.p10_volExp_step1_label'), formula: 'ΔV ∝ V_o × ΔT', detail: t('lab.p10_volExp_step1_detail') },
 { label: t('lab.p10_volExp_step2_label'), formula: 'ΔV = β V_o ΔT', detail: t('lab.p10_volExp_step2_detail') },
 { label: t('lab.p10_volExp_step3_label'), formula: 'β = ΔV / (V_o ΔT)', detail: t('lab.p10_volExp_step3_detail') },
 { label: t('lab.p10_volExp_step4_label'), formula: 'β = 3α', detail: t('lab.p10_volExp_step4_detail') }
 ];
 ...
 <div className="text-2xl font-bold text-white mt-1"><MathFormula formula="β = ΔV / (V₀ ΔT)" className="text-2xl font-bold" /></div>
