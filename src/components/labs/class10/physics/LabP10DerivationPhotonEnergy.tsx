...
import { Sun, CheckCircle, XCircle, Lightbulb, ArrowRight, BookOpen, BrainCircuit, HelpCircle, Trophy, EyeOff, Sparkles, RefreshCcw, Target } from 'lucide-react';
...
export default function LabP10DerivationPhotonEnergy({ onExit }: { onExit?: () => void }) {
 ...
 const steps = [
 { label: t('lab.p10_photon_step1_label'), formula: 'c = fÎ» â‡’ f = c/Î»', detail: t('lab.p10_photon_step1_detail') },
 { label: t('lab.p10_photon_step2_label'), formula: 'p = h / Î» = hf / c', detail: t('lab.p10_photon_step2_detail') }
 ];
  ...
  {
    "testEquation": "E = hf",
    "testHint": "Planck's quantum equation for photon energy E = h f."
  },
  {
    "testEquation": "f = c / lambda",
    "testHint": "Wave speed relation frequency f = c / lambda."
  },
  {
    "testEquation": "E = hc / lambda",
    "testHint": "Substitute f = c / lambda into E = h f."
  },
  {
    "testEquation": "p = h / lambda",
    "testHint": "de Broglie momentum relation p = E / c = h / lambda."
  }
];
 ...
 <LabHeader onExit={onExit} title={t("Derivation: Photon Energy & Momentum")} />
 ...
 <div className="text-lg font-bold text-white mt-1"><MathFormula formula="E = hf = hc/Î», p = h/Î»" className="text-base font-bold" /></div>
