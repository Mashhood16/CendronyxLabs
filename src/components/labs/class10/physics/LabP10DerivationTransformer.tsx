...
export default function LabP10DerivationTransformer({ onExit }: { onExit?: () => void }) {
 ...
 { label: t('lab.p10_trans_step3_label'), formula: 'I_s = (V_p / V_s) Ã— I_p', detail: t('lab.p10_trans_step3_detail') },
 { label: t('lab.p10_trans_step4_label'), formula: 'V_s / V_p = N_s / N_p = I_p / I_s', detail: t('lab.p10_trans_step4_detail') }
  ...
  const testSteps = [
  {
    "testEquation": "P_in = P_out",
    "testHint": "For an ideal transformer (100% efficient), input power equals output power."
  },
  {
    "testEquation": "I_p * V_p = I_s * V_s",
    "testHint": "Primary power I_p V_p equals secondary power I_s V_s."
  },
  {
    "testEquation": "V_s / V_p = N_s / N_p",
    "testHint": "Voltage ratio equals turn ratio V_s / V_p = N_s / N_p = I_p / I_s."
  }
];
 ...
 <LabHeader onExit={onExit} title={t("Derivation: Ideal Transformer Power")} />
