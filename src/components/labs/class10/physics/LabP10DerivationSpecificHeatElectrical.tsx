...
export default function LabP10DerivationSpecificHeatElectrical({ onExit }: { onExit?: () => void }) {
 ...
 { label: t('lab.p10_shElec_step3_label'), formula: 'c_l = (VIt - m_c c_c (T_f - T_i)) / (m_l (T_f - T_i))', detail: t('lab.p10_shElec_step3_detail') }
  ...
  const testSteps = [
  {
    ...
    "testHint": "Electrical energy supplied E = V I t."
  },
  {
    "testEquation": "Q = (m_c * c_c + m_l * c_l) * dT",
    "testHint": "Heat absorbed by calorimeter and liquid Q = (m_c c_c + m_l c_l) dT."
  },
  {
    "testEquation": "V * I * t = m_c * c_c * dT + m_l * c_l * dT",
    "testHint": "Equate electrical energy supplied to total heat absorbed."
  },
  {
    "testEquation": "c_l = (V*I*t - m_c*c_c*dT) / (m_l*dT)",
    "testHint": "Rearrange equation to isolate liquid specific heat c_l."
  }
];
