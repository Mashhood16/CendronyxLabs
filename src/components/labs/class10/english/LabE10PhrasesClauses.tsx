...
export default function LabE10PhrasesClauses({ onExit = () => {} }: LabE10PhrasesClausesProps) {
 ...
 return (
 <div className="flex flex-col bg-slate-50 dark:bg-[#121212] font-sans text-slate-900 dark:text-[#ffffff] min-h-screen lg:h-screen overflow-x-hidden w-full">
 ...
 <VocabularyPanel words={['phrase', 'clause', 'subject', 'verb', 'independent', 'dependent', 'relative', 'noun', 'adjective', 'adverb', 'preposition', 'gerund']} title="Key Words" />
 ...
 {/* Window 3: Simulation */}
 <section className={`bg-slate-100 dark:bg-[#0a0a0a] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] relative flex-col p-6 ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
 <div className="flex items-center gap-3 mb-6">
