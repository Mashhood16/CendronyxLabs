...
export default function LabE10SentenceNarration({ onExit = () => {} }: LabE10SentenceNarrationProps) {
 ...
 <VocabularyPanel words={['mayor', 'detective', 'teacher', 'hospital', 'reported', 'asked', 'told', 'would', 'could', 'finished', 'direct', 'indirect']} title="Key Words" />
 ...
 <div className="flex-1 min-h-0 overflow-y-auto pr-2 gap-6 flex flex-col">
 {/* Word Bank */}
 ...
 {t('lab.e10sentencenarration_retry_assessment')}
    ...
    <section className={`bg-slate-100 dark:bg-[#0a0a0a] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] relative flex flex-col min-h-0 overflow-y-auto p-4 md:p-8 ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
