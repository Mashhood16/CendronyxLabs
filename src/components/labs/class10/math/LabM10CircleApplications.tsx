...
export default function LabM10CircleApplications({ onExit }: { onExit: () => void }) {
 ...
 setFeedback("Sector area is incorrect. Hint: Area = (Î¸/360) * Ï€r²");
 } else {
 setFeedback(`Incorrect. Arc length is Î¸/360 * 2Ï€r. Area is Î¸/360 * Ï€r². Use Ï€ â‰ˆ 3.14159.`);
 }
 };
 ...
 <div className={`flex-1 min-w-0 relative bg-[#000000] dark:bg-[#121212] rounded-lg border border-[#1c1b1b] dark:border-[#1c1b1b] flex flex-col min-h-[300px] `}>
