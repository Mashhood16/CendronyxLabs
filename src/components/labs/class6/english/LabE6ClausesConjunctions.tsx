...
export default function LabE6ClausesConjunctions({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col bg-slate-50 dark:!bg-[#000000] font-sans select-none text-slate-900 dark:text-[#ffffff] selection:bg-indigo-200 dark:selection:bg-indigo-900 min-h-screen lg:h-screen overflow-x-hidden w-full">
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['because', 'who', 'which', 'although', 'clause', 'conjunction', 'sentence', 'robot', 'engineer', 'spaceship', 'system']}
 title="Key Words"
 />
 <div>
