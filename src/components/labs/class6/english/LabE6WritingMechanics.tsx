...
export default function LabE6WritingMechanics({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col overflow-hidden bg-slate-50 dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#ffffff] transition-colors duration-300 min-h-screen lg:h-screen overflow-x-hidden w-full">
 {/* Header */}
 ...
 {/* Main content */}
 <div className="lg:flex-1 flex flex-col lg:grid grid-cols-1 lg:grid-cols-2 min-h-0 lg:overflow-hidden">
 {/* Left Column: Interactive Controls */}
 <div className="flex flex-col p-6 lg:overflow-y-auto border-r border-slate-200 dark:border-[#1c1b1b] space-y-6">
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['bookmark', 'scroll', 'download', 'refresh', 'login', 'website', 'internet', 'computer']}
 title="Key Words"
 />
 <div>
 <h2 className="text-2xl font-bold mb-2">{t('lab.e6writingmechanics_web_browser_simulator')}</h2>
 <p className="text-slate-600 dark:text-[#71717a]">{t('lab.e6writingmechanics_choose_the_correct_internet_ve')}</p>
 </div>
 ...
 {t('lab.e6writingmechanics_task')} {currentIndex + 1} of {tasks.length}
 </h3>
 <p className={`w-full text-lg font-medium mb-6 bg-white dark:bg-[#121212] dark:border-[#1c1b1b] lg:bg-slate-50 dark:bg-[#121212] lg:dark:bg-[#121212] p-4 rounded-xl border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] 'block' : 'hidden'} lg:block rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t`}>
 "{currentTask.prompt}"
 </p>
 ...
 >
 {t('lab.e6writingmechanics_execute_action')}
 </button>
 </div>
 {feedback.message && (
 ...
 {t('lab.e6writingmechanics_https_www_space_explorer_edu')}
 </div>
 ...
 <h1 className="text-3xl font-bold text-slate-800 dark:text-[#ffffff]">{t('lab.e6writingmechanics_mars_explorer')}</h1>
 ...
 {t('lab.e6writingmechanics_log_in')}
 </button>
 </div>
 </div>
 ...
 <span className="font-semibold text-lg">{t('lab.e6writingmechanics_downloading_mars_image_hq_jpg')}</span>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-2xl font-bold text-slate-800 dark:text-[#ffffff]">{t('lab.e6writingmechanics_mission_details_hidden_footer_')}</h2>
 <div className="space-y-4">
 <div className="h-4 bg-slate-200 dark:bg-[#121212] rounded w-full"></div>
 <div className="h-4 bg-slate-200 dark:bg-[#121212] rounded w-5/6"></div>
 <div className="h-4 bg-slate-200 dark:bg-[#121212] rounded w-full"></div>
