...
export default function LabE6PrepositionsStructure({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff] font-sans select-none overflow-hidden min-h-screen lg:h-screen overflow-x-hidden w-full">
 <style>{styleSheet}</style>
 <LabHeader onExit={onExit} title={t('lab.e6prepositionsstructure_prepositions_structure_lab')} />
 <main className="lg:flex-1 flex flex-col lg:grid grid-cols-1 lg:grid-cols-2 min-h-0 lg:overflow-hidden">
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['over', 'under', 'through', 'around', 'into', 'The', 'dog', 'ran', 'the', 'park']}
 title="Key Words"
 />
