...
export default function LabC6MovementTracking({ onExit }: LabProps) {
 ...
 <div className={`px-4 py-2 rounded-lg font-bold transition-colors ${pressedKey === '' ? 'bg-amber-400 text-slate-900 dark:text-[#ffffff]' : 'bg-slate-700 dark:bg-[#121212] text-slate-300'}`}>
