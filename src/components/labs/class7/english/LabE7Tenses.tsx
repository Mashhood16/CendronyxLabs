...
export default function LabE7Tenses({ onExit }: { onExit?: () => void }) {
 ...
 {/* Header */}
 <LabHeader onExit={onExit} title={t('lab.e7tenses_timeline_conjugator')} rightContent={
 ...
 <span className="opacity-90">{t('lab.e7tenses_score')}</span>
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['repair', 'build', 'travel', 'watch', 'type', 'mechanic', 'bridge', 'letters']}
 title="Key Words"
 />
 <div className="mb-6">
