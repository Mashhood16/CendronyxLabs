...
export default function LabE7PrepositionsModals({ onExit }: { onExit?: () => void }) {
 ...
 if (status === "finished") {
 return (
 <div className="flex flex-col items-center justify-center bg-slate-50 dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#ffffff] select-none p-6 min-h-screen lg:h-screen overflow-x-hidden w-full">
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['because', 'during', 'must', 'should', 'due', 'past', 'according', 'addition', 'in spite', 'along', 'might']}
 title="Key Words"
 />
