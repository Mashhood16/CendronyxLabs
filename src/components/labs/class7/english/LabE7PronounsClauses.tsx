...
export default function LabE7PronounsClauses({ onExit }: { onExit?: () => void }) {
 ...
 {/* Main Content */}
 <div className="lg:flex-1 flex flex-col lg:grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-4 p-4 lg:min-h-0 lg:overflow-hidden">
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['She', 'book', 'that', 'expensive', 'man', 'who', 'helped', 'Someone', 'left', 'their', 'bag', 'table', 'phrase', 'clause']}
 title="Key Words"
 />
