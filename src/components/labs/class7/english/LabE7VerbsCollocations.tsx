...
export default function LabE7VerbsCollocations({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col overflow-hidden bg-slate-50 dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#ffffff] select-none min-h-screen lg:h-screen overflow-x-hidden w-full">
 {/* Header */}
 <LabHeader
 onExit={onExit}
 ...
 {/* Vocabulary Panel */}
 <VocabularyPanel
 words={['open', 'kick', 'ring', 'read', 'sleep', 'laugh', 'cry', 'jump', 'make', 'do', 'catch', 'pay', 'give', 'look', 'take', 'mistake', 'homework', 'cold', 'attention']}
 title="Key Words"
 />
 {activeTab === "stage" && (
