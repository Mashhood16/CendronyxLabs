...
line-block w-24 h-1 border-b-2 border-dashed border-slate-300 dark:border-[#1c1b1b]"></span>}
 ...
 <VocabularyPanel words={['beautiful', 'old', 'small', 'round', 'wooden', 'quickly', 'yesterday', 'outside', 'clever', 'little', 'red', 'dining']} title="Key Words" />
 ...
 {/* Window 3: Simulation */}
 <section className={`bg-slate-100 dark:bg-[#0a0a0a] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] relative flex-col items-center justify-center p-6 ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
