...
export default function LabE11SentenceStructure({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col bg-slate-50 dark:!bg-[#000000] font-sans select-none text-slate-800 dark:text-[#ffffff] overflow-hidden min-h-screen lg:h-screen overflow-x-hidden w-full">
 {/* Header */}
 ...
 <VocabularyPanel words={['declarative', 'interrogative', 'exclamatory', 'imperative', 'optative', 'modifier', 'dangling', 'misplaced', 'sentence', 'structure']} title="Key Words" />
