...
import DeepDivePanel from '../../../widgets/DeepDivePanel';
import FrontierApplicationsPanel from '../../../widgets/FrontierApplicationsPanel';
import type { FrontierTopic } from '../../../widgets/FrontierApplicationsPanel';
...
export default function LabP12SolarCell({ onExit }: { onExit?: () => void }) {
 ...
 const absorptionCoeff = materialData.type === 'Direct' ? 10 : 1; // cmâ»¹
 ...
 <DeepDivePanel
 derivation={{
 title: 'Why Î» = 1240 / E<sub>g</sub>? — Photon Absorption Threshold',
