  ...
  return (
    <div className="flex flex-col h-screen font-sans bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff]">
      ...
      <div className="flex-1 px-8 pb-8 flex flex-col lg:overflow-y-auto">
        ...
        <p className="text-slate-600 dark:text-[#a1a1aa] mb-8">Choose a hobby, plan your startup idea, and calculate your potential profit.</p>
        ...
        <div className="flex gap-8 flex-1">
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 text-left transition-all ${
                        hobby === h.id ? 'border-indigo-500 bg-indigo-50 shadow-md' : 'border-slate-200 dark:border-[#1c1b1b] hover:border-slate-300 dark:border-[#1c1b1b] hover:bg-slate-50 dark:bg-[#121212]'
                      }`}
                    >
          ...
          <div className="w-1/2 bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-8 flex flex-col">
            ...
            <div className="flex flex-col gap-6 flex-1">
              <div>
                <label className="block text-sm font-bold text-slate-700 dark:text-[#ffffff] mb-2">Selling Price per item/service (Rs)</label>
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 dark:text-[#ffffff] mb-2">Cost Price per item/service (Rs)</label>
                <div className="relative">
                  <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                  <input 
                    type="number" 
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 dark:text-[#ffffff] mb-2">Estimated Sales (Quantity)</label>
                <input 
                  type="number" 
                  value={sales}
              ...
              <div className="mt-auto bg-slate-50 dark:bg-[#121212] border border-slate-200 dark:border-[#1c1b1b] rounded-xl p-6">
                <h3 className="font-bold text-slate-500 dark:text-[#71717a] text-sm uppercase tracking-wider mb-4">Financial Summary</h3>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-600 dark:text-[#a1a1aa]">Profit Per Item (Selling - Cost):</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-800 dark:text-[#ffffff] font-bold text-lg">Total Estimated Profit:</span>
