    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 gap-4 p-4 min-h-0">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col items-center">
          <h2 className="text-lg font-bold text-slate-800 dark:text-[#ffffff] mb-4">Target Simulator</h2>
          <svg width="300" height="300" className="bg-slate-100 dark:bg-[#121212] rounded-full border border-slate-300 dark:border-[#1c1b1b] cursor-crosshair shadow-inner" onClick={handleShoot}>
            {/*rings */}
          ...
          <div className="mt-4 flex gap-3">
            <button onClick={clearShots} className="px-4 py-2 bg-slate-200 dark:bg-[#121212] hover:bg-slate-300 dark:bg-[#121212] text-slate-700 dark:text-[#ffffff] rounded-lg font-medium transition-colors">
              Clear Target
            </button>
          </div>
        </div>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 lg:overflow-y-auto">
          ...
          <div className="mb-4 max-h-48 lg:overflow-y-auto border border-slate-200 dark:border-[#1c1b1b] rounded p-2 bg-slate-50 dark:bg-[#121212]">
