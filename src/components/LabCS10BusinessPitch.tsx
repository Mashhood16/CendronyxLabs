    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <main className="flex-1 p-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col gap-6">
          ...
          {/* Sticky Note Board */}
          <div className="flex-1 bg-amber-50 rounded-lg border-2 border-dashed border-amber-200 p-2 relative min-h-[200px] lg:overflow-hidden dark:bg-[#121212] dark:border-[#1c1b1b]">
            ...
            {notes.map(note => (
              <div 
                key={note.id}
                className="absolute w-32 h-32 bg-yellow-200 shadow-md p-2 text-xs font-handwriting cursor-move transform rotate-1 transition-transform hover:scale-105 hover:z-10 text-slate-800 dark:text-[#ffffff]"
