...
import { Thermometer, Mountain, Users, Calculator, Check, RefreshCw } from 'lucide-react';
...
export default function LabM7RationalSquares({ onExit }: { onExit?: () => void }) {
 ...
 {/* Header */}
 <LabHeader onExit={onExit} title={t('lab.m7rationalsquares_class_7_labs_rational_numbers_')} />
