        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 overflow-y-auto">
          ...
          <div className="space-y-4 text-slate-700 dark:text-slate-200 text-sm leading-relaxed">
            <section>
              ...
              <p className="mt-2 font-mono text-xs bg-slate-100 dark:bg-slate-800 p-2 rounded">Depth = (v × t) / 2</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 font-mono text-xs bg-slate-100 dark:bg-slate-800 p-2 rounded">I = I₀ e^(-μx)</p>
            </section>
          </div>
        </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 flex flex-col gap-6 overflow-y-auto">
          <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-500">
            <div className="flex justify-between items-center mb-2">
              <h3 className="font-bold text-slate-800 dark:text-slate-100">Ultrasound Sonography</h3>
              <button 
            ...
            <div className="h-48 bg-slate-900 dark:bg-slate-800 rounded-lg relative overflow-hidden flex flex-col">
              ...
              <div className="flex-1 w-full flex flex-col relative pt-4">
                ...
                <div className="absolute w-full bg-red-900/40 border-t-2 border-slate-400 dark:border-slate-500" style={{ top: `${(tissueDepth * 20) + 16}px`, height: '100%' }}></div>
            ...
            <div className="mt-3 bg-slate-800 dark:bg-slate-800 text-cyan-400 font-mono text-sm p-2 rounded text-center">
              Echo Return Time: {echoTime > 0 ? `${echoTime} µs` : '---'}
            </div>
          </div>

          <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-500">
            <h3 className="font-bold text-slate-800 dark:text-slate-100 mb-2">X-Ray Transmission</h3>
            
            <div className="flex gap-4 mb-4">
              <div className="flex-1">
                <label className="text-xs text-slate-600 dark:text-slate-300 block">Muscle Thickness (cm): {muscleThickness}</label>
              ...
              <div className="flex-1">
                <label className="text-xs text-slate-600 dark:text-slate-300 block">Bone Thickness (cm): {boneThickness}</label>
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 dark:border-slate-500 flex items-center justify-center font-bold">
                I₀
                <br/>100%
              </div>
              <div className="flex-1 h-12 relative flex">
                <div className="h-full bg-red-200" style={{ flex: muscleThickness }} title="Muscle (μ=0.1)"></div>
                <div className="h-full bg-slate-300 dark:bg-slate-800" style={{ flex: boneThickness }} title="Bone (μ=0.5)"></div>
              </div>
              <div 
                className="w-16 h-16 border border-slate-300 dark:border-slate-700 dark:border-slate-500 flex items-center justify-center font-bold text-white transition-colors duration-300"
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 overflow-y-auto">
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-700 dark:border-slate-500">
              <h3 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Q1: Ultrasound Depth</h3>
              ...
              <div className="flex gap-2 items-center">
                ...
                />
                <span className="text-sm text-slate-600 dark:text-slate-300">cm</span>
            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-700 dark:border-slate-500">
              <h3 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Q2: X-Ray Attenuation</h3>
              <p className="text-sm text-slate-600 dark:text-slate-300 mb-3">
