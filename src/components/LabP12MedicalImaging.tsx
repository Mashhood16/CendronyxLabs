        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 lg:overflow-y-auto">
          ...
          <div className="space-y-4 text-slate-700 dark:text-[#ffffff] text-sm leading-relaxed">
            <section>
              ...
              <p className="mt-2 font-mono text-xs bg-slate-100 dark:bg-[#121212] p-2 rounded">Depth = (v × t) / 2</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 font-mono text-xs bg-slate-100 dark:bg-[#121212] p-2 rounded">I = I₀ e^(-μx)</p>
            </section>
          </div>
        </div>
