      ...
      <div className="flex-1 min-w-0 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          ...
          <div className="flex-1 min-w-0 lg:overflow-y-auto pr-2 space-y-4 text-slate-700 dark:text-[#ffffff]">
            ...
            <div className="bg-blue-50 p-3 rounded-lg font-mono text-sm dark:bg-teal-950/20 dark:border-teal-900">
            ...
            <div className="bg-slate-100 dark:bg-[#121212] p-3 rounded-lg font-mono text-sm">
              Rₓ = X₁ + X₂<br/>
              Rₗ = Y₁ + Y₂
            </div>
            
            <p>To find the Resultant Magnitude and Angle:</p>
            <div className="bg-green-50 p-3 rounded-lg font-mono text-sm dark:bg-[#121212] dark:border-[#1c1b1b]">
              |R| = √(Rₓ² + Rₗ²)<br/>
              θ = tan⁻¹(Rₗ / Rₓ)
            </div>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          ...
          {/* Visualizer */}
          <div className="relative h-64 bg-slate-50 dark:bg-[#121212] rounded-xl mb-6 overflow-hidden border border-slate-200 dark:border-[#1c1b1b] shadow-inner flex items-center justify-center">
