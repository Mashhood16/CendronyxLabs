          ...
          <div className="w-64 bg-white rounded-xl shadow-sm border border-slate-200 p-4 flex flex-col gap-6">
            ...
            <div className="mt-auto flex gap-2">
              <button 
                ...
                className="flex-1 flex flex-col items-center justify-center p-3 rounded-lg border-2 border-slate-200 text-slate-600 hover:bg-slate-50 disabled:opacity-50"
              >
              ...
              <button 
                onClick={clear}
                disabled={shapes.length === 0}
                className="flex-1 flex flex-col items-center justify-center p-3 rounded-lg border-2 border-slate-200 text-red-600 hover:bg-red-50 disabled:opacity-50"
              >
