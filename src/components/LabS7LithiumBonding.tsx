      ...
      <div className="flex-1 p-8 flex flex-col items-center">
        ...
        <div className="flex gap-16 w-full max-w-5xl justify-center items-center mt-12">
          ...
          <div className="relative w-96 h-96 flex justify-center items-center">
             ...
             {/* Shell 1 */}
             <div className="absolute border border-slate-500/50 rounded-full w-40 h-40 flex justify-center items-center">
             ...
             {/* Shell 2 (Valence) */}
             <div className={`absolute border rounded-full w-72 h-72 flex justify-center items-center transition-all duration-1000 ${isIon ? 'border-transparent scale-110 opacity-0' : 'border-slate-500/50 scale-100 opacity-100'}`}>
          ...
          <div className="flex-1 bg-slate-800 rounded-3xl p-8 border border-slate-700">
             ...
             <div className="mt-8 p-4 bg-slate-700/50 rounded-xl text-slate-300 text-sm leading-relaxed">
               {isIon 
