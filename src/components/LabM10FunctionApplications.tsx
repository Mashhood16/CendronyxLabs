...
export default function LabM10FunctionApplications({ onExit }: { onExit: () => void }) {
 ...
 <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
  ...
  <div className={`w-full bg-white lg:bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] flex-col '' : ''} rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
   ...
   {/* Visualizer */}
   <div className={`w-full relative h-64 bg-white lg:bg-slate-100 dark:bg-[#121212] lg:dark:bg-[#121212] rounded-xl mb-6 overflow- border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] items-center justify-center p-4 flex-col '' : ''} ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
   {mode === 'virus' ? (
