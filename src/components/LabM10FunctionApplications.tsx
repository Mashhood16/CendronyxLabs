...
export default function LabM10FunctionApplications({ onExit }: { onExit: () => void }) {
 ...
 {/* Visualizer */}
 <div className={`w-full relative h-64 bg-white dark:bg-[#121212] dark:border-[#1c1b1b] lg:bg-slate-100 dark:bg-[#121212] lg:dark:bg-[#121212] rounded-xl mb-6 border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] items-center justify-center p-4 flex-col '' : ''} ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
 {mode === 'virus' ? (
