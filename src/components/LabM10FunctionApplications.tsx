          ...
          <div className="flex-1 min-w-0 lg:overflow-y-auto pr-2 space-y-4 text-slate-700 dark:text-[#ffffff]">
            {mode === 'virus' ? (
              <>
                ...
                <div className="bg-purple-50 p-4 rounded-lg text-center font-mono font-bold text-purple-800 dark:bg-[#121212] dark:border-[#1c1b1b] dark:text-[#ffffff]">
                  N(t) = N₀ × (R₀)ᵗ
                </div>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          <div className="flex space-x-2 mb-6">
            <button 
              ...
              className={`flex-1 flex items-center justify-center py-2 rounded-lg font-medium transition-colors ${mode === 'virus' ? 'bg-purple-600 text-white' : 'bg-slate-100 dark:bg-[#121212] text-slate-600 dark:text-[#ffffff] hover:bg-slate-200 dark:bg-[#121212]'}`}
            >
              ...
              <div className="w-full h-full flex flex-col items-center justify-center">
                <div className="grid gap-[2px] bg-slate-300 dark:bg-[#121212] p-2 rounded-lg" style={{ gridTemplateColumns: `repeat(${gridCols}, minmax(0, 1fr))` }}>
                  {Array.from({ length: gridCells }).map((_, i) => (
                    <div key={i} className={`w-3 h-3 sm:w-4 sm:h-4 rounded-sm ${i < infectedCount ? 'bg-purple-600' : 'bg-slate-50 dark:bg-[#121212]'}`} />
                  ))}
                </div>
