  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <main className="flex-1 min-w-0 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4">
        {/* LEFT: Theory & Setup */}
        <div className="bg-slate-50 dark:bg-[#121212] p-6 rounded-lg shadow flex flex-col gap-4 lg:overflow-y-auto border-t-4 border-blue-500">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 min-w-0 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center justify-center gap-2 dark:bg-blue-500 dark:hover:bg-blue-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-blue-500/40"
              >
        ...
        {/* MIDDLE: Simulation */}
        <div className="bg-slate-50 dark:bg-[#121212] p-6 rounded-lg shadow flex flex-col items-center justify-center border-t-4 border-indigo-500 overflow-hidden relative">
          ...
          <svg viewBox="-15 -15 30 30" className="w-full h-64 max-w-sm mt-8 border border-gray-100 rounded-lg shadow-inner bg-slate-50 dark:bg-[#121212]">
            {/* Axes */}
