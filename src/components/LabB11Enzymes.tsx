...
<h3 className="font-bold text-indigo-800 text-lg dark:text-[#ffffff]">{t('lab.b11enzymes_immobilized_enzymes')}</h3>
 ...
 <section className={`w-full bg-[#121212] dark:bg-[#121212] lg:dark:bg-[#121212] rounded-xl shadow-inner border border-[#1c1b1b] dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] p-6 flex flex-col items-center relative 'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
 ...
 {/* The Column / Beaker */}
 <div className={`w-40 h-64 border-x-4 border-b-4 border-white/40 rounded-b-xl relative flex flex-col-reverse items-center justify-start p-2 gap-1 bg-[#000000] dark:bg-[#121212]/50 `}>
