      ...
      <main className="flex-1 p-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] lg:overflow-y-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-slate-800 dark:text-[#ffffff]">Biostatistics Basics</h2>
          </div>
        ...
        <div className="lg:col-span-1 bg-slate-50 dark:!bg-[#121212] p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-slate-800 dark:text-[#ffffff]">Interactive Data Tasks</h2>
            <button
              onClick={handleReset}
          ...
          <div className="flex-1 lg:lg:overflow-y-auto pr-2 space-y-8">
            {/* Task 1: Sorting */}
            <div>
              <h3 className="font-bold text-slate-700 dark:text-[#ffffff] mb-2">1. Sort the Data (Ascending)</h3>
              <p className="text-sm text-slate-500 dark:text-[#71717a] mb-4">Click two cards to swap their positions.</p>
                  ...
                  <button
                    ...
                    className={`w-14 h-14 text-xl font-bold rounded-lg transition-all ${
                      selectedIdx === idx
                        ...
                        : 'bg-slate-100 dark:bg-[#121212] text-slate-800 dark:text-slate-100 hover:bg-indigo-100 border border-slate-200 dark:border-[#1c1b1b]'
                    }`}
                  >
                    {val}
                  </button>
            ...
            {/* Task 2: Charting */}
            <div>
              <h3 className="font-bold text-slate-700 dark:text-[#ffffff] mb-2">2. Plot the Raw Data</h3>
              ...
              <div
                className={`p-3 rounded text-sm font-semibold flex items-center justify-between ${
                  sortData.join(',') === '10,15,20,25,30'
                    ...
                    : 'bg-slate-100 dark:bg-[#121212] text-slate-600 dark:text-[#ffffff]'
                }`}
              >
