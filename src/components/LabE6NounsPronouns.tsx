  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:bg-slate-950 font-sans select-none text-slate-900 dark:text-slate-100">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
            ...
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800 space-y-4">
              {activeTab === 'nouns' ? (
                <>
                  ...
                  {nounScore !== null && (
                    <div className={`p-4 rounded-xl text-center font-bold text-lg ${
                      nounScore === INITIAL_WORDS.length 
                ...
                <>
                  ...
                  {articleScore !== null && (
                    <div className={`p-4 rounded-xl text-center font-bold text-lg ${
                      articleScore === ARTICLE_QUESTIONS.reduce((acc, q) => acc + q.answers.length, 0)
                        ? 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300' 
                        : 'bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300'
                    }`}>
        ...
        <div className="w-full lg:w-2/3 p-4 sm:p-8 overflow-y-auto bg-slate-50 dark:bg-slate-950 flex flex-col relative">
