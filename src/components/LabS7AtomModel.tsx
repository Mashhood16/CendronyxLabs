...
export default function LabS7AtomModel({ onExit }: LabProps) {
 ...
 return (
 <div className="flex flex-col min- font-sans bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff] min-h-screen lg:h-screen overflow-x-hidden w-full">
 <LabHeader onExit={onExit} title={t('lab.s7atommodel_unit_5_3d_atom_model_builder')} />
 ...
 <h2 className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-2">{t('lab.s7atommodel_build_a_carbon_atom')}</h2>
 <p className="text-slate-600 dark:text-[#a1a1aa] mb-6 text-sm">{t('lab.s7atommodel_carbon_has_an_atomic_number_of')}</p>
 ...
 <span className="text-slate-800 dark:text-white font-bold">{t('lab.s7atommodel_protons_nucleus')}</span>
 </div>
 <div className="flex items-center gap-3">
 <button onClick={() => setProtons(Math.max(0, protons - 1))} className="w-8 h-8 rounded-full text-slate-800 dark:text-[#f8fafc] font-bold bg-slate-300 dark:bg-slate-600 hover:bg-slate-400 dark:hover:bg-slate-50 dark:bg-[#000000]0 dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:border-transparent">-</button>
 <span className="w-6 text-center text-slate-800 dark:text-white font-mono">{protons}</span>
 <button onClick={() => setProtons(Math.min(10, protons + 1))} className="w-8 h-8 rounded-full text-slate-800 dark:text-[#f8fafc] font-bold bg-slate-300 dark:bg-slate-600 hover:bg-slate-400 dark:hover:bg-slate-50 dark:bg-[#000000]0 dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:border-transparent">+</button>
 </div>
 </div>
 ...
 <span className="text-slate-800 dark:text-white font-bold">{t('lab.s7atommodel_neutrons_nucleus')}</span>
 </div>
 <div className="flex items-center gap-3">
 <button onClick={() => setNeutrons(Math.max(0, neutrons - 1))} className="w-8 h-8 rounded-full text-slate-800 dark:text-[#f8fafc] font-bold bg-slate-300 dark:bg-slate-600 hover:bg-slate-400 dark:hover:bg-slate-50 dark:bg-[#000000]0 dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:border-transparent">-</button>
 <span className="w-6 text-center text-slate-800 dark:text-white font-mono">{neutrons}</span>
 <button onClick={() => setNeutrons(Math.min(10, neutrons + 1))} className="w-8 h-8 rounded-full text-slate-800 dark:text-[#f8fafc] font-bold bg-slate-300 dark:bg-slate-600 hover:bg-slate-400 dark:hover:bg-slate-50 dark:bg-[#000000]0 dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:border-transparent">+</button>
 </div>
 </div>
 ...
 <span className="text-slate-800 dark:text-white font-bold">{t('lab.s7atommodel_electrons_orbit')}</span>
 </div>
 <div className="flex items-center gap-3">
 <button onClick={() => setElectrons(Math.max(0, electrons - 1))} className="w-8 h-8 rounded-full text-slate-800 dark:text-[#f8fafc] font-bold bg-slate-300 dark:bg-slate-600 hover:bg-slate-400 dark:hover:bg-slate-50 dark:bg-[#000000]0 dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:border-transparent">-</button>
 <span className="w-6 text-center text-slate-800 dark:text-white font-mono">{electrons}</span>
 <button onClick={() => setElectrons(Math.min(10, electrons + 1))} className="w-8 h-8 rounded-full text-slate-800 dark:text-[#f8fafc] font-bold bg-slate-300 dark:bg-slate-600 hover:bg-slate-400 dark:hover:bg-slate-50 dark:bg-[#000000]0 dark:bg-cyan-400 dark:text-black dark:hover:bg-cyan-300 dark:border-transparent">+</button>
 </div>
 </div>
 </div>
 ...
 <p className="text-sm">{t('lab.s7atommodel_perfect_carbon_consists_of_6_p')}</p>
 </div>
 )}
 </div>
