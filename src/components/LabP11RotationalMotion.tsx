      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 gap-4 p-4 min-h-0">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 lg:overflow-y-auto">
          ...
          <div className="prose prose-sm text-slate-600 dark:text-[#a1a1aa]">
            ...
            <p className="text-center font-mono bg-slate-100 dark:bg-[#121212] p-2 rounded text-slate-800 dark:text-[#ffffff]">L = I × ω = constant</p>
        ...
        {/* Simulator */}
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-5 flex flex-col items-center justify-center">
          <h2 className="text-lg font-bold text-slate-800 dark:text-[#ffffff] mb-4">Skater Visualizer</h2>
          
          <div className="relative w-64 h-64 bg-slate-100 dark:bg-[#121212] rounded-full border-4 border-slate-200 dark:border-[#1c1b1b] shadow-inner flex items-center justify-center overflow-hidden">
            {/* Spinning Container */}
            <div 
              className="absolute"
