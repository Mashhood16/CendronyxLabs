...
export default function LabP11RotationalMotion({ onExit }: { onExit?: () => void }) {
 ...
 <div className={`relative w-64 h-64 bg-slate-100 dark:bg-[#121212] rounded-full border-4 border-slate-200 dark:border-[#1c1b1b] shadow-inner flex items-center justify-center flex-col `}>
 {/* Spinning Container */}
 <div 
 className="absolute"
