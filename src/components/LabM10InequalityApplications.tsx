      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-grow">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-lg p-6 border border-slate-200 dark:border-[#1c1b1b]">
          ...
          <div className="prose text-slate-700 dark:text-[#ffffff]">
            ...
            <div className="bg-amber-50 p-4 rounded-lg mt-4 border border-amber-200 font-mono text-center dark:bg-[#121212] dark:border-[#1c1b1b]">
              P_A(x) + P_B(y) ≤ Budget
            </div>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-lg p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col items-center">
          ...
          <div className="w-full max-w-md space-y-4 mb-6 bg-slate-50 dark:bg-[#121212] p-4 rounded-lg border border-slate-200 dark:border-[#1c1b1b] text-sm font-semibold">
            <div>
          ...
          <div className="relative w-full max-w-sm aspect-square bg-slate-50 dark:bg-[#121212] rounded-lg overflow-hidden border-2 border-slate-300 dark:border-[#1c1b1b] shadow-inner">
            ...
            <div className="absolute top-2 right-2 text-xs bg-slate-50 dark:bg-[#121212]/90 p-1 border border-slate-200 dark:border-[#1c1b1b] rounded text-slate-600 dark:text-[#a1a1aa]">
