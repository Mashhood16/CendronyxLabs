...
export default function LabM10InequalityApplications({ onExit }: Props) {
 ...
 <div className={`relative w-full max-w-sm aspect-square bg-slate-50 dark:bg-[#121212] rounded-lg border-2 border-slate-300 dark:border-[#1c1b1b] shadow-inner flex-col `}>
