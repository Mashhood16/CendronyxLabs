...
const MATERIALS = [
  { id: 'al', name: 'Aluminum Wire', type: 'metal', color: 'bg-slate-300', flexible: true },
...
export default function LabS8Flexibility({ onExit }: LabProps) {
  ...
  return (
    <div 
      className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none"
    ...
    >
      ...
      <div className="flex-1 p-6 flex flex-col md:flex-row gap-6 max-w-6xl mx-auto w-full">
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col items-center justify-center relative overflow-hidden min-h-[400px]">
          ...
          >
            {/* Left Clamp (Fixed) */}
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-16 bg-slate-700 rounded-r-md z-20 shadow-md" />
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-20 bg-slate-800 z-20" />
