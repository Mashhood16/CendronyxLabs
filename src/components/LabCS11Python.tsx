      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col">
          ...
          <div className="prose prose-sm text-slate-600 dark:text-[#a1a1aa] flex-1 lg:overflow-y-auto">
            ...
            <ul className="space-y-2 mt-4 font-mono bg-slate-100 dark:bg-[#121212] p-4 rounded-md text-slate-800 dark:text-[#ffffff]">
          ...
          <div className="w-full flex gap-4 h-full">
            <div className="w-1/3 flex flex-col">
              ...
              <textarea 
                ...
                className="flex-1 w-full bg-[#000000] dark:bg-[#121212] text-green-400 font-mono text-sm p-4 rounded-xl border-4 border-[#1c1b1b] dark:border-[#1c1b1b] outline-none resize-none focus:border-indigo-500 transition-colors"
                spellCheck={false}
              />
            </div>

            <div className="w-2/3 relative bg-slate-50 dark:bg-[#121212] border-2 border-slate-200 dark:border-[#1c1b1b] rounded-xl shadow-inner overflow-hidden flex items-center justify-center">
