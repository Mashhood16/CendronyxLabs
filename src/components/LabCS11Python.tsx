...
export default function LabCS11Python({ onExit }: { onExit?: () => void }) {
 ...
 <div className={`w-2/3 relative bg-slate-50 dark:bg-[#121212] border-2 border-slate-200 dark:border-[#1c1b1b] rounded-xl shadow-inner flex items-center justify-center flex-col `}>
