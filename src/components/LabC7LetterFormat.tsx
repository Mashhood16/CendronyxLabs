  ...
  return (
    <div className="flex flex-col h-screen font-sans bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff]">
      ...
      <div className="flex-1 px-8 pb-8 flex flex-col lg:overflow-y-auto">
        ...
        <p className="text-slate-600 dark:text-[#a1a1aa] mb-6">Write an application using specific formatting rules: Calibri font, size 11, blue color, and include your signature/details.</p>
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-xl border border-slate-300 dark:border-[#1c1b1b] flex flex-col flex-1 overflow-hidden max-w-4xl mx-auto w-full">
          ...
          <div className="flex-1 bg-slate-100 dark:bg-[#121212] p-8 lg:overflow-y-auto flex justify-center">
            <textarea
              className={`w-full max-w-2xl min-h-full bg-slate-50 dark:bg-[#121212] shadow-md border border-slate-200 dark:border-[#1c1b1b] p-12 resize-none outline-none transition-all
