          ...
          <div className="bg-blue-50 border-b border-blue-200 p-3 flex gap-4 items-center">
            ...
            <div className="flex items-center bg-white border border-slate-300 rounded overflow-hidden">
              ...
              <select 
                ...
                className="py-1 px-2 outline-none border-l border-slate-300 bg-transparent text-sm w-32"
              >
            ...
            <div className="flex items-center bg-white border border-slate-300 rounded overflow-hidden">
              ...
              <select 
                ...
                className="py-1 px-2 outline-none border-l border-slate-300 bg-transparent text-sm w-16"
              >
            ...
            <div className="flex items-center bg-white border border-slate-300 rounded overflow-hidden">
              ...
              <select 
                ...
                className="py-1 px-2 outline-none border-l border-slate-300 bg-transparent text-sm w-24"
              >
                <option value="text-slate-800">Black</option>
      ...
      <div className="w-80 bg-white p-6 border-l border-slate-200 shadow-[-10px_0_20px_rgba(0,0,0,0.05)] z-10 flex flex-col overflow-y-auto">
        ...
        <ul className="space-y-4">
          <li className="flex items-center text-slate-600">
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-3 ${isFontCorrect ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-slate-300'}`}>
              {isFontCorrect && <CheckCircle className="w-4 h-4" />}
            </div>
            Font Type: Calibri
          </li>
          <li className="flex items-center text-slate-600">
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-3 ${isSizeCorrect ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-slate-300'}`}>
              {isSizeCorrect && <CheckCircle className="w-4 h-4" />}
            </div>
            Font Size: 11
          </li>
          <li className="flex items-center text-slate-600">
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-3 ${isColorCorrect ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-slate-300'}`}>
              {isColorCorrect && <CheckCircle className="w-4 h-4" />}
            </div>
            Font Color: Blue
          </li>
          <li className="flex items-center text-slate-600">
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-3 ${hasSignature ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-slate-300'}`}>
