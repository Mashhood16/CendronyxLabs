    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-1">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] p-5 rounded-xl shadow-sm flex flex-col gap-4 border border-slate-200 dark:border-[#1c1b1b]">
          ...
          <div className="mt-4 p-4 bg-indigo-50 rounded-lg text-sm text-indigo-900 dark:bg-[#121212] dark:border-[#1c1b1b] dark:text-[#ffffff]">
          ...
          {tab === 'iot' && (
            <div className="mt-4 border-t pt-4">
              ...
              <div className="flex justify-between items-center bg-slate-50 dark:bg-[#121212] p-3 rounded mb-2">
              ...
              <div className="flex justify-between items-center bg-slate-50 dark:bg-[#121212] p-3 rounded">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] p-5 rounded-xl shadow-sm flex flex-col items-center justify-center border border-slate-200 dark:border-[#1c1b1b] relative overflow-hidden">
          {tab === 'iot' && (
