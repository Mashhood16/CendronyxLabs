...
const { recordLabData, setLabScore } = useLab();
 ...
 <div className={`flex-1 relative bg-slate-50 dark:bg-[#121212] border-2 border-slate-200 dark:border-[#1c1b1b] rounded-xl items-center justify-center p-4 h-80 lg:flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
