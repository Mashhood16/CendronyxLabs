      ...
      <div className="flex-1 p-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] p-6 rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          ...
          <div className="prose prose-slate flex-1 lg:overflow-y-auto">
            ...
            <div className="bg-slate-100 dark:bg-[#121212] p-3 rounded-lg border border-slate-200 dark:border-[#1c1b1b] font-mono text-sm text-slate-700 dark:text-[#ffffff] mb-4 whitespace-pre-wrap">
              {`if (score >= 90) {\n  return 'A+';\n} else if (score >= 80) {\n  return 'A';\n}`}
            </div>
        ...
        <div className="bg-[#000000] dark:!bg-[#121212] p-6 rounded-xl shadow-sm border border-[#1c1b1b] dark:border-[#1c1b1b] flex flex-col text-slate-100">
