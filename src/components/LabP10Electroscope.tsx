      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col gap-6">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-[#71717a] bg-slate-100 dark:bg-[#121212] p-2 rounded">
        ...
        {/* Column 2: Simulation */}
        <div className="bg-slate-100 dark:bg-[#121212] rounded-2xl shadow-inner border border-slate-300 dark:border-[#1c1b1b] p-6 flex flex-col items-center justify-center relative overflow-hidden">
          
          {/* Angle Display overlay */}
          <div className="absolute top-4 right-4 bg-slate-50 dark:!bg-[#121212] p-3 rounded-lg border border-slate-300 dark:border-[#1c1b1b] shadow-sm flex flex-col items-center z-20">
