...
export default function LabCS12DeepLearning({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col gap-2 p-4 bg-slate-50 dark:bg-[#121212] rounded border border-slate-200 dark:border-[#1c1b1b] min-h-screen lg:h-screen overflow-x-hidden w-full">
 ...
 <div className="flex flex-col lg:grid lg:grid-cols-3 gap-0 lg:gap-6 p-6 lg:flex-1 lg:h-full lg:min-h-0 lg:overflow-hidden">
 {/* Column 1 */}
