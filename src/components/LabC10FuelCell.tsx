...
<LabHeader onExit={onExit} title="Hydrogen-Oxygen Fuel Cell" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          ...
          <div className="bg-slate-100 dark:bg-[#121212] p-4 rounded-lg mb-6 text-sm font-mono overflow-x-auto space-y-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 dark:bg-[#121212] p-3 rounded border border-slate-200 dark:border-[#1c1b1b] text-sm">
