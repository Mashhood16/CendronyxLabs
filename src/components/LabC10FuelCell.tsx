...
<LabHeader onExit={onExit} title="Hydrogen-Oxygen Fuel Cell" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700 dark:border-slate-500 flex flex-col">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg mb-6 text-sm font-mono overflow-x-auto space-y-1">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">Load Resistance: {resistance} Ω</label>
              <input 
            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-3 rounded border border-slate-200 dark:border-slate-700 dark:border-slate-500 text-sm">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700 dark:border-slate-500 flex flex-col items-center">
          ...
          <div className="mt-4 w-full grid grid-cols-3 gap-2 text-center">
            <div className="bg-slate-100 dark:bg-slate-800 p-2 rounded-lg">
              <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold">Voltage</div>
              <div className="text-lg font-mono text-slate-800 dark:text-slate-100">{voltage.toFixed(2)}V</div>
            </div>
            <div className="bg-slate-100 dark:bg-slate-800 p-2 rounded-lg">
              <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold">Current</div>
              <div className="text-lg font-mono text-slate-800 dark:text-slate-100">{current.toFixed(2)}A</div>
            </div>
            <div className="bg-slate-100 dark:bg-slate-800 p-2 rounded-lg border border-blue-200">
