            ...
            <div className="flex-1 min-w-0 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 lg:overflow-hidden">
                ...
                <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-lg p-6 flex flex-col lg:overflow-y-auto border-t-4 border-indigo-500">
                    ...
                    <div className="prose prose-indigo flex-1 text-slate-700 dark:text-[#ffffff]">
                        ...
                        <div className="bg-indigo-50 p-3 rounded-lg font-mono text-sm text-indigo-900 border border-indigo-200 dark:bg-[#121212] dark:border-[#1c1b1b] dark:text-[#ffffff]">
                ...
                {/* Column 2: Simulator */}
                <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-lg p-6 flex flex-col border-t-4 border-sky-500">
                    ...
                    <div className="flex-1 min-w-0 relative bg-sky-50 rounded-lg overflow-hidden border border-slate-200 dark:border-[#1c1b1b] flex flex-col min-h-[300px]">
