  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-purple-50 dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#ffffff]">
      ...
      <div className="flex-1 p-8 flex flex-col items-center">
        <div className="bg-slate-50 dark:!bg-[#121212] p-6 rounded-2xl shadow-sm border border-purple-100 max-w-2xl w-full text-center mb-8">
          <h2 className="text-2xl font-bold text-purple-800 mb-4 dark:text-[#ffffff]">Pitch and Vibrating Length</h2>
          ...
          <button 
            onClick={pluck}
            className="mt-8 flex mx-auto items-center px-8 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 font-bold active:scale-95 transition-transform shadow-md dark:text-white dark:text-white dark:bg-purple-500 dark:hover:bg-purple-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-purple-500/40"
          >
        ...
        <div className="mt-12 bg-slate-50 dark:!bg-[#121212] p-6 rounded-2xl border border-slate-200 dark:border-[#1c1b1b] shadow-sm w-full max-w-2xl">
           <div className="flex justify-between items-center mb-4">
             ...
             <span className="bg-purple-100 text-purple-800 px-3 py-1 rounded-full font-bold text-sm uppercase tracking-wider dark:text-[#ffffff]">{pitchLabel}</span>
           </div>
