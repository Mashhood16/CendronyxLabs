    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      <div className="bg-white border-b p-4 flex items-center justify-between sticky top-0 shadow-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">Unit 14: Total Internal Reflection</h1>
            <p className="text-sm text-slate-500">Investigate Snell's Law and the Critical Angle.</p>
          </div>
        </div>
