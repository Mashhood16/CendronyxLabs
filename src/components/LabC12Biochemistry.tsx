            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-1">
                ...
                <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 flex flex-col gap-4 overflow-y-auto">
                    ...
                    <div className="prose prose-sm text-slate-600 dark:text-slate-300">
                        <h3 className="text-md font-semibold text-slate-700 dark:text-slate-200">Enzyme Inhibition</h3>
                        <p>
                        ...
                        <h3 className="text-md font-semibold text-slate-700 dark:text-slate-200 mt-4">Gel Electrophoresis</h3>
                        <p>
                ...
                <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 flex flex-col gap-4">
                    <div className="flex gap-2 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
                        <button 
                            className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-colors ${activeTab === 'kinetics' ? 'bg-slate-50 dark:bg-slate-900 shadow text-slate-800 dark:text-slate-100' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-200'}`}
                            onClick={() => setActiveTab('kinetics')}
                        >
                            Enzyme Kinetics
                        </button>
                        <button 
                            className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-colors ${activeTab === 'electrophoresis' ? 'bg-slate-50 dark:bg-slate-900 shadow text-slate-800 dark:text-slate-100' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-200'}`}
                    ...
                    {activeTab === 'kinetics' ? (
                        <div className="flex flex-col gap-4 flex-1">
                            <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:border-slate-500 rounded-lg p-4 relative h-48">
                                ...
                                <div className="absolute top-2 left-10 text-xs font-mono bg-slate-50 dark:bg-slate-900 px-2 py-1 border rounded shadow-sm">
                                ...
                                <div className="flex gap-2 mt-2">
                                    {['None', 'Competitive', 'Non-competitive'].map(t => (
                                        <button 
                                            ...
                                            className={`px-2 py-1 text-xs rounded border ${inhType === t ? 'bg-pink-100 border-pink-400 text-pink-800' : 'bg-slate-50 dark:bg-slate-900 border-slate-300 dark:border-slate-700 dark:border-slate-500 text-slate-600 dark:text-slate-300'}`}
                                        >
                                            {t}
                                        </button>
                                    ))}
                        ...
                        <div className="flex flex-col gap-4 flex-1">
                            <div className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 dark:border-slate-500 rounded-lg p-4 relative h-48 flex items-center justify-center">
                                ...
                                <svg viewBox="0 0 300 100" className="w-full h-full bg-slate-200 dark:bg-slate-800 rounded drop-shadow-inner">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button 
                                        ...
                                        className="py-2 px-4 bg-slate-300 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded font-medium hover:bg-slate-400 dark:bg-slate-800"
                                    >
                                        <RefreshCw size={16} />
                                    </button>
                                </div>
