                    ...
                    {activeTab === 'kinetics' ? (
                        <div className="flex flex-col gap-4 flex-1">
                            <div className="bg-slate-50 dark:bg-[#121212] border border-slate-200 dark:border-[#1c1b1b] rounded-lg p-4 relative h-48">
                                ...
                                <div className="absolute top-2 left-10 text-xs font-mono bg-slate-50 dark:bg-[#121212] px-2 py-1 border rounded shadow-sm">
                        ...
                        <div className="flex flex-col gap-4 flex-1">
                            <div className="bg-slate-100 dark:bg-[#121212] border border-slate-300 dark:border-[#1c1b1b] rounded-lg p-4 relative h-48 flex items-center justify-center">
