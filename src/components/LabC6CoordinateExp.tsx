...
export default function LabC6CoordinateExp({ onExit }: LabProps) {
 ...
 <div className="flex flex-col min- lg: font-sans bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff] min-h-screen lg:h-screen overflow-x-hidden w-full">
  ...
  <p className="text-slate-600 dark:text-[#a1a1aa] mb-8">Relocate the Rocket sprite to different coordinates on the Cartesian plane stage.</p>
  ...
  <div className="flex gap-8 flex-1">
   ...
   <div className="bg-blue-500 text-white font-bold p-3 text-sm dark:bg-teal-950/20 dark:border-teal-900">Blocks</div>
