      ...
      <div className="flex-1 p-8 flex flex-col items-center">
        <div className="bg-slate-50 dark:!bg-[#121212] p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] max-w-4xl w-full">
          <div className="flex items-center mb-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-slate-800 dark:text-[#ffffff]">Water Footprint Tracker</h2>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-collapse border border-slate-300 dark:border-[#1c1b1b] mb-4">
                <thead className="bg-slate-100 dark:bg-[#121212]">
                  <tr>
                    <th className="border border-slate-300 dark:border-[#1c1b1b] p-2 text-left">Activity</th>
                    <th className="border border-slate-300 dark:border-[#1c1b1b] p-2 text-left">Estimated Liters per Use</th>
                  </tr>
                </thead>
                <tbody>
                  <tr><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">Flushing Toilet</td><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">~6 to 9 Liters</td></tr>
                  <tr><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">Brushing Teeth (Tap running)</td><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">~5 Liters per min</td></tr>
                  <tr><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">Shower</td><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">~10 Liters per min</td></tr>
                  <tr><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">Drinking</td><td className="border border-slate-300 dark:border-[#1c1b1b] p-2">~0.25 Liters per glass</td></tr>
                </tbody>
              </table>
            </div>
