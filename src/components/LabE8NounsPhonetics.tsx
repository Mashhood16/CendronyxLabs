...
export default function LabE8NounsPhonetics({ onExit }: { onExit?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:bg-[#000000]/50 dark:!bg-[#000000] dark:!bg-[#000000] font-sans select-none text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa]">
      {/* Header */}
      <div className="flex items-center p-4 border-b border-slate-200 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] dark:bg-[#121212] shrink-0">
        <button
          onClick={onExit}
        ...
        <button
          onClick={toggleTheme}
          className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white dark:bg-[#121212]/10 transition-colors shrink-0 ml-4"
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-4 lg:p-6 flex flex-col gap-6 lg:overflow-y-auto border-r border-slate-200 dark:border-[#1c1b1b] bg-slate-50 dark:bg-[#121212]/50 dark:bg-[#121212] dark:bg-[#121212]/50">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="bg-white dark:!bg-[#121212] dark:!bg-[#121212] rounded-xl p-6 shadow-sm border border-slate-200 dark:border-[#1c1b1b]">
             ...
             <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
             ...
             <div className="flex gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-green-500"
        ...
        <div className="w-full lg:w-1/2 p-4 lg:p-6 bg-slate-100 dark:bg-[#121212]/50 dark:bg-[#121212]/60 dark:bg-slate-950 flex flex-col items-center justify-center relative overflow-hidden">
