    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 min-w-0 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              className="w-full py-2 px-4 bg-slate-100 dark:bg-[#121212] hover:bg-slate-200 dark:bg-[#121212] text-slate-800 dark:text-[#ffffff] font-medium rounded-lg transition-colors border border-slate-300 dark:border-[#1c1b1b]"
            >
              {showTangents ? "Hide Tangents" : "Construct Tangents"}
            </button>
            
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 text-sm text-blue-800 mt-4 dark:bg-teal-950/20 dark:border-teal-900 dark:text-[#ffffff]">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex flex-col items-center justify-center min-h-[400px]">
          ...
          <svg width="450" height="400" className="bg-slate-50 dark:bg-[#121212] border border-slate-200 dark:border-[#1c1b1b] rounded-lg shadow-inner">
            {/* Grid */}
