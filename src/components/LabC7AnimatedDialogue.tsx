    ...
    <div className="flex flex-col h-screen font-sans bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff]">
      ...
      <div className="flex-1 px-8 pb-8 flex flex-col lg:overflow-y-auto">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-lg border border-slate-200 dark:border-[#1c1b1b] p-6 flex gap-8 max-w-5xl mx-auto w-full">
          ...
          {/* Stage */}
          <div className="flex-1">
            <div className={`w-full aspect-video rounded-xl border-4 overflow-hidden relative ${bgSet ? 'border-blue-300' : 'border-slate-200 dark:border-[#1c1b1b] bg-slate-100 dark:bg-[#121212]'}`}>
              ...
              <div className="absolute bottom-12 left-20 flex flex-col items-center">
                {currentMsg?.sprite === 1 && (
                  <div className="bg-slate-50 dark:!bg-[#121212] p-3 rounded-xl rounded-bl-none shadow-lg mb-2 max-w-[200px] border-2 border-blue-200 animate-in fade-in slide-in-from-bottom-2">
              ...
              <div className="absolute bottom-12 right-20 flex flex-col items-center">
                {currentMsg?.sprite === 2 && (
                  <div className="bg-slate-50 dark:!bg-[#121212] p-3 rounded-xl rounded-br-none shadow-lg mb-2 max-w-[200px] border-2 border-orange-200 animate-in fade-in slide-in-from-bottom-2">
                    <p className="font-bold text-slate-800 dark:text-[#ffffff]">{currentMsg.text}</p>
                  </div>
                )}
