...
export default function LabC12IndustryMaterials({ onExit }: { onExit?: () => void }) {
 ...
 className={`w-full h-2 bg-slate-200 dark:bg-[#121212] rounded-lg appearance-none cursor-pointer accent-orange-600 mb-6 flex-col `}
 />
 ...
 className={`flex items-center gap-2 px-6 py-3 bg-orange-600 text-white rounded-lg font-medium hover:bg-orange-700 transition-colors shadow-sm dark:bg-orange-500 dark:hover:bg-orange-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-orange-500/40 flex-col `}
 >
 <Play size={18} />
