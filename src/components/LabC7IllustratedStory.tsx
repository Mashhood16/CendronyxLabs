      ...
      <div className="flex-1 p-8 flex flex-col overflow-y-auto">
        ...
        <div className="bg-white rounded-xl shadow border border-slate-300 flex flex-col flex-1 max-w-4xl mx-auto w-full overflow-hidden relative">
          ...
          <div className="flex-1 p-12 overflow-y-auto bg-slate-50">
            <textarea
              className="w-full min-h-[200px] bg-transparent resize-none outline-none text-lg font-serif text-slate-800 leading-relaxed mb-8 placeholder:text-slate-300"
