      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col items-center relative">
            ...
            <div className="relative w-64 h-64 flex flex-col items-center justify-end">
                ...
                {/* Burner */}
                <div className="w-16 h-12 border-x-4 border-t-4 border-[#1c1b1b] dark:border-[#1c1b1b] bg-slate-600 dark:bg-[#121212] rounded-t relative flex justify-center mt-2">
