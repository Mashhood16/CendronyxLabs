      ...
      <div className="flex flex-1 flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-6 bg-slate-900 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="relative w-full max-w-lg aspect-video flex items-center justify-center">
            ...
            <div 
              className={`absolute left-0 w-[48%] h-32 bg-gradient-to-r from-slate-600 to-slate-500 rounded-l-xl border-y-4 border-l-4 border-slate-400 shadow-[inset_0_4px_10px_rgba(255,255,255,0.2)] transition-transform duration-500 flex items-center justify-center ${
            ...
            <div 
              className={`absolute right-0 w-[48%] h-32 bg-gradient-to-l from-slate-600 to-slate-500 rounded-r-xl border-y-4 border-r-4 border-slate-400 shadow-[inset_0_4px_10px_rgba(255,255,255,0.2)] transition-transform duration-500 flex items-center justify-center ${
                weldState === 'welding' ? '-translate-x-4' : weldState === 'success' ? '-translate-x-[4%]' : 'translate-x-0'
              }`}
            >
