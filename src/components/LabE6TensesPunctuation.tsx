  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none text-slate-900 dark:text-[#ffffff]">
      ...
      <main className="flex-1 flex flex-col lg:flex-row lg:overflow-hidden lg:overflow-y-auto">
        ...
        <section className="w-full lg:w-1/3 flex flex-col border-r border-slate-200 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] lg:overflow-y-auto p-6">
          
          <div className="flex bg-slate-200 dark:bg-slate-700 p-1 rounded-lg mb-8 shrink-0">
            <button 
              onClick={() => setActiveTab('tenses')}
              className={`flex-1 py-2 text-sm font-bold rounded-md transition-all whitespace-nowrap flex-shrink-0 ${activeTab === 'tenses' ? 'bg-white dark:bg-[#121212] shadow-sm text-blue-600 dark:text-blue-400' : 'text-slate-600 dark:text-[#ffffff] hover:bg-slate-300 dark:hover:bg-slate-600'}`}
            >
              Time Machine (Tenses)
            </button>
            <button 
              onClick={() => setActiveTab('gerunds')}
              className={`flex-1 py-2 text-sm font-bold rounded-md transition-all whitespace-nowrap flex-shrink-0 ${activeTab === 'gerunds' ? 'bg-white dark:bg-[#121212] shadow-sm text-emerald-600 dark:text-emerald-400' : 'text-slate-600 dark:text-[#ffffff] hover:bg-slate-300 dark:hover:bg-slate-600'}`}
            >
              Gerund Scanner
            </button>
          </div>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-200 dark:border-[#1c1b1b]">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 min-w-0 bg-white dark:bg-[#121212] border border-slate-300 dark:border-[#1c1b1b] rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <button
                      ...
                      <button
                        ...
                        className={`px-2 py-1 rounded transition-all whitespace-nowrap flex-shrink-0 ${
                          selectedWords.includes(idx) 
                            ...
                            : 'bg-white dark:bg-[#121212] hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-[#ffffff] border border-slate-300 dark:border-slate-600'
                        }`}
                      >
                        {w.text}
                      </button>
