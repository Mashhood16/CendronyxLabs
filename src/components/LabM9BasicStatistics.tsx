      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-1 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col gap-4">
          ...
          <div className="prose prose-slate text-sm">
            ...
            <div className="mt-4 p-3 bg-amber-50 rounded-lg border border-amber-100 text-center dark:bg-[#121212] dark:border-[#1c1b1b]">
          ...
          <div className="flex-1 min-w-0 flex flex-col items-center justify-end relative bg-slate-50 dark:bg-[#121212] border border-slate-200 dark:border-[#1c1b1b] rounded-lg p-6">
            <div className="w-full h-48 flex items-end justify-center gap-12">
              ...
              <div className="flex flex-col items-center gap-2 w-24">
                ...
                <div 
                  className="w-full bg-blue-500 rounded-t-md transition-all duration-500 /20 dark:border-teal-900 dark:bg-blue-500 dark:hover:bg-blue-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-blue-500/40"
              ...
              <div className="flex flex-col items-center gap-2 w-24">
                ...
                <div 
                  className="w-full bg-red-500 rounded-t-md transition-all duration-500 dark:bg-red-500 dark:hover:bg-red-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-red-500/40"
