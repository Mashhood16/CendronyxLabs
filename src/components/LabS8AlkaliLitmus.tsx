  ...
  return (
    <div className="overflow-y-auto flex flex-col h-screen bg-slate-50 dark:bg-slate-900 font-sans select-none">
      ...
      <div className="flex-1 flex flex-col p-6 gap-6 max-w-4xl mx-auto w-full items-center justify-center">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-2xl shadow-sm border p-8 flex flex-col items-center justify-center relative min-h-[450px] w-full">
          
          <h2 className="text-xl font-bold mb-8 text-slate-700 dark:text-slate-200">Aqueous Sodium Hydroxide (NaOH)</h2>

          <div className="relative w-64 h-64 flex flex-col items-center justify-center mb-8">
            {/* The Beaker */}
            <div className="absolute bottom-0 w-48 h-32 border-4 border-slate-300 dark:border-slate-700 dark:border-slate-500 rounded-b-3xl border-t-0 bg-slate-50 dark:bg-slate-900/50 shadow-inner z-10 flex flex-col justify-end overflow-hidden">
              <div className="w-full h-3/4 bg-blue-50/50 relative">
                 <div className="absolute bottom-2 left-10 w-2 h-2 bg-slate-50 dark:bg-slate-900 rounded-sm" />
                 <div className="absolute bottom-3 right-12 w-2 h-2 bg-slate-50 dark:bg-slate-900 rounded-sm" />
              </div>
            </div>
