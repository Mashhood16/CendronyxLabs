...
const { recordLabData, setLabScore } = useLab();
 ...
 <div className={`flex-1 relative bg-slate-50 dark:bg-[#121212] border-2 border-slate-200 dark:border-[#1c1b1b] rounded-xl justify-center items-end p-4 h-80 lg:flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
 {/* Beaker */}
 <div className={`w-full w-32 h-64 border-4 border-white/80 bg-blue-100/50 relative rounded-b-xl shadow-inner z-10 backdrop-blur-[1px] flex-col 'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
