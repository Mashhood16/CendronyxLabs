      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col gap-6">
          ...
          <div className="space-y-4 text-slate-600 dark:text-[#a1a1aa] text-sm">
            ...
            <div className="flex items-start gap-2 bg-blue-50 text-blue-800 p-3 rounded-md dark:bg-teal-950/20 dark:border-teal-900 dark:text-[#ffffff]">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] p-6 flex flex-col gap-6">
          ...
          <div className="flex-1 relative bg-slate-50 dark:bg-[#121212] border-2 border-slate-200 dark:border-[#1c1b1b] rounded-xl flex justify-center items-end p-4 h-80 lg:overflow-hidden">
            {/* Beaker */}
