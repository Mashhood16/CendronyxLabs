...
export default function LabE8AdjectivesPoetry({ onExit }: { onExit?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:bg-[#000000]/50 dark:!bg-[#000000] dark:!bg-[#000000] font-sans select-none text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa]">
      <header className="flex items-center p-4 bg-white dark:bg-[#121212] dark:bg-[#121212] shadow-sm z-10 border-b border-slate-200 dark:border-[#1c1b1b]">
      ...
      <div className="flex-1 flex flex-col lg:flex-row lg:overflow-hidden lg:overflow-y-auto">
         ...
         <div className="w-full lg:w-1/3 flex flex-col border-r border-slate-200 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] dark:bg-[#121212] lg:overflow-y-auto">
               ...
               {activeTab === 'poetry' ? (
                 <div className="space-y-6">
                    <div className="flex justify-between items-center bg-slate-100 dark:bg-[#121212]/50 dark:bg-[#121212]/60 dark:bg-[#121212]/50 p-2 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
                       <button onClick={() => setPoemIndex(Math.max(0, poemIndex - 1))} disabled={poemIndex === 0} className="whitespace-nowrap flex-shrink-0 px-3 py-1 rounded bg-white dark:bg-[#121212] dark:bg-slate-700 shadow disabled:opacity-50 text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] transition-opacity">Prev Poem</button>
                       ...
                       <button onClick={() => setPoemIndex(Math.min(poetryData.length - 1, poemIndex + 1))} disabled={poemIndex === poetryData.length - 1} className="whitespace-nowrap flex-shrink-0 px-3 py-1 rounded bg-white dark:bg-[#121212] dark:bg-slate-700 shadow disabled:opacity-50 text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] transition-opacity">Next Poem</button>
                    </div>
                                            ...
                                            <button
                                                ...
                                                className={`whitespace-nowrap flex-shrink-0 py-2 px-3 rounded-md border text-sm font-medium transition-colors ${
                                                    poetryAnswers[poemIndex]?.[i] === opt
                                                        ...
                                                        : 'bg-slate-50 dark:bg-[#121212]/50 dark:bg-[#121212] border-slate-200 dark:border-[#1c1b1b] text-slate-700 dark:text-[#ffffff] dark:text-[#ffffff] hover:bg-slate-100 dark:bg-[#121212]/50 dark:bg-[#121212]/60 dark:bg-[#121212] dark:border-slate-600 dark:text-[#ffffff] dark:hover:bg-slate-700'
                                                }`}
                                            >
                                                {opt}
                                            </button>
                ...
                <div className="space-y-6">
                    <div className="flex justify-between items-center bg-slate-100 dark:bg-[#121212]/50 dark:bg-[#121212]/60 dark:bg-[#121212]/50 p-2 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
                       <button onClick={() => setAdjIndex(Math.max(0, adjIndex - 1))} disabled={adjIndex === 0} className="whitespace-nowrap flex-shrink-0 px-3 py-1 rounded bg-white dark:bg-[#121212] dark:bg-slate-700 shadow disabled:opacity-50 text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] transition-opacity">Prev</button>
                       ...
                       <button onClick={() => setAdjIndex(Math.min(adjectiveData.length - 1, adjIndex + 1))} disabled={adjIndex === adjectiveData.length - 1} className="whitespace-nowrap flex-shrink-0 px-3 py-1 rounded bg-white dark:bg-[#121212] dark:bg-slate-700 shadow disabled:opacity-50 text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] transition-opacity">Next</button>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 items-center">
                                    <input
                                        ...
                                        className="flex-1 min-w-0 p-2 border border-slate-300 dark:border-[#1c1b1b] rounded bg-white dark:bg-[#121212] dark:bg-[#121212] text-slate-800 dark:text-[#a1a1aa] dark:text-[#a1a1aa] dark:text-[#a1a1aa] outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
