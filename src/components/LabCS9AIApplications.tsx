...
export default function LabCS9AIApplications({ onExit }: LabProps) {
 ...
 <LabHeader onExit={onExit} title={t('lab.cs9aiapplications_ai_applications_ethics')} />
 ...
 {t('lab.cs9aiapplications_theory')}
 </button>
 <button 
 onClick={() => setActiveMobileTab('lab')}
 className={`w-full py-3 text-sm font-bold rounded-xl transition-all text-center ${activeMobileTab === 'lab' ? 'bg-[#4158D1] text-white shadow-md' : 'bg-white dark:bg-[#1c1b1b] text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-gray-700'}`}
 >{t('lab.cs9aiapplications_lab')}</button>
 </div>
 ...
 {t('lab.cs9aiapplications_theory_context')}
 </h2>
 <div className="text-sm text-slate-600 dark:text-[#a1a1aa] space-y-3">
 <p><strong>{t('lab.cs9aiapplications_artificial_intelligence_ai')}</strong> {t('lab.cs9aiapplications_systems_are_designed_to_perfor')}</p>
 <p>{t('lab.cs9aiapplications_however_real_world_ai_applicat')}</p>
 <ul className="list-disc pl-5 space-y-1">
 <li><strong>{t('lab.cs9aiapplications_healthcare')}</strong> {t('lab.cs9aiapplications_patient_privacy_and_the_risk_o')}</li>
 <li><strong>{t('lab.cs9aiapplications_nlp_natural_language_processin')}</strong> {t('lab.cs9aiapplications_inheriting_human_biases_from_t')}</li>
 <li><strong>{t('lab.cs9aiapplications_manufacturing')}</strong> {t('lab.cs9aiapplications_job_displacement_and_over_reli')}</li>
 </ul>
 <div className={`mt-4 p-3 bg-indigo-50 border-l-4 border-indigo-500 rounded-r-lg dark:bg-[#121212] dark:border-[#1c1b1b] flex-col `}>
 <p className="font-semibold text-indigo-900 flex items-center gap-2 dark:text-[#ffffff]"><ShieldAlert className="w-4 h-4"/> {t('lab.cs9aiapplications_objective')}</p>
 <p className="mt-1">{t('lab.cs9aiapplications_explore_the_tech_tree_identify')}</p>
 </div>
 </div>
 </div>
 ...
 {t('lab.cs9aiapplications_ai_tech_tree_simulator')}
 </h2>
 <p className="text-xs text-slate-500 dark:text-[#71717a] mb-4 text-center">{t('lab.cs9aiapplications_click_locked_nodes_gray_to_ana')}</p>
 
 <div className={`relative w-full aspect-square max-w-md border-2 border-indigo-50 rounded-xl bg-slate-50 dark:bg-[#121212] shadow-inner flex-col `}>
 ...
 <h3 className="font-bold text-indigo-900 mb-1 dark:text-[#ffffff]">{selectedNode.label} {t('lab.cs9aiapplications_analysis')}</h3>
 <p className="text-sm mb-3"><span className="font-semibold text-slate-700 dark:text-[#ffffff]">{t('lab.cs9aiapplications_identified_risk')}</span> {selectedNode.issue}</p>
 ...
 <CheckCircle2 className="w-4 h-4"/> {t('lab.cs9aiapplications_solved')} {selectedNode.solution}
 </div>
 ) : (
 <div className="space-y-2">
 <p className="text-xs font-semibold text-slate-600 dark:text-[#a1a1aa]">{t('lab.cs9aiapplications_propose_solution')}</p>
 ...
 {t('lab.cs9aiapplications_deploy')} {selectedNode.solution} <ArrowRight className="w-4 h-4"/>
 </button>
 </div>
 )}
 </div>
 ...
 {/* Column 3: Analysis */}
 <div className="bg-white dark:bg-[#121212] dark:border-[#1c1b1b] lg:bg-slate-50 dark:!bg-[#121212] p-6 rounded-xl shadow-sm flex flex-col lg:h-full border border-slate-100 ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t">
 <h2 className="text-xl font-bold text-slate-800 dark:text-[#ffffff] mb-4 flex items-center gap-2">
 <Activity className="w-6 h-6 text-indigo-600" />
 
 {t('lab.cs9aiapplications_analysis_assessment')}
 </h2>
 
 <div className={`flex-1 min-h-[200px] lg:overflow-y-auto bg-slate-50 dark:bg-[#121212] p-4 rounded-lg border border-slate-200 dark:border-[#1c1b1b] mb-6 shadow-inner flex-col ${activeMobileTab === 'theory' ? 'flex' : 'hidden'} lg:flex`}>
 <h3 className="font-semibold text-sm text-slate-700 dark:text-[#ffffff] mb-3 border-b pb-1 border-slate-200 dark:border-[#1c1b1b]">{t('lab.cs9aiapplications_security_log')}</h3>
 {logs.length === 0 ? (
 <p className="text-xs text-slate-500 dark:text-[#71717a] italic text-center mt-8">{t('lab.cs9aiapplications_no_issues_resolved_yet')}<br/>{t('lab.cs9aiapplications_interact_with_the_tech_tree')}</p>
 ) : (
 ...
 <h3 className="font-bold text-indigo-900 mb-2 text-sm flex items-center gap-2 dark:text-[#ffffff]">{t('lab.cs9aiapplications_knowledge_check')}</h3>
 ...
 placeholder={t('lab.cs9aiapplications_type_the_issue_name_exactly')}
 ...
 {t('lab.cs9aiapplications_check_answer')}
 </button>
 {assessmentFeedback && (
