      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-grow">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 flex flex-col">
          ...
          <div className="prose prose-slate text-sm flex-grow overflow-y-auto pr-2">
            <h3 className="font-semibold text-slate-800 dark:text-slate-100">1. Mechanical Digestion: Peristalsis</h3>
            <p>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-slate-100 mt-4">2. Chemical Digestion: Emulsification</h3>
            <p>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 flex flex-col relative overflow-hidden">
          ...
          <div className="flex flex-col gap-6 flex-grow overflow-y-auto pr-2 pb-8">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-4">
              <h3 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Station 1: Esophageal Peristalsis</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Pinch the esophagus above the bolus (green) to move it downward.</p>
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                <div className="flex flex-col gap-2">
                   ...
                   <button onClick={() => setBolusPosition(10)} className="px-4 py-2 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-300 dark:bg-slate-800 text-sm font-medium transition-colors">
                     Reset Bolus
                   </button>
                </div>
              </div>
            ...
            {/* Emulsification Sim */}
            <div className="bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-4">
              <h3 className="font-semibold text-slate-800 dark:text-slate-100 mb-2">Station 2: Lipid Emulsification</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Add bile drops to the oil-water mixture to observe emulsification.</p>
              
              <div className="flex items-center justify-center gap-8">
                <div className="relative w-32 h-40 bg-slate-50 dark:bg-slate-900 border-b-8 border-x-4 border-slate-300 dark:border-slate-700 dark:border-slate-500 rounded-b-2xl overflow-hidden flex flex-col justify-end">
                  {/* Water layer */}
                ...
                <div className="flex flex-col gap-2">
                  <div className="text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">Bile Drops: {bileDrops}/3</div>
                  ...
                  <button onClick={() => { setBileDrops(0); setEmulsified(false); }} className="px-4 py-2 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-300 dark:bg-slate-800 text-sm font-medium transition-colors">
                    Reset Mixture
                  </button>
                </div>
              </div>
