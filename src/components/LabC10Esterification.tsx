      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 flex-1">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-lg shadow-sm border p-4 flex flex-col items-center relative">
          ...
          <div className="flex-1 w-full flex flex-col items-center justify-center relative">
            ...
            <div className="absolute top-4 right-4 bg-slate-100 dark:bg-slate-800 p-3 rounded border text-sm w-40 text-center">
              <div className="font-bold text-slate-700 dark:text-slate-200">Odor Detected:</div>
              <div className={`font-semibold ${smell === 'None' ? 'text-slate-500 dark:text-slate-400' : smell === 'Fruity (Sweet)' ? 'text-pink-600' : 'text-orange-500'}`}>
                {smell}
              </div>
            </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-lg shadow-sm border p-4 flex flex-col gap-4">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded flex justify-between items-center">
            <div>
              <div className="text-xs text-slate-500 dark:text-slate-400 uppercase font-bold">Ester Yield</div>
