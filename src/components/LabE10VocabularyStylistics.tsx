        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 flex flex-col h-full overflow-hidden">
            <div className="p-6 bg-pink-50 dark:bg-pink-900/30 border-b border-pink-100 dark:border-pink-800/50 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Stylistics & Mechanics</h2>
            </div>
            <div className="p-6 lg:overflow-y-auto flex-1 space-y-6 text-slate-700 dark:text-[#a1a1aa]">
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Figures of Speech</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Vocabulary</h3>
                <ul className="list-disc pl-5 space-y-2 text-sm">
              ...
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Punctuation</h3>
                <ul className="list-disc pl-5 space-y-2 text-sm">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 p-6 flex flex-col h-full overflow-hidden">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-200 dark:border-neutral-900">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Stylist's Workbench</h2>
            </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="bg-slate-100 dark:bg-[#121212] p-8 rounded-xl border border-slate-200 dark:border-[#1c1b1b] text-center mb-8 shadow-inner">
                <p className="text-xl font-medium text-slate-900 dark:text-[#ffffff] leading-relaxed italic">
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-xl font-medium text-sm transition-all border-2 flex items-center justify-center ${
                        !isAnswered
                          ? 'border-slate-200 dark:border-[#1c1b1b] hover:border-pink-400 hover:bg-pink-50 dark:hover:bg-pink-900/30'
                          : isSelected
                            ? isCorrect 
                            ...
                            : isCorrect
                              ...
                              : 'border-slate-200 dark:border-[#1c1b1b] opacity-40'
                      }`}
                    >
                      {opt}
                    </button>
                ...
                <div className="mt-6 flex flex-col gap-4">
                  <div className={`p-4 rounded-lg text-sm font-medium flex gap-3 ${
                    selectedAnswer === STYLISTIC_CHALLENGES[currentChallenge].correct
                      ...
                      : 'bg-slate-100 dark:bg-[#121212] text-slate-800 dark:text-[#ffffff]'
                  }`}>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 bg-pink-600 hover:bg-pink-700 text-white rounded-lg font-bold transition-colors shadow-sm dark:text-white dark:text-white dark:bg-pink-500 dark:hover:bg-pink-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-pink-500/40"
                  >
              ...
              {!assessmentSubmitted ? (
                <div className="space-y-6">
                        ...
                        {q.options.map((opt, oIdx) => (
                          <label key={oIdx} className="flex items-start gap-3 cursor-pointer group">
                            <input
                              type="radio"
                              name={`question-${qIdx}`}
                              className="mt-1 w-4 h-4 text-pink-600 dark:text-pink-400 bg-slate-100 dark:bg-[#121212]/50 border-slate-300 dark:border-[#1c1b1b]"
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2 px-4 bg-pink-600 hover:bg-pink-700 disabled:bg-slate-300 disabled: text-white rounded-lg font-medium transition-colors dark:bg-pink-500 dark:hover:bg-pink-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-pink-500/40"
                  >
                    Submit Evaluation
                  </button>
                </div>
