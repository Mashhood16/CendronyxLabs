  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans select-none">
      <div className="bg-white border-b p-4 flex items-center gap-4 sticky top-0 shadow-sm z-10">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-800">Unit 18: Thermionic Emission</h1>
          <p className="text-sm text-slate-500">Determine the specific charge of an electron.</p>
        </div>
      </div>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 overflow-hidden">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col gap-6 overflow-y-auto">
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-slate-500 mt-1">Requires &gt;1.5A to emit electrons.</p>
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-slate-700 mb-1">
        ...
        <div className="bg-slate-900 rounded-xl shadow-sm border border-slate-700 p-6 flex flex-col items-center justify-center relative overflow-hidden">
           <div className="relative w-full aspect-video border-4 border-slate-600 rounded-[100px] bg-slate-800 flex items-center shadow-[inset_0_0_50px_rgba(0,0,0,0.5)]">
             <div className="absolute left-10 w-4 h-24 bg-slate-400 rounded flex items-center justify-center">
             ...
             <div className="absolute right-16 w-4 h-32 bg-slate-300 rounded border-2 border-slate-400 flex flex-col justify-between items-center">
           ...
           <div className="mt-8 flex gap-8 text-white font-mono text-sm bg-slate-800 p-4 rounded-lg border border-slate-700 w-full justify-between items-center">
             <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col overflow-hidden">
          ...
          <div className="p-4 flex-1 overflow-y-auto">
            ...
            <div className="mb-6">
              <h3 className="font-semibold text-slate-700 text-sm mb-2">Graph: v² vs V</h3>
              <div className="w-full aspect-video bg-slate-50 border border-slate-200 rounded relative">
                ...
                <div className="absolute bottom-1 left-1/2 -translate-x-1/2 text-[10px] text-slate-500">V (Volts)</div>
                <div className="absolute top-1/2 -left-2 -translate-y-1/2 -rotate-90 text-[10px] text-slate-500">v² (10¹⁴)</div>
              </div>
              {n > 1 && (
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
              ...
              <div className="flex gap-2 items-center">
                ...
                <span className="text-xs text-slate-600 font-mono">× 10¹¹ C/kg</span>
