...
export default function LabM6Sets({ onExit }: { onExit?: () => void }) {
 ...
 {/* Header */}
 <LabHeader onExit={onExit} title={t('lab.m6sets_unit_4_set_theory_canvas')} />
 ...
 <div 
 className="relative w-full max-w-4xl aspect-[4/3] bg-white dark:!bg-[#121212] rounded-[3rem] shadow-2xl border border-slate-200 dark:border-neutral-900 flex flex-col p-8 overflow-hidden transition-colors"
 onDragOver={onDragOver}
