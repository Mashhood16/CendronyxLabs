    ...
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50 dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff] font-sans select-none">
      ...
      <div className="flex items-center justify-between p-4 bg-white dark:bg-[#121212] shadow-sm z-10 shrink-0 border-b border-slate-200 dark:border-[#1c1b1b]">
        ...
        <div className="flex gap-2 bg-slate-100 dark:bg-[#121212] p-1 rounded-lg border border-slate-200 dark:border-[#1c1b1b]">
          <button onClick={() => setActiveScenario('biology')} className={`px-4 py-2 rounded-md font-medium transition-all ${activeScenario === 'biology' ? 'bg-white dark:bg-[#121212] shadow text-indigo-600 dark:text-indigo-400' : 'hover:text-indigo-600 dark:hover:text-indigo-400'}`}>
            Biology Lab
          </button>
          <button onClick={() => setActiveScenario('students')} className={`px-4 py-2 rounded-md font-medium transition-all ${activeScenario === 'students' ? 'bg-white dark:bg-[#121212] shadow text-indigo-600 dark:text-indigo-400' : 'hover:text-indigo-600 dark:hover:text-indigo-400'}`}>
            Student Clubs
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-full max-w-md p-6 lg:overflow-y-auto border-r border-slate-200 dark:border-[#1c1b1b] bg-white dark:bg-[#121212] flex flex-col gap-6 shrink-0 shadow-lg z-0">
          ...
          <div className="bg-indigo-50 dark:bg-indigo-900/20 p-5 rounded-2xl border border-indigo-100 dark:border-indigo-800/50">
            ...
            <div className="flex flex-col gap-2 text-sm bg-white dark:bg-[#121212] p-3 rounded-xl border border-indigo-100 dark:border-indigo-800">
          ...
          <div className="flex-1 min-w-0 bg-slate-50 dark:bg-[#121212]/50 rounded-2xl p-5 border border-slate-200 dark:border-[#1c1b1b]/50 flex flex-col min-h-[250px]">
             ...
             <div 
                className="flex-1 min-w-0 border-2 border-dashed border-slate-300 dark:border-[#1c1b1b] rounded-xl bg-white dark:bg-[#121212] p-4 flex flex-wrap content-start gap-3 transition-colors"
