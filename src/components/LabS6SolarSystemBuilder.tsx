    ...
    <div className="flex flex-col h-screen bg-slate-900 font-sans text-white">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-800 via-slate-900 to-black overflow-hidden flex items-center justify-center">
          ...
          {/* The Sun */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-yellow-500 rounded-full shadow-[0_0_80px_rgba(234,179,8,0.6)] z-10 flex items-center justify-center font-bold text-yellow-900 shadow-inner">
            SUN
          </div>
