  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-green-50 font-sans">
      ...
      <div className="flex-1 p-8 flex flex-col items-center">
           ...
           {[0, 1, 2, 3].map((i) => (
             <div key={i} className="absolute bottom-16 flex flex-col items-center" style={{ left: `${250 + i * 140}px` }}>
                ...
                <div className="absolute bottom-[-16px] w-2 h-16 bg-green-700 z-30">
                  <div className="absolute top-2 -left-4 w-6 h-3 bg-green-500 rounded-full rotate-[-30deg]"></div>
                  <div className="absolute top-6 -right-4 w-6 h-3 bg-green-500 rounded-full rotate-[30deg]"></div>
                  <div className="absolute top-10 -left-3 w-4 h-2 bg-green-400 rounded-full rotate-[-20deg]"></div>
                </div>
        ...
        {waterTank === 0 && (
          <div className="mt-8 p-4 bg-green-100 text-green-800 rounded-xl border border-green-200 text-center font-medium max-w-xl animate-fade-in">
