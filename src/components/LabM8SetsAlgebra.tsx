...
export default function LabM8SetsAlgebra({ onExit }: { onExit?: () => void }) {
 ...
 <div>
 <h2 className="text-2xl font-extrabold text-indigo-700 dark:text-indigo-400 mb-2">{t('lab.m8setsalgebra_demographic_survey')}</h2>
 <p className="text-sm text-slate-600 dark:text-[#a1a1aa]">{t('lab.m8setsalgebra_adjust_the_survey_results_to_s')}</p>
 </div>
 
 <div className="space-y-5 bg-slate-50 dark:bg-[#121212]/50 p-4 rounded-xl border border-slate-100 dark:border-[#1c1b1b]">
 <div>
 <div className="flex justify-between mb-1">
 <label className="text-sm font-semibold">{t('lab.m8setsalgebra_total_students')}</label>
 ...
 <label className="text-sm font-semibold">{t('lab.m8setsalgebra_biology_students')}</label>
 ...
 <label className="text-sm font-semibold">{t('lab.m8setsalgebra_cs_students')}</label>
 ...
 <label className="text-sm font-semibold">{t('lab.m8setsalgebra_students_in_both')}</label>
 ...
 <h3 className="font-bold text-lg text-indigo-900 dark:text-indigo-300 mb-2">{t('lab.m8setsalgebra_knowledge_check')}</h3>
 <p className="text-sm mb-4">{t('lab.m8setsalgebra_given_these_survey_results_how')} <strong>{t('lab.m8setsalgebra_neither')}</strong> {t('lab.m8setsalgebra_biology_nor_cs')}</p>
 ...
 placeholder={t('lab.m8setsalgebra_enter_value')}
 />
 <button 
 onClick={checkSets}
 ...
 >
 <Check size={18} className="mr-1.5" /> {t('lab.m8setsalgebra_check')}
 </button>
 </div>
 {setsFeedback && (
 ...
 <div className="space-y-6 flex-1 flex flex-col">
 <div>
 <h2 className="text-2xl font-extrabold text-emerald-700 dark:text-emerald-400 mb-2">{t('lab.m8setsalgebra_sequence_growth')}</h2>
 <p className="text-sm text-slate-600 dark:text-[#a1a1aa]">{t('lab.m8setsalgebra_model_career_progressions_usin')}</p>
 </div>

 <div className="space-y-5 bg-slate-50 dark:bg-[#121212]/50 p-4 rounded-xl border border-slate-100 dark:border-[#1c1b1b]">
 <div>
 <label className="block text-sm font-semibold mb-2">{t('lab.m8setsalgebra_sequence_type')}</label>
 <select 
 value={seqType} 
 ...
 >
 <option value="arithmetic">{t('lab.m8setsalgebra_arithmetic_constant_addition')}</option>
 <option value="geometric">{t('lab.m8setsalgebra_geometric_constant_multiplicat')}</option>
 </select>
 </div>
 <div>
 <div className="flex justify-between mb-1">
 <label className="text-sm font-semibold">{t('lab.m8setsalgebra_first_term_year_1')}</label>
 ...
 <label className="text-sm font-semibold">{t('lab.m8setsalgebra_target_year_n')}</label>
 ...
 <h3 className="font-bold text-lg text-emerald-900 dark:text-emerald-300 mb-2">{t('lab.m8setsalgebra_assessment')}</h3>
 <p className="text-sm mb-4">{t('lab.m8setsalgebra_calculate_the_exact_predicted_')} <strong>{t('lab.m8setsalgebra_year')} {targetN}</strong>.</p>
 <div className="flex space-x-2">
 <input 
 type="number" 
 value={seqAns} 
 ...
 placeholder={t('lab.m8setsalgebra_enter_predicted_value')}
 />
 <button 
 onClick={checkSeq}
 ...
 <h3 className="text-xl font-bold text-center mb-6 text-slate-700 dark:text-[#ffffff]">{t('lab.m8setsalgebra_venn_diagram_visualization')}</h3>
 ...
 <text x="35" y="45" fontSize="16" fontWeight="bold" fill="currentColor" className="text-slate-500 dark:text-[#71717a]">{t('lab.m8setsalgebra_total_surveyed_u')} {totalStudents}</text>
 
 {/* Neither Section Text */}
 <rect x="350" y="340" width="115" height="28" rx="6" fill="currentColor" className="text-slate-100 dark:text-slate-800 dark:text-[#f8fafc]" />
 <text x="407" y="359" fontSize="14" fontWeight="bold" textAnchor="middle" fill="currentColor" className="text-slate-600 dark:text-[#a1a1aa]">{t('lab.m8setsalgebra_neither_1')} {neither}</text>
 ...
 <text x="120" y="50" fontSize="14" fontWeight="bold" fill="#fff" textAnchor="middle">{t('lab.m8setsalgebra_biology')}</text>
 
 <rect x="300" y="30" width="120" height="30" rx="15" fill="#3b82f6" />
 <text x="360" y="50" fontSize="14" fontWeight="bold" fill="#fff" textAnchor="middle">{t('lab.m8setsalgebra_computer_sci')}</text>
 ...
 <div className="w-full h-full max-w-4xl max-h-[600px] bg-white dark:!bg-[#121212] rounded-3xl shadow-xl border border-slate-200 dark:border-[#1c1b1b] flex flex-col p-6 overflow-hidden">
 <h3 className="text-xl font-bold text-center mb-6 text-slate-700 dark:text-[#ffffff]">{t('lab.m8setsalgebra_value_progression_chart')}</h3>
 <div className="flex-1 min-w-0 w-full relative">
 <svg viewBox="0 0 800 400" className="w-full h-full drop-shadow-sm">
 {/* Grid Lines */}
 {[0, 1, 2, 3, 4].map(i => (
 <line key={`grid-${i}`} x1="60" y1={40 + i * 70} x2="760" y2={40 + i * 70} stroke="currentColor" strokeWidth="1" strokeDasharray="4 4" className="text-slate-200 dark:text-slate-700 dark:text-slate-300" />
 ))}
 ...
 <text x="30" y="180" transform="rotate(-90 30 180)" fontSize="14" fontWeight="bold" fill="currentColor" textAnchor="middle" className="text-slate-500 dark:text-[#71717a]">{t('lab.m8setsalgebra_value')}</text>
 <text x="410" y="370" fontSize="14" fontWeight="bold" fill="currentColor" textAnchor="middle" className="text-slate-500 dark:text-[#71717a]">{t('lab.m8setsalgebra_time_years')}</text>
