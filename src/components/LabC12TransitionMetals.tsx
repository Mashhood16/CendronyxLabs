    ...
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
        ...
        <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm p-6 flex flex-col items-center border border-slate-200 dark:border-[#1c1b1b]">
          ...
          <select 
            className="w-full max-w-sm p-2 border rounded bg-slate-50 dark:bg-[#121212] mb-6 font-mono font-bold text-center"
            value={complexIdx}
          ...
          <div className="w-full flex gap-4">
            <div className="w-1/2 flex flex-col items-center">
              ...
              >
                <div className="absolute top-0 w-full h-4 bg-slate-50 dark:bg-[#121212]/30"></div>
              </div>
