  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 lg:overflow-hidden">
        ...
        <div className="bg-[#000000] dark:!bg-[#121212] rounded-xl shadow-sm border border-[#1c1b1b] dark:border-[#1c1b1b] p-6 flex flex-col items-center justify-center relative overflow-hidden">
          <div className="relative w-full aspect-square max-w-sm bg-green-900 border-4 border-green-800 rounded-lg p-4 shadow-xl flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-8 mt-8">
              <div className="flex items-center gap-4">
                <div className="bg-[#121212] dark:bg-[#121212] border-2 border-slate-600 dark:border-[#1c1b1b] rounded p-2 text-cyan-400 font-mono w-16 text-center">{vA.toFixed(1)}V</div>
                <div className="w-16 h-1 bg-cyan-600" />
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-[#121212] dark:bg-[#121212] border-2 border-slate-600 dark:border-[#1c1b1b] rounded p-2 text-cyan-400 font-mono w-16 text-center">{vB.toFixed(1)}V</div>
                <div className="w-16 h-1 bg-cyan-600" />
              </div>
            </div>

            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-[#121212] dark:!bg-[#121212] border-2 border-[#1c1b1b] dark:border-[#1c1b1b] rounded-lg flex items-center justify-center shadow-2xl">
