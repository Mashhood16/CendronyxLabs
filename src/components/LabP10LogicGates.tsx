      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 lg:overflow-hidden">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-6 flex flex-col gap-6 overflow-y-auto">
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">In real electronic circuits, logic gates process continuous voltages. TTL (Transistor-Transistor Logic) defines specific voltage thresholds.</p>
            <ul className="text-sm text-slate-600 dark:text-slate-300 list-disc pl-5 mb-4">
          ...
          <div>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-1">Gate Type</label>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-1">Input A Voltage: {vA.toFixed(2)} V</label>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-1">Input B Voltage: {vB.toFixed(2)} V</label>
          ...
          <div className="relative w-full aspect-square max-w-sm bg-green-900 border-4 border-green-800 rounded-lg p-4 shadow-xl flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-8 mt-8">
              <div className="flex items-center gap-4">
                <div className="bg-slate-800 dark:bg-slate-800 border-2 border-slate-600 dark:border-slate-500 rounded p-2 text-cyan-400 font-mono w-16 text-center">{vA.toFixed(1)}V</div>
                <div className="w-16 h-1 bg-cyan-600" />
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-slate-800 dark:bg-slate-800 border-2 border-slate-600 dark:border-slate-500 rounded p-2 text-cyan-400 font-mono w-16 text-center">{vB.toFixed(1)}V</div>
                <div className="w-16 h-1 bg-cyan-600" />
              </div>
            </div>

            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-slate-800 dark:bg-slate-800 border-2 border-slate-700 dark:border-slate-500 rounded-lg flex items-center justify-center shadow-2xl">
            ...
            <div className="absolute top-1/2 right-4 -translate-y-1/2 flex items-center gap-4">
              ...
              <div className="bg-slate-800 dark:bg-slate-800 border-2 border-slate-600 dark:border-slate-500 rounded p-2 text-purple-400 font-mono w-16 text-center shadow-[0_0_15px_#9333ea]">{vOut.toFixed(1)}V</div>
            </div>
          </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 flex flex-col overflow-hidden">
          ...
          <div className="p-4 flex-1 overflow-y-auto">
            ...
            <div className="mb-6">
              <h3 className="font-semibold text-slate-700 dark:text-slate-200 text-sm mb-2">Graph: V_out vs V_A</h3>
              <div className="w-full aspect-video bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 dark:border-slate-500 rounded relative">
                ...
                <div className="absolute bottom-1 left-1/2 -translate-x-1/2 text-[10px] text-slate-500 dark:text-slate-400">V_A (Volts)</div>
                <div className="absolute top-1/2 -left-2 -translate-y-1/2 -rotate-90 text-[10px] text-slate-500 dark:text-slate-400">V_out (Volts)</div>
              </div>
            </div>
