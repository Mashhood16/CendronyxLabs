    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col">
      ...
      <div className="flex-1 p-4 md:p-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Column 1: Theory */}
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700 p-6 flex flex-col h-[calc(100vh-8rem)] overflow-y-auto">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-blue-100 dark:bg-blue-900 rounded-xl">
                <BookOpen className="w-6 h-6 text-blue-600 dark:text-blue-400 dark:text-blue-400" />
              </div>
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-300 dark:text-white">Verbals Theory</h2>
            </div>

            <div className="space-y-6">
              <section>
                <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-300 mb-2 flex items-center gap-2">
              ...
              <section>
                ...
                <div className="bg-orange-50 dark:bg-orange-900 p-4 rounded-xl border border-orange-100 dark:border-orange-800/50 text-sm text-slate-700 dark:text-slate-300 dark:text-slate-300">
              ...
              <section>
                ...
                <div className="bg-green-50 dark:bg-green-900 p-4 rounded-xl border border-green-100 dark:border-green-800/50 text-sm text-slate-700 dark:text-slate-300 dark:text-slate-300">
              ...
              <section>
                ...
                <div className="bg-purple-50 dark:bg-purple-900 p-4 rounded-xl border border-purple-100 dark:border-purple-800/50 text-sm text-slate-700 dark:text-slate-300 dark:text-slate-300">
          ...
          {/* Column 2: Simulation */}
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700 p-6 flex flex-col h-[calc(100vh-8rem)]">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-slate-800 dark:text-slate-300 dark:text-white">Conveyor Sorter</h2>
                  <p className="text-sm text-slate-500 dark:text-slate-400 dark:text-slate-400">Sort phrases by their verbal type</p>
                </div>
              </div>
              <button
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative bg-slate-50 dark:bg-slate-900 rounded-2xl border-2 border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700 overflow-hidden p-6">
              
              {/* Conveyor Belt Background */}
              <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-20 bg-slate-200 dark:bg-slate-900 dark:bg-slate-800 flex items-center overflow-hidden border-y-4 border-slate-300 dark:border-slate-600 dark:border-slate-700">
                <div className="w-[200%] h-full flex opacity-20">
                  {Array.from({ length: 20 }).map((_, i) => (
                    <div key={i} className="flex-1 border-r-4 border-slate-400 dark:border-slate-500 skew-x-[20deg]" />
                  ))}
                </div>
              </div>
              ...
              <div className="z-10 w-full max-w-md">
                {!isSimulationRunning && queue.length > 0 && (
                  <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700">
                    <h3 className="text-lg font-bold text-slate-800 dark:text-slate-300 mb-2">Simulation Paused</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Press Play to start sorting!</p>
                  </div>
                )}
                ...
                {queue.length === 0 && (
                  <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700">
                    ...
                    <h3 className="text-lg font-bold text-slate-800 dark:text-slate-300 mb-2">All Items Sorted!</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Check your log or restart the conveyor.</p>
                  </div>
                )}

                {isSimulationRunning && currentItem && (
                  <div className="text-center p-6 bg-white dark:bg-slate-800 rounded-xl shadow-xl border-2 border-indigo-200 dark:border-indigo-700/50 dark:border-indigo-800 animate-in zoom-in duration-300">
                    <FileText className="w-8 h-8 text-indigo-500 dark:text-indigo-400 mx-auto mb-3" />
                    <p className="text-lg text-slate-800 dark:text-slate-300 font-medium leading-relaxed">
              ...
              <div className="absolute bottom-6 inset-x-4 flex justify-center gap-4">
                ...
                <button
                  ...
                  disabled={!isSimulationRunning || !currentItem}
                  className="flex-1 py-3 px-2 bg-green-50 hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-xl shadow-md transition-all active:scale-95 text-sm"
                >
                  Participle
                </button>
                <button
                  ...
                  disabled={!isSimulationRunning || !currentItem}
                  className="flex-1 py-3 px-2 bg-purple-50 hover:bg-purple-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-xl shadow-md transition-all active:scale-95 text-sm"
                >
                  Infinitive
                </button>
              </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700 p-6 flex flex-col h-[calc(100vh-8rem)]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-300 dark:text-white">Log & Assessment</h2>
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-8 pr-2">
              ...
              {/* Log Section */}
              <section>
                <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-300 mb-3 flex items-center gap-2">
                  <History className="w-5 h-5 text-emerald-500 dark:text-emerald-400" />
                  Sorting Log
                </h3>
                {sortedLog.length === 0 ? (
                  <div className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-900 p-4 rounded-xl text-center border border-dashed border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700">
                    ...
                    {sortedLog.map((log, idx) => (
                      <div key={idx} className={`p-3 rounded-lg border flex flex-col gap-1 ${
                        ...
                        <div className="flex justify-between items-start">
                          <span className="font-medium text-sm text-slate-800 dark:text-slate-300 line-clamp-1">
                            "{log.item.text}"
                          </span>
                          {log.isCorrect ? (
                        ...
                        <div className="text-xs text-slate-600 dark:text-slate-400 dark:text-slate-400">
              ...
              {/* Assessment Section */}
              <section className="pt-6 border-t border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700">
                ...
                <div className="space-y-6">
                    ...
                    <div key={qIndex} className="space-y-3">
                      ...
                      <div className="space-y-2">
                        {q.options.map((opt, oIndex) => {
                          ...
                          let btnClass = "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700";
                          ...
                          if (isSelected && !showResults) {
                            ...
                            btnClass = "bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700 text-slate-400 opacity-50";
                          }
                  ...
                  {!showResults ? (
                    <button
                      ...
                      className={`w-full py-3 rounded-xl font-bold transition-all ${
                        assessmentScores.includes(-1)
                          ? 'bg-slate-100 dark:bg-slate-900 dark:bg-slate-800 text-slate-400 cursor-not-allowed'
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 dark:border-slate-700 dark:border-slate-700 text-center space-y-3">
                      <div className="text-2xl font-black text-slate-800 dark:text-slate-300 dark:text-slate-300">
