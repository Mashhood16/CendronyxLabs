      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 flex-1">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 flex flex-col gap-4">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg mt-2">
            ...
            <input 
              ...
              className="w-full"
            />
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">Set mass before adding sample to flask.</p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 flex flex-col items-center">
          <div className="flex justify-around w-full mb-6 bg-slate-50 dark:bg-slate-900 p-3 rounded-lg">
            ...
            <button onClick={resetFlask} className="flex flex-col items-center p-2 border rounded hover:bg-slate-100 dark:bg-slate-800 transition-colors">
              <RefreshCw className="text-slate-500 dark:text-slate-400 w-8 h-8 mb-1" />
              <span className="text-xs font-semibold">Empty Flask</span>
            </button>
          </div>

          <div className="relative w-full max-w-[250px] aspect-square flex justify-center items-end bg-slate-50 dark:bg-slate-900 rounded-xl p-4 border border-slate-200 dark:border-slate-700 dark:border-slate-500">
            ...
            {flaskSample && (
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-xs font-bold text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-900/70 px-2 py-1 rounded">
          ...
          <div className="w-full mt-6 bg-slate-800 dark:bg-slate-800 text-green-400 font-mono text-sm p-4 rounded-lg min-h-[80px] flex items-center justify-center text-center">
            {equation}
          </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 p-5 flex flex-col gap-4">
          ...
          <div className="h-48 w-full border border-slate-200 dark:border-slate-700 dark:border-slate-500 rounded-lg p-2 bg-slate-50 dark:bg-slate-900 relative mt-2">
            <div className="absolute top-2 left-2 text-xs font-semibold text-slate-500 dark:text-slate-400">Vol Br₂ (mL) vs Mass of Oil (g)</div>
