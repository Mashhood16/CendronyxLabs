  ...
  return (
    <div className="overflow-y-auto flex flex-col h-screen bg-slate-50 dark:bg-slate-900 font-sans">
      ...
      <div className="flex-1 flex p-8 items-center justify-center gap-16">
        ...
        <div className="w-96 bg-slate-50 dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500">
          ...
          <div className="space-y-4">
            <button 
              ...
              className={`w-full p-4 rounded-xl text-left border-2 flex items-center justify-between transition-colors ${step === 0 ? 'border-amber-500 bg-amber-50 text-amber-900 font-bold' : step > 0 ? 'border-slate-200 dark:border-slate-700 dark:border-slate-500 bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-400'}`}
            >
            ...
            <button 
              ...
              className={`w-full p-4 rounded-xl text-left border-2 flex items-center justify-between transition-colors ${step === 1 ? 'border-amber-500 bg-amber-50 text-amber-900 font-bold' : step > 1 ? 'border-slate-200 dark:border-slate-700 dark:border-slate-500 bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-400'}`}
            >
            ...
            <button 
              ...
              className={`w-full p-4 rounded-xl text-left border-2 flex items-center justify-between transition-colors ${step === 2 ? 'border-amber-500 bg-amber-50 text-amber-900 font-bold' : step > 2 ? 'border-slate-200 dark:border-slate-700 dark:border-slate-500 bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-400'}`}
            >
            ...
            <button 
              ...
              className={`w-full p-4 rounded-xl text-left border-2 flex items-center justify-between transition-colors ${step === 3 ? 'border-amber-500 bg-amber-50 text-amber-900 font-bold' : step > 3 ? 'border-slate-200 dark:border-slate-700 dark:border-slate-500 bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400' : 'border-slate-200 dark:border-slate-700 dark:border-slate-500 text-slate-400'}`}
            >
        ...
        <div className="w-80 h-128 bg-slate-50 dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-500 flex flex-col items-center justify-end relative overflow-hidden">
          {/* Test Tube */}
          <div className={`w-16 h-80 border-4 border-t-0 border-slate-300 dark:border-slate-700 dark:border-slate-500 rounded-b-3xl relative overflow-hidden transition-transform duration-500 ${step === 3 ? 'animate-shake' : ''}`}>
            ...
            {getTubeContent() === 'cloudy' && (
              <>
                <div className="absolute bottom-32 w-full h-16 bg-slate-50 dark:bg-slate-900/90 backdrop-blur-xl border-t border-slate-200 dark:border-slate-700 dark:border-slate-500"></div>
                <div className="absolute bottom-0 w-full h-32 bg-amber-600/30 rounded-b-2xl"></div>
              </>
            )}
            
            {/* Glass reflection */}
            <div className="absolute top-0 left-2 w-2 h-full bg-slate-50 dark:bg-slate-900/40 rounded-full"></div>
          </div>
          <div className="mt-4 flex flex-col items-center">
            <Beaker className="w-8 h-8 text-slate-400 mb-2" />
            <span className="text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider text-sm">Test Tube</span>
          </div>
