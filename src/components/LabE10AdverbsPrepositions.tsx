        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 flex flex-col h-full overflow-hidden">
            <div className="p-6 bg-amber-50 dark:bg-amber-900/30 border-b border-amber-100 dark:border-amber-800/50 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Contextual Grammar</h2>
            </div>
            <div className="p-6 lg:overflow-y-auto flex-1 space-y-6 text-slate-700 dark:text-[#a1a1aa]">
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Types of Adverbs</h3>
              ...
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Prepositions of Time & Movement</h3>
                <ul className="list-disc pl-5 space-y-2 text-sm">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 p-6 flex flex-col h-full overflow-hidden">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-200 dark:border-neutral-900">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-[#a1a1aa]">Vector Simulator</h2>
            </div>
            
            <div className="flex-1 flex flex-col space-y-6">
              <div className="bg-slate-100 dark:bg-[#121212]/50 p-6 rounded-xl border border-slate-200 dark:border-[#1c1b1b]">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-xs font-bold text-slate-500 dark:text-[#71717a] bg-slate-200 dark:bg-slate-700 px-2 py-1 rounded">
                    {ADVERB_PUZZLES[currentPuzzle].type}
                  </span>
                </div>
                
                <p className="text-xl font-medium text-slate-900 dark:text-[#ffffff] text-center py-6 leading-relaxed">
                ...
                {ADVERB_PUZZLES[currentPuzzle].options.map((opt, idx) => (
                  <button
                    ...
                    className={`p-4 rounded-xl text-center text-sm font-bold transition-all border-2 ${
                      !puzzleAnswered
                        ? 'border-slate-200 dark:border-[#1c1b1b] hover:border-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/30'
                        : idx === ADVERB_PUZZLES[currentPuzzle].correctOptionIndex
                          ...
                          : idx === selectedOption
                            ...
                            : 'border-slate-200 dark:border-[#1c1b1b] opacity-50'
                    }`}
                  >
                    {opt}
                  </button>
              ...
              {puzzleAnswered && (
                <div className="mt-auto flex justify-end">
                  <button
                    onClick={nextPuzzle}
                    className="flex items-center gap-2 px-6 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-bold transition-colors dark:text-white dark:text-white dark:bg-amber-500 dark:hover:bg-amber-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-amber-500/40"
                  >
              ...
              {!assessmentSubmitted ? (
                <div className="space-y-6">
                        ...
                        {q.options.map((opt, oIdx) => (
                          <label key={oIdx} className="flex items-start gap-3 cursor-pointer group">
                            <input
                              type="radio"
                              name={`question-${qIdx}`}
                              className="mt-1 w-4 h-4 text-amber-600 dark:text-amber-400 bg-slate-100 dark:bg-[#121212]/50 border-slate-300 dark:border-[#1c1b1b]"
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2 px-4 bg-amber-600 hover:bg-amber-700 disabled:bg-slate-300 disabled: text-white rounded-lg font-medium transition-colors dark:bg-amber-500 dark:hover:bg-amber-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-amber-500/40"
                  >
                    Submit Evaluation
                  </button>
                </div>
