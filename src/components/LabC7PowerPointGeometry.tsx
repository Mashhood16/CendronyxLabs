        ...
        <div className="bg-white rounded-t-xl border border-slate-300 p-2 flex gap-6 w-full max-w-4xl mx-auto shadow-sm">
          ...
          <div className="flex flex-col border-r border-slate-200 pr-6">
            ...
            <div className="flex gap-2">
              <button onClick={() => addShape('square')} className="p-2 hover:bg-slate-100 rounded border border-transparent hover:border-slate-300"><Square className="w-5 h-5 text-blue-600" fill="currentColor"/></button>
              <button onClick={() => addShape('circle')} className="p-2 hover:bg-slate-100 rounded border border-transparent hover:border-slate-300"><Circle className="w-5 h-5 text-rose-600" fill="currentColor"/></button>
              <button onClick={() => addShape('triangle')} className="p-2 hover:bg-slate-100 rounded border border-transparent hover:border-slate-300"><Triangle className="w-5 h-5 text-emerald-600" fill="currentColor"/></button>
              <button onClick={() => addShape('parallelogram')} className="p-2 hover:bg-slate-100 rounded border border-transparent hover:border-slate-300">
          ...
          <div className="flex flex-col border-r border-slate-200 pr-6">
            ...
            <select value={transition} onChange={e => setTransition(e.target.value)} className="p-1 text-sm border border-slate-300 rounded outline-none">
          ...
          <div className="flex flex-col pr-6">
            ...
            <select 
              ...
              className="p-1 text-sm border border-slate-300 rounded outline-none disabled:opacity-50"
            >
              <option value="none">None</option>
