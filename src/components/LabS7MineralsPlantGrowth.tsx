  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-orange-50 font-sans">
      ...
      <div className="flex-1 p-8 flex flex-col items-center">
        <div className="bg-slate-50 dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-orange-100 max-w-2xl w-full text-center mb-8">
          <h2 className="text-2xl font-bold text-orange-800 mb-4">Testing Soil Nutrients</h2>
          <p className="text-slate-600 dark:text-slate-300 mb-6">Observe two identical seedlings planted in DIY sub-irrigated planters (soda bottles with wicks). One is in pure sand, and the other in a compost-soil mix. Both get equal water and light.</p>
          ...
          <div className="mt-4 font-bold text-lg text-slate-700 dark:text-slate-200">Time Elapsed: {weeks} Weeks</div>
        </div>
        ...
        <div className="flex gap-20 items-end justify-center mt-12">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-32 h-64 flex flex-col items-center">
              ...
              {/* Top Half (Inverted) */}
              <div className="absolute bottom-16 w-32 h-24 border-t border-l border-r border-slate-300 dark:border-slate-700 dark:border-slate-500/50 bg-slate-50 dark:bg-slate-900/20 backdrop-blur-sm z-10 flex justify-center">
                 {/* Sand */}
                 ...
                 {/* Wick */}
                 <div className="absolute -bottom-4 w-2 h-8 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 dark:border-slate-500"></div>
              </div>

              {/* Bottom Half (Reservoir) */}
              <div className="absolute bottom-0 w-32 h-20 border-b-2 border-l-2 border-r-2 border-slate-300 dark:border-slate-700 dark:border-slate-500/80 bg-blue-50/50 rounded-b-xl">
        ...
        {weeks === 4 && (
          <div className="mt-12 p-6 bg-slate-50 dark:bg-slate-900 shadow-lg text-slate-800 dark:text-slate-100 rounded-xl border-t-4 border-orange-500 max-w-xl">
