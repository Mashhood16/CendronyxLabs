          ...
          <div className="max-w-3xl mx-auto">
             ...
             <div className="mt-12 text-center pb-12">
               <button 
                 ...
                 className="px-12 py-4 bg-purple-600 hover:bg-purple-700 text-white font-bold text-xl rounded-full shadow-lg transition-transform active:scale-95 flex items-center justify-center gap-2 mx-auto"
               >
