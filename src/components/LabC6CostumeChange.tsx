...
export default function LabC6CostumeChange({ onExit }: LabProps) {
 ...
 <LabHeader onExit={onExit} title={t('lab.c6costumechange_costume_change_event')} />
 <div className="flex-1 px-8 pb-8 flex flex-col lg:overflow-y-auto">
 

 <p className="text-slate-600 dark:text-[#a1a1aa] mb-8">{t('lab.c6costumechange_press_the_c_key_on_your_keyboa')}</p>
 ...
 <div className="bg-amber-500 text-white font-bold p-3 text-sm dark:bg-[#121212] dark:border-[#1c1b1b]">{t('lab.c6costumechange_events_looks')}</div>
 <div className="flex-1 p-6 flex flex-col gap-2 bg-slate-50 dark:bg-[#121212]/50">
 
 <div className="bg-amber-400 rounded-lg shadow-sm border border-amber-500 dark:border-amber-400 p-4 w-full text-amber-900 dark:text-slate-900 dark:text-white font-bold text-sm rounded-b-none pb-6 relative z-10 dark:bg-amber-500 dark:hover:bg-amber-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-amber-500/40">
 ...
 {t('lab.c6costumechange_when_c_key_pressed')}
 </div>
 ...
 {t('lab.c6costumechange_next_costume')}
 </div>
 ...
 <span className="font-bold text-sm text-slate-600 dark:text-[#a1a1aa]">{t('lab.c6costumechange_scratch_stage')}</span>
 <span className="font-bold text-xs text-slate-500 dark:text-[#71717a]">{t('lab.c6costumechange_current_costume')} {costume}</span>
 </div>
