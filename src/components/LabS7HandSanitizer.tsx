...
export default function LabS7HandSanitizer({ onExit }: LabProps) {
 ...
 return (
 <div className="flex flex-col min- bg-emerald-50 font-sans dark:!bg-[#000000] text-slate-800 dark:text-[#ffffff] min-h-screen lg:h-screen overflow-x-hidden w-full">
