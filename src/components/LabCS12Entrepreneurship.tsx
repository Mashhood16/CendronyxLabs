...
export default function LabCS12Entrepreneurship({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col bg-slate-50 dark:!bg-[#000000] font-sans select-none overflow-hidden min-h-screen lg:h-screen overflow-x-hidden w-full">
 ...
 <div className="lg:flex-1 flex flex-col lg:grid lg:grid-cols-3 gap-0 lg:gap-4 p-4 min-h-0 lg:overflow-hidden">
...
'lab.cs12entrepreneurship_adding_flashy_or_complex_featu')}</li>
 ...
 <div className={`bg-slate-50 dark:!bg-[#121212] rounded-xl shadow-sm border border-slate-200 dark:border-[#1c1b1b] flex flex-col `}>
