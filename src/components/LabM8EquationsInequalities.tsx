...
export default function LabM8EquationsInequalities({ onExit }: { onExit?: () => void }) {
 ...
 return (
 <div className="flex flex-col min- overflow-hidden bg-slate-50 dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#ffffff] select-none min-h-screen lg:h-screen overflow-x-hidden w-full">
 {/* Header */}
 <LabHeader onExit={onExit} title={t('lab.m8equationsinequalities_unit_7_equations_inequalities')} />
