...
export default function LabM8EquationsInequalities({ onExit }: { onExit?: () => void }) {
 ...
 <div className="flex flex-col min- lg: overflow-hidden bg-slate-50 dark:!bg-[#000000] font-sans text-slate-800 dark:text-[#ffffff] select-none min-h-screen lg:h-screen overflow-x-hidden w-full">
  ...
  <h1 className="text-lg md:text-xl font-bold flex-1 truncate">{t('lab.m8equationsinequalities_unit_7_equations_inequalities')}</h1>
  <div className="flex space-x-2">
   <button onClick={() => setMode('equations')} className={`px-4 py-2 rounded-lg font-medium flex items-center transition-colors ${mode === 'equations' ? 'bg-indigo-600 text-white shadow-md' : 'bg-slate-200 text-slate-700 dark:text-slate-300 hover:bg-slate-300 dark:bg-slate-700 dark:text-[#ffffff] dark:hover:bg-slate-600'}`}>
   <TrendingUp size={18} className="mr-2" />  {t('lab.m8equationsinequalities_systems_of_equations')}
                        </button>
   <button onClick={() => setMode('inequalities')} className={`px-4 py-2 rounded-lg font-medium flex items-center transition-colors ${mode === 'inequalities' ? 'bg-rose-600 text-white shadow-md' : 'bg-slate-200 text-slate-700 dark:text-slate-300 hover:bg-slate-300 dark:bg-slate-700 dark:text-[#ffffff] dark:hover:bg-slate-600'}`}>
   <LocateFixed size={18} className="mr-2" />  {t('lab.m8equationsinequalities_business_constraints')}
                        </button>
  </div>
  </div>
  ...
  <div className="w-full lg:w-1/3 min-w-[320px] p-6 lg:overflow-y-auto border-r border-slate-200 dark:border-[#1c1b1b] shadow-lg z-10 flex flex-col">
   ...
   <div className="space-y-6 flex-1 flex flex-col">
    <div>
    <h2 className="text-2xl font-extrabold text-indigo-700 dark:text-indigo-400 mb-2">{t('lab.m8equationsinequalities_isp_pricing_model')}</h2>
    <p className="text-sm text-slate-600 dark:text-[#a1a1aa]">{t('lab.m8equationsinequalities_compare_two_internet_service_p')}</p>
    </div>
    ...
    <h3 className="font-bold text-indigo-900 dark:text-indigo-300">{t('lab.m8equationsinequalities_isp_a_blue_line')}</h3>
    <div>
     <div className="flex justify-between mb-1">
     <label className="text-sm font-semibold">{t('lab.m8equationsinequalities_cost_per_minute')}</label>
    ...
    <div>
     <div className="flex justify-between mb-1">
     <label className="text-sm font-semibold">{t('lab.m8equationsinequalities_base_cost')}</label>
    ...
    <h3 className="font-bold text-emerald-900 dark:text-emerald-300">{t('lab.m8equationsinequalities_isp_b_green_line')}</h3>
    <div>
     <div className="flex justify-between mb-1">
     <label className="text-sm font-semibold">{t('lab.m8equationsinequalities_cost_per_minute')}</label>
    ...
    <h3 className="font-bold text-lg text-indigo-900 dark:text-indigo-300 mb-2">{t('lab.m8equationsinequalities_optimize')}</h3>
    <p className="text-sm mb-4">{t('lab.m8equationsinequalities_at_how_many_minutes_is_the_cos')}</p>
    <div className="flex space-x-2">
     <input 
     type="number" 
     value={eqAns} 
     ...
     placeholder={t('lab.m8equationsinequalities_break_even_minutes')}
     />
     <button 
     ...
     >
     <Check size={18} className="mr-1.5" />  {t('lab.m8equationsinequalities_check')}
                                          </button>
    </div>
    {eqFeedback && (
   ...
   <div className="space-y-6 flex-1 flex flex-col">
    <div>
    <h2 className="text-2xl font-extrabold text-rose-700 dark:text-rose-400 mb-2">{t('lab.m8equationsinequalities_visual_constraints')}</h2>
    <p className="text-sm text-slate-600 dark:text-[#a1a1aa]">{t('lab.m8equationsinequalities_model_business_limits_e_g_max_')}</p>
    </div>
    ...
    <div className="flex space-x-4 items-end">
     ...
     <label className="block text-sm font-semibold mb-2">{t('lab.m8equationsinequalities_constraint_form')}</label>
     <div className="flex items-center space-x-2 font-mono p-2.5 border border-slate-300 dark:border-[#1c1b1b] rounded-lg">
      ...
      >
      <option value="<">{t('lab.m8equationsinequalities_lt')}</option>
      <option value="<=">{t('lab.m8equationsinequalities_le')}</option>
      <option value=">">{t('lab.m8equationsinequalities_gt')}</option>
      <option value=">=">{t('lab.m8equationsinequalities_ge')}</option>
      </select>
      <span>{ineqM}{t('lab.m8equationsinequalities_x')} {ineqC}</span>
     </div>
     </div>
    </div>
    ...
    <div>
     <div className="flex justify-between mb-1">
     <label className="text-sm font-semibold">{t('lab.m8equationsinequalities_slope_rate_of_change')}</label>
    ...
    <div>
     <div className="flex justify-between mb-1">
     <label className="text-sm font-semibold">{t('lab.m8equationsinequalities_y_intercept_fixed_limit')}</label>
    ...
    <div className="space-y-5 bg-slate-50 dark:bg-[#121212]/50 p-4 rounded-xl border border-slate-100 dark:border-[#1c1b1b]">
    <h3 className="font-bold">{t('lab.m8equationsinequalities_test_a_point')}</h3>
    <div className="flex space-x-4">
     <div className="flex-1">
     <label className="text-sm font-semibold mb-1 block">{t('lab.m8equationsinequalities_x_coord')} {ineqPointX}</label>
     ...
     <div className="flex-1">
     <label className="text-sm font-semibold mb-1 block">{t('lab.m8equationsinequalities_y_coord')} {ineqPointY}</label>
    ...
    <h3 className="font-bold text-lg text-rose-900 dark:text-rose-300 mb-2">{t('lab.m8equationsinequalities_verify_constraint')}</h3>
    <p className="text-sm mb-4">{t('lab.m8equationsinequalities_does_your_selected_point')}{ineqPointX}, {ineqPointY}{t('lab.m8equationsinequalities_satisfy_the_business_rule')}</p>
    <button 
    ...
    >
     <Check size={18} className="mr-1.5" />  {t('lab.m8equationsinequalities_check_point')}
                                         </button>
    {ineqFeedback && (
  ...
  <div className="w-full lg:w-2/3 p-4 md:p-8 flex flex-col items-center justify-center bg-slate-100 dark:bg-[#1c1b1b]/50 dark:bg-slate-950/50 relative overflow-hidden">
   {mode === 'equations' ? (
   <div className="w-full h-full max-w-4xl max-h-[600px] bg-white dark:!bg-[#121212] rounded-3xl shadow-xl border border-slate-200 dark:border-[#1c1b1b] flex flex-col p-6 overflow-hidden relative">
    <h3 className="text-xl font-bold text-center mb-6 text-slate-700 dark:text-[#ffffff]">{t('lab.m8equationsinequalities_cost_comparison_graph')}</h3>
    ...
    <svg viewBox="0 0 600 400" className="w-full h-full bg-slate-50 dark:bg-[#121212] rounded-xl border border-slate-200 dark:border-[#1c1b1b]">
     ...
     <text x="315" y="380" fontSize="14" fill="currentColor" textAnchor="middle" className="font-bold text-slate-500">{t('lab.m8equationsinequalities_minutes_used')}</text>
     <text x="20" y="185" fontSize="14" fill="currentColor" textAnchor="middle" transform="rotate(-90 20 185)" className="font-bold text-slate-500">{t('lab.m8equationsinequalities_cost')}</text>
     ...
     return (
      ...
      <text x={mapX(x2A)-10} y={mapY(y2A)-10} fill="#2563eb" fontSize="14" fontWeight="bold">{t('lab.m8equationsinequalities_isp_a')}</text>
      
      {/* ISP B */}
      <line x1={mapX(x1B)} y1={mapY(y1B)} x2={mapX(x2B)} y2={mapY(y2B)} stroke="#10b981" strokeWidth="4" />
      <text x={mapX(x2B)-10} y={mapY(y2B)+20} fill="#10b981" fontSize="14" fontWeight="bold">{t('lab.m8equationsinequalities_isp_b')}</text>
      ...
      {intersectX >= 0 && intersectX <= maxEqX && intersectY >= 0 && intersectY <= maxEqY && (
       ...
       <text x={mapX(intersectX)} y={mapY(intersectY) - 15} fill="#ef4444" fontSize="12" fontWeight="bold" textAnchor="middle">
        ({intersectX.toFixed(1)}  {t('lab.m8equationsinequalities_min')}{intersectY.toFixed(1)})
       </text>
       {/* Guidelines */}
   ...
   <div className="w-full h-full max-w-4xl max-h-[600px] bg-white dark:!bg-[#121212] rounded-3xl shadow-xl border border-slate-200 dark:border-[#1c1b1b] flex flex-col p-6 overflow-hidden relative">
    <h3 className="text-xl font-bold text-center mb-6 text-slate-700 dark:text-[#ffffff]">{t('lab.m8equationsinequalities_feasible_region')}</h3>
    ...
    <svg viewBox="0 0 600 400" className="w-full h-full bg-slate-50 dark:bg-[#121212] rounded-xl border border-slate-200 dark:border-[#1c1b1b] overflow-hidden">
     ...
     <text x="130" y="20" fontSize="12" fill="currentColor" opacity="0.6">{t('lab.m8equationsinequalities_y_axis')}</text>
     <text x="560" y="310" fontSize="12" fill="currentColor" opacity="0.6">{t('lab.m8equationsinequalities_x_axis')}</text>
