...
export default function LabM11Trigonometry({ onExit }: { onExit?: () => void }) {
 ...
 <div className={`w-full flex justify-center items-center bg-[#000000] dark:bg-[#121212] lg:dark:bg-[#121212] rounded-lg p-4 mb-6 relative h-64 shadow-inner flex-col 'flex' : 'hidden'} lg:flex rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t`}>
