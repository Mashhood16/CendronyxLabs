  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 font-sans">
      <div className="bg-white border-b border-slate-200 p-4 flex items-center justify-between shrink-0">
        ...
        <h1 className="text-xl font-bold text-slate-800">Unit 2: Human Body Systems Projects</h1>
      </div>
      ...
      <div className="flex-1 p-8 flex flex-col items-center">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 max-w-4xl w-full">
          <div className="flex items-center mb-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-slate-800">Working Model & Observations</h2>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200 mt-8">
              <h4 className="text-blue-800 font-bold mt-0">Submission Requirements</h4>
