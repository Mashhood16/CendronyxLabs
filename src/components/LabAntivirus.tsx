  ...
  return (
    <div className="overflow-y-auto w-full h-screen bg-slate-900 flex flex-col font-sans">
      ...
      <div className="flex-1 relative flex items-center justify-center overflow-hidden bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center">
        ...
        <div className="absolute inset-0 bg-black/20 backdrop-blur-[2px]">
           ...
           <div className="p-8 flex flex-col gap-6">
              {!hasAntivirus && (
                ...
                >
                  <div className="w-12 h-12 bg-slate-100 rounded flex items-center justify-center shadow-lg group-hover:bg-blue-100 border border-slate-300">
        ...
        {/* Modal Windows */}
        {step === 'installer' && (
          <div className="w-[500px] bg-slate-50 rounded shadow-2xl border border-slate-300 flex flex-col overflow-hidden z-20 animate-fade-in">
             ...
             <div className="p-8 flex flex-col items-center text-center">
                ...
                <h2 className="text-xl font-bold text-slate-800 mb-2">Installing Protection...</h2>
                <p className="text-slate-500 text-sm mb-8">Please wait while setup installs SecureShield on your computer.</p>
                
                <div className="w-full bg-slate-200 h-6 rounded-sm overflow-hidden border border-slate-300 mb-2">
                   <div className="h-full bg-blue-500 transition-all duration-75" style={{ width: `${installProgress}%` }}></div>
                </div>
                <div className="w-full text-left text-xs text-slate-500 font-mono">
        ...
        {step === 'scanning' && (
          <div className="w-[600px] bg-slate-50 rounded shadow-2xl border border-slate-300 flex flex-col overflow-hidden z-20 animate-fade-in">
             ...
             <div className="p-8 flex gap-8">
                <div className="w-1/3 flex flex-col justify-between border-r border-slate-200 pr-8">
                   <div className="space-y-4">
                     <div className="text-slate-800 font-bold flex items-center gap-2"><div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div> Status</div>
                     <div className="text-slate-500 cursor-pointer hover:text-green-600">Protection</div>
                     <div className="text-slate-500 cursor-pointer hover:text-green-600">Privacy</div>
                   </div>
                   <button onClick={() => setStep('desktop')} className="text-sm text-slate-500 underline text-left">Cancel Scan</button>
                </div>
                <div className="w-2/3 flex flex-col">
                   <h2 className="text-xl font-bold text-slate-800 mb-2">Full System Scan</h2>
                   <p className="text-slate-500 text-sm mb-6">Scanning memory, registry, and file system for malicious software.</p>
                   ...
                   <div className="bg-slate-900 text-green-400 font-mono text-xs p-2 h-24 overflow-hidden rounded border border-slate-700">
             ...
             <div className="p-8 flex flex-col items-center text-center">
                {threatsRemoved ? (
                   <>
                     ...
                     <h2 className="text-xl font-bold text-slate-800 mb-2">System is Protected</h2>
                     <p className="text-slate-500 text-sm mb-8">All detected malware has been quarantined successfully.</p>
                     <button onClick={() => setStep('desktop')} className="px-8 py-2 bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold rounded transition-colors">Close</button>
                   </>
                ) : (
                   <>
