                ...
                <button
                  ...
                  className={`relative p-4 rounded-xl border-2 text-left transition-all z-10 flex items-center gap-4 ${
                    isActive 
                      ...
                      : isCompleted
                        ? 'border-green-200 bg-slate-50 dark:bg-[#121212] hover:border-green-300'
                        : 'border-slate-200 dark:border-[#1c1b1b] bg-slate-50 dark:bg-[#121212] opacity-60 hover:opacity-100'
                  }`}
                >
                  <div className={`w-10 h-10 shrink-0 rounded-full flex items-center justify-center font-bold text-white shadow-sm ${
                    isActive ? 'bg-blue-600' : isCompleted ? 'bg-green-500' : 'bg-slate-300 dark:bg-[#121212]'
                  }`}>
