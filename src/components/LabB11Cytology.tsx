...
export default function LabB11Cytology({ onExit }: { onExit?: () => void }) {
 ...
 <circle cx="50" cy="50" r="10" className="text-blue-800 fill-current dark:text-[#ffffff]" />
 ...
 <circle cx="30" cy="40" r="8" className="text-indigo-800 fill-current dark:text-[#ffffff]" />
 <circle cx="60" cy="60" r="6" className="text-indigo-800 fill-current dark:text-[#ffffff]" />
 <circle cx="45" cy="30" r="4" className="text-indigo-800 fill-current dark:text-[#ffffff]" />
 </svg>
 );
 ...
 <main className="lg:flex-1 flex flex-col lg:grid lg:grid-cols-3 gap-0 lg:gap-6 p-6 min-h-0 lg:overflow-hidden">
 ...
 <section className={`w-full bg-[#000000] dark:bg-[#121212] lg:dark:bg-[#121212] rounded-xl shadow-inner border-4 border-[#1c1b1b] dark:border-[#2a2a2a] lg:dark:border-[#1c1b1b] p-6 flex flex-col relative 'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
 {activeTab === 'sem' ? (
 <>
 ...
 <div className={`w-64 h-64 border-2 border-[#1c1b1b] dark:border-[#1c1b1b] rounded-full bg-slate-950 p-4 shadow-2xl flex items-center justify-center relative `}>
 {/* Grid lines */}
 <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:20px_20px] rounded-full pointer-events-none ${activeMobileTab === 'lab' ? 'block' : 'hidden'} lg:block rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t"></div>
 {getSvgContent()}
 </div>
 </div>
 ...
 className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 transition-all ${selectedOrgan === organ.id ? 'bg-slate-700 dark:bg-[#121212] border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.3)]' : 'bg-[#121212] dark:bg-[#121212] border-slate-600 dark:border-slate-500 hover:border-slate-400 dark:border-slate-500'}`}
 >
 <div className={`w-12 h-12 rounded-full flex items-center justify-center ${selectedOrgan === organ.id ? 'bg-emerald-500 text-white' : 'bg-slate-600 dark:bg-[#121212] text-slate-300'}`}>
 {organ.icon}
 </div>
