  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none">
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 lg:overflow-hidden">
          ...
          {activeTab === 'sem' ? (
            <div className="text-slate-600 dark:text-[#a1a1aa] space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 dark:bg-teal-950/20 dark:border-teal-900">
                ...
                <p className="font-mono text-sm bg-slate-50 dark:bg-[#121212] p-2 rounded border border-blue-200 text-center">Magnification (M) = Image Size (I) / Actual Size (A)</p>
        ...
        <section className="bg-[#000000] dark:bg-[#121212] rounded-xl shadow-inner border-4 border-[#1c1b1b] dark:border-[#1c1b1b] p-6 flex flex-col relative overflow-hidden">
          {activeTab === 'sem' ? (
            <>
              ...
              <div className="flex-1 flex items-center justify-center relative">
                <div className="w-64 h-64 border-2 border-[#1c1b1b] dark:border-[#1c1b1b] rounded-full bg-slate-950 p-4 shadow-2xl flex items-center justify-center overflow-hidden relative">
                  {/* Grid lines */}
