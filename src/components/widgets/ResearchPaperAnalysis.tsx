...
export const RESEARCH_PAPERS: Record<string, ResearchPaper> = {
  ...
  'pet-imaging': {
    ...
    keyFinding: 'By extending the axial field-of-view to 194 cm, the scanner captures 100% of emitted gamma photons in coincidence, compared to ~2-5% in conventional PET scanners — a direct application of the E = hc/Î» photon detection principle.',
    ...
    connectionToLab: 'This PET scanner directly uses the annihilation physics from this lab — positron-electron annihilation produces 511 keV gamma rays (E = hc/Î» = 1240/0.00243 nm). The detectors use scintillation crystals that convert these gamma photons to visible light via the photoelectric effect, which is then detected by photomultiplier tubes — a practical application of E = hc/Î».'
  },
  'protein-mass-spec': {
    ...
    questions: [
      ...
      {
        id: 2,
        question: 'If two adjacent charge-state peaks differ by 100 m/z at charge state +40, what is the calculated mass of the protein complex? (Hint: Î”(m/z) = mass × (1/z - 1/(z+1)))',
        hint: 'For large z, Î”(m/z) â‰ˆ mass/z². So mass â‰ˆ 100 × 40² = ?',
        answer: '160000',
        tolerance: 10000
      }
    ],
  ...
  'mems-oscillator': {
    ...
    questions: [
      ...
      {
        id: 2,
        question: 'The effective spring constant k_eff = k_mech - k_elec(V²). If the mechanical spring constant k_mech = 100 N/m and at V=0 the frequency is 100 kHz, using Ï‰ = âˆš(k/m), what is the effective mass m? (Hint: m = k/(2Ï€f)²)',
        hint: 'm = 100 / (2Ï€ × 100,000)² = 100 / (6.2832 × 10âµ)² = 100 / (3.948×10¹¹) = 2.53×10â»¹â° kg',
        answer: '2.53e-10',
        tolerance: 0.5e-10
      }
    ],
    connectionToLab: 'MEMS resonators are physical SHM systems — a proof mass suspended by springs oscillates at Ï‰ = âˆš(k/m), exactly the equation derived in this lab. The spring softening effect (k_eff = k - Î±V²) is a direct application of Hooke\'s law combined with electrostatic force, which you can explore by adjusting the damping and spring constant in the car suspension simulation.'
  },
  'bioelectricity': {
    id: 'bioelectricity',
    ...
    questions: [
      ...
      {
        id: 2,
        question: 'If internal resistance is 500 Î©, what is the maximum power output when connected to a matched load? (Hint: P_max = V²/4R for maximum power transfer)',
        hint: 'P_max = (600 V)² / (4 × 500 Î©) = 360000 / 2000 = ?',
        answer: '180',
        tolerance: 10
      }
    ],
  ...
  'exoplanet-gravitational': {
    ...
    keyFinding: 'The detected planet has mass M = 18.4 M_Earth at orbital radius 5.5 AU, with orbital period T = 12.7 years — consistent with Kepler\'s Third Law (T² âˆ a³) applied to the host star M-dwarf (0.45 M_Sun).',
    ...
    questions: [
      ...
      {
        id: 2,
        question: 'Using Kepler\'s Third Law: T² = (4Ï€²/GM) a³. If the star has mass M = 0.45 M_Sun (M_Sun = 1.99×10³â° kg), what is the expected orbital radius a for the detected T = 12.7 year period? (Hint: Use Kepler\'s law normalized to Earth: (T/T_Earth)² = (a/a_Earth)³(M_Sun/M))',
        hint: 'Start from (12.7/1)² = (a/1)³(1/0.45). So a³ = (12.7)² × 0.45 = 72.6. Take cube root: a = â·âˆš72.6 = ?',
        answer: '4.17',
        tolerance: 0.2
      }
    ],
    connectionToLab: 'This exoplanet detection is a direct application of the gravitational physics you\'re exploring here. The Kepler\'s Third Law calculation in this lab (T² âˆ a³) is the exact same formula astronomers use to find planets around distant stars. The orbital mechanics simulator in this lab, which visualizes how satellites orbit Earth using F = GMm/r², uses the same Newtonian inverse-square law that governs these planetary systems.'
  }
};
