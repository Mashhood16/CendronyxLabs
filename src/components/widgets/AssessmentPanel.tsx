...
export default function AssessmentPanel({
  ...
  const handleCheck = (q: AssessmentQuestion) => {
    ...
    const status: 'correct' | 'incorrect' = Math.abs(userAnswer - q.answer) <= q.tolerance ? 'correct' : 'incorrect';

    const newStatuses: Record<string, 'idle' | 'correct' | 'incorrect'> = { ...statuses, [q.id]: status };
