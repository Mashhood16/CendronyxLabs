      ...
      <div className="flex-1 flex lg:overflow-hidden">
        ...
        <div className="w-1/2 bg-slate-50 dark:bg-[#121212] p-12 lg:overflow-y-auto border-r border-slate-300 dark:border-[#1c1b1b] shadow-[10px_0_20px_rgba(0,0,0,0.05)] z-10">
           ...
           <div className="flex justify-between items-end mb-8 border-b-2 border-emerald-100 pb-4">
             <div>
               <h2 className="text-3xl font-bold text-slate-800 dark:text-[#ffffff] uppercase tracking-widest">Campaign Manager</h2>
               <p className="text-slate-500 dark:text-[#71717a] font-bold">Brand: PIA (Pakistan Airlines)</p>
             </div>
             <div className="text-right">
               <div className="text-sm font-bold text-slate-500 dark:text-[#71717a] uppercase">Remaining Budget</div>
           ...
           <div className="mb-12">
             <h3 className="text-xl font-bold text-slate-700 dark:text-[#ffffff] mb-4">1. Select Special Incentive</h3>
             <p className="text-sm text-slate-500 dark:text-[#71717a] mb-4">What special offer are you promoting to attract valuable customers?</p>
             ...
             <div className="grid grid-cols-3 gap-4">
               ...
               >
                 ...
                 <span className="font-bold text-slate-700 dark:text-[#ffffff]">20% Off Tickets</span>
               </button>
               <button 
               ...
               >
                 ...
                 <span className="font-bold text-slate-700 dark:text-[#ffffff]">Free VIP Lounge</span>
               </button>
               <button 
               ...
               >
                 <span className="text-2xl">✈️</span>
                 <span className="font-bold text-slate-700 dark:text-[#ffffff]">Double Air Miles</span>
               </button>
             </div>
           </div>

           <div className="mb-12">
             <h3 className="text-xl font-bold text-slate-700 dark:text-[#ffffff] mb-4">2. Allocate Ad Budget</h3>
             <p className="text-sm text-slate-500 dark:text-[#71717a] mb-6">Distribute your Rs. 10,000 budget across different platforms.</p>
             ...
             <div className="space-y-6">
                <div>
                   <div className="flex justify-between mb-2">
                     ...
                     <span className="font-mono text-slate-600 dark:text-[#a1a1aa]">Rs. {budget.facebook.toLocaleString()}</span>
                   </div>
                ...
                <div>
                   <div className="flex justify-between mb-2">
                     ...
                     <span className="font-mono text-slate-600 dark:text-[#a1a1aa]">Rs. {budget.instagram.toLocaleString()}</span>
                   </div>
                ...
                <div>
                   <div className="flex justify-between mb-2">
                     ...
                     <span className="font-mono text-slate-600 dark:text-[#a1a1aa]">Rs. {budget.search.toLocaleString()}</span>
                   </div>
        ...
        <div className="w-1/2 bg-[#000000] dark:bg-[#121212] text-white p-12 flex flex-col relative bg-[url('https://www.transparenttextures.com/patterns/stardust.png')]">
           ...
           <h2 className="text-2xl font-bold text-slate-400 mb-8 border-b border-[#1c1b1b] dark:border-[#1c1b1b] pb-2">Live Campaign Analytics</h2>
           ...
           <div className="mt-auto">
             <h3 className="text-sm font-bold text-slate-500 dark:text-[#71717a] uppercase tracking-widest mb-4">Ad Creative Preview</h3>
             <div className="bg-slate-50 dark:!bg-[#121212] rounded-xl overflow-hidden shadow-2xl max-w-sm mx-auto">
                ...
                <div className="p-4 text-slate-800 dark:text-[#ffffff]">
                   ...
                   <button className="w-full py-2 bg-blue-600 text-white font-bold rounded dark:text-white dark:text-white dark:bg-blue-500 dark:hover:bg-blue-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-blue-500/40">Book Flight</button>
                </div>
             </div>
           </div>
