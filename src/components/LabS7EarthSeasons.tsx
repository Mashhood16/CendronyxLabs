...
export default function LabS7EarthSeasons({ onExit }: LabProps) {
 ...
 return (
 <div className="flex flex-col min- font-sans bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-[#ffffff] min-h-screen lg:h-screen overflow-x-hidden w-full">
