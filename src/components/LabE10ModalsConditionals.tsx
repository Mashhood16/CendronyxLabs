        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 flex flex-col h-full overflow-hidden">
            ...
            <div className="p-6 lg:overflow-y-auto flex-1 space-y-6 text-slate-700 dark:text-[#a1a1aa]">
              <section>
                <h3 className="text-lg font-bold text-slate-900 dark:text-[#ffffff] mb-2">Modal Verbs</h3>
          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-neutral-900 p-6 flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="bg-slate-100 dark:bg-[#121212] p-6 rounded-xl border border-slate-200 dark:border-[#1c1b1b] text-center mb-6 shadow-inner">
                <p className="text-xl font-bold text-slate-900 dark:text-[#ffffff]">
                  "{LOGIC_GATES[currentGate].ifClause}"
                </p>
              </div>

              <div className="space-y-3 flex-1 lg:overflow-y-auto">
                ...
                {LOGIC_GATES[currentGate].matches.map((match, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isAnswered && (isSelected || match.isCorrect) && (
                        <div className={`text-sm mt-2 p-2 rounded bg-white/50 dark:bg-[#121212]/50 ${
