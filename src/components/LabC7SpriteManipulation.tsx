...
export default function LabC7SpriteManipulation({ onExit }: LabProps) {
 ...
 <LabHeader onExit={onExit} title={t('lab.c7spritemanipulation_sprite_coordinate_manipulation')} />
 <div className="flex-1 px-8 pb-8 flex flex-col lg:overflow-y-auto items-center">

 <p className="text-slate-600 dark:text-[#a1a1aa] mb-8">{t('lab.c7spritemanipulation_change_the_x_and_y_coordinates')}</p>
 ...
 <h2 className="font-bold text-lg text-slate-700 dark:text-[#ffffff] mb-2">{t('lab.c7spritemanipulation_properties')}</h2>
 ...
 >
 <Play className="w-5 h-5 mr-2 fill-current" /> {t('lab.c7spritemanipulation_execute')}
 </button>
 
 <div className="mt-auto text-sm text-slate-500 dark:text-[#71717a]">
 <p className="mb-2"><strong>{t('lab.c7spritemanipulation_limits')}</strong></p>
 <ul className="list-disc pl-5">
 <li>{t('lab.c7spritemanipulation_x_ranges_from_240_to_240')}</li>
 <li>{t('lab.c7spritemanipulation_y_ranges_from_180_to_180')}</li>
 </ul>
 </div>
 </div>
 ...
 <span className="absolute top-2 text-xs font-bold text-slate-400">{t('lab.c7spritemanipulation_y_180')}</span>
 <span className="absolute bottom-2 text-xs font-bold text-slate-400">{t('lab.c7spritemanipulation_y_180_1')}</span>
 <span className="absolute left-2 text-xs font-bold text-slate-400">{t('lab.c7spritemanipulation_x_240')}</span>
 <span className="absolute right-2 text-xs font-bold text-slate-400">{t('lab.c7spritemanipulation_x_240_1')}</span>
 ...
 {t('lab.c7spritemanipulation_sprite')}
 </div>
 </div>
 </div>
 </div>
