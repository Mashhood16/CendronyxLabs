...
export default function LabM9SetsRelations({ onExit }: Props) {
 ...
 {/* Venn Diagram Area */}
 <div className={`relative w-full h-80 bg-slate-50 dark:bg-[#121212] rounded-lg border border-slate-200 dark:border-[#1c1b1b] flex items-center justify-center flex-col `}>
