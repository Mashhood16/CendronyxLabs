        ...
        <section className="w-full lg:w-1/2 flex flex-col p-6 overflow-y-auto border-r border-slate-200 dark:border-slate-700">
          ...
          {activeTab === "stage" && (
            <div className="max-w-xl mx-auto w-full space-y-8">
              ...
              {stageLog && (
                <div className={`p-4 rounded-xl flex items-start border-l-4 ${
                  stageLog.isError 
                  ...
                  return (
                    <div 
                      ...
                      className={`transition-all duration-300 p-3 rounded-xl ${
                        isActive 
                          ? 'bg-blue-100 dark:bg-blue-900/50 shadow-lg -translate-y-4' 
                          : 'bg-white dark:bg-slate-700 shadow opacity-50 grayscale hover:grayscale-0'
                      } ${isActionHappening ? 'animate-bounce border-2 border-green-500' : ''}`}
                    >
