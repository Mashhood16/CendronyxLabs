...
'bg-teal-700 text-white hover:bg-teal-600'}`}>
 ...
 <div className={`relative w-64 h-64 bg-slate-100 dark:bg-[#121212] rounded-full flex items-center justify-center border border-slate-300 dark:border-[#1c1b1b] shadow-inner flex-col `}>
