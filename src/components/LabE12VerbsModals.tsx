...
export default function LabE12VerbsModals({ onExit }: { onExit?: () => void }) {
 ...
 return (
  <div className="flex flex-col min- lg: bg-slate-50 dark:!bg-[#000000] font-sans select-none min-h-screen lg:h-screen overflow-x-hidden w-full">
   <LabHeader onExit={onExit} title={t('lab.e12verbsmodals_kinetic_engine_lab')} />
   ...
   <button 
    ...
    >
                      ...
                      {t('lab.e12verbsmodals_theory')}
                     </button>
   <button 
     onClick={() => setActiveMobileTab('lab')}
     className={`w-full py-3 text-sm font-bold rounded-xl transition-all text-center ${activeMobileTab === 'lab' ? 'bg-[#4158D1] text-white shadow-md' : 'bg-white dark:bg-[#1c1b1b] text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-gray-700'}`}
    >{t('lab.e12verbsmodals_lab')}</button>
  </div>
   ...
   <main className="flex-grow p-4 md:p-6 flex flex-col lg:grid lg:grid-cols-3 gap-0 lg:gap-6 lg:overflow-visible">
    ...
    <section className={`w-full rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#1c1b1b] flex-col ${activeMobileTab === 'theory' ? 'flex' : 'hidden'} lg:flex`}>
     <h2 className="text-xl font-bold text-slate-800 dark:text-[#ffffff] mb-4 flex items-center">
      <BookOpen className="mr-2 text-indigo-500" />  {t('lab.e12verbsmodals_grammar_theory')}
                          </h2>
     <div className="prose prose-sm text-slate-600 dark:text-[#a1a1aa] overflow-y-auto h-[500px] pr-2">
      <p>
       <strong>{t('lab.e12verbsmodals_verbs')}</strong>  {t('lab.e12verbsmodals_are_the_engine_of_a_sentence_t')}
                               </p>
      
      <h4 className="font-bold text-slate-800 dark:text-gray-200 mt-4">{t('lab.e12verbsmodals_transitivity_action_transfer')}</h4>
      <p className="mt-2">{t('lab.e12verbsmodals_transitivity_refers_to_whether')}</p>
      <ul className="list-disc pl-5 space-y-2 mt-2">
       <li><strong>{t('lab.e12verbsmodals_transitive')}</strong>  {t('lab.e12verbsmodals_the_action_transfers_to_a_dire')} <em>{t('lab.e12verbsmodals_kicked')}</em>  {t('lab.e12verbsmodals_the')} <strong>{t('lab.e12verbsmodals_ball')}</strong>).</li>
       <li><strong>{t('lab.e12verbsmodals_intransitive')}</strong>  {t('lab.e12verbsmodals_the_action_does_not_transfer_t')} <em>{t('lab.e12verbsmodals_rises')}</em>).</li>
       <li><strong>{t('lab.e12verbsmodals_ditransitive')}</strong>  {t('lab.e12verbsmodals_the_action_takes_two_objects_a')} <em>{t('lab.e12verbsmodals_gave')}</em> <strong>{t('lab.e12verbsmodals_him')}</strong> a <strong>{t('lab.e12verbsmodals_gift')}</strong>).</li>
      </ul>

      <hr className="my-6 border-slate-200 dark:border-gray-800" />

      <h4 className="font-bold text-slate-800 dark:text-gray-200 mt-4">{t('lab.e12verbsmodals_modal_auxiliaries')}</h4>
      <p className="mt-2">
       
                                {t('lab.e12verbsmodals_modal_verbs_help_the_main_verb')}
                               </p>
      <ul className="list-disc pl-5 space-y-2 mt-2">
       <li><strong>{t('lab.e12verbsmodals_must')}</strong>  {t('lab.e12verbsmodals_expresses_strong_obligation_or')}</li>
       <li><strong>{t('lab.e12verbsmodals_can')}</strong>  {t('lab.e12verbsmodals_expresses_physical_or_mental_a')}</li>
       <li><strong>{t('lab.e12verbsmodals_may')}</strong>  {t('lab.e12verbsmodals_expresses_permission_or_a_stro')}</li>
       <li><strong>{t('lab.e12verbsmodals_might')}</strong>  {t('lab.e12verbsmodals_expresses_a_weak_possibility_o')}</li>
      </ul>
     </div>
    </section>
    ...
    <section className={`w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b] lg:bg-slate-50 dark:bg-[#121212] lg:dark:bg-[#1c1b1b] rounded-xl shadow-sm p-6 border border-slate-200 dark:border-[#2a2a2a] lg:dark:border-[#2a2a2a] flex-col '' : ''} rounded-t-none lg:rounded-t-xl border-t-0 lg:border-t ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
     <h2 className="text-xl font-bold text-slate-800 dark:text-white flex items-center gap-2 mb-6">
      <Activity className="text-[#4158D1]" />  {t('lab.e12verbsmodals_kinetic_modulator')}
                          </h2>
     ...
     <div className="flex gap-2 mb-6">
      ...
      >
                                ...
                                {t('lab.e12verbsmodals_modal_stress_test')}
                               </button>
      <button 
      ...
      >
                                ...
                                {t('lab.e12verbsmodals_transitivity')}
                               </button>
     </div>
       ...
       <div className="space-y-6">
        <div className={`p-4 rounded-xl border border-slate-200 dark:border-[#2a2a2a] flex-col ${activeMobileTab === 'lab' ? 'flex' : 'hidden'} lg:flex`}>
         <h3 className="font-bold text-slate-800 dark:text-white flex items-center gap-2 mb-4">
          <ShieldAlert className="w-5 h-5 text-amber-500" />  {t('lab.e12verbsmodals_constraint_protocol')}
                                              </h3>
         
         <div className={`mb-6 p-4 bg-black/80 text-green-400 font-mono text-sm rounded-lg shadow-inner flex-col `}>
          <p>{t('lab.e12verbsmodals_gt_system_alert')} {modalConstraints[modalIndex].context}</p>
          <p className="mt-2 text-yellow-400">{t('lab.e12verbsmodals_gt_req_protocol')} {modalConstraints[modalIndex].requirement}</p>
         </div>
          ...
          <div className={`mt-6 p-4 rounded-lg font-bold text-center border-2 ${isModalCorrect ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 border-emerald-500' : 'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-red-500'}`}>
           ...
           {isModalCorrect && (
            ...
            >
                                                              ...
                                                              {t('lab.e12verbsmodals_next_protocol')}
                                                             </button>
           )}
          </div>
         )}
       ...
       <div className="space-y-6">
        <div className="p-4 rounded-xl border border-indigo-200 dark:border-[#2a2a2a]">
         <h3 className="font-bold text-indigo-800 dark:text-white flex items-center gap-2 mb-4">
          <Box className="w-5 h-5 text-indigo-500" />  {t('lab.e12verbsmodals_object_detector')}
                                              </h3>
         ...
         {selectedObject === actionScenarios[actionIndex].type && (
          ...
          >
                                                    ...
                                                    {t('lab.e12verbsmodals_next_action')}
                                                   </button>
         )}
        </div>
       </div>
    ...
    {/* Window 3: Simulation */}
    <section className={`w-full bg-[#111] rounded-xl shadow-sm border border-[#333] relative flex items-center justify-center p-8 lg:min-h-[35vh] lg:min-h-[500px] flex-col  'flex' : 'hidden'} lg:flex order-first lg:order-none rounded-b-none lg:rounded-b-xl border-b-0 lg:border-b`}>
     {/* Background Grid */}
     ...
     {activeMode === 'modals' && (
      <div className="relative w-full max-w-lg z-10">
       <h2 className="text-center font-mono text-gray-400 mb-4 tracking-widest">{t('lab.e12verbsmodals_certainty_meter_core')}</h2>
       ...
       <div className="h-64 w-32 mx-auto bg-black border-4 border-gray-800 rounded-2xl relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)]">
        ...
        <div className="absolute inset-y-0 right-0 w-4 flex flex-col justify-between py-2 pr-1 opacity-50 z-20">
         <div className="h-[1px] w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b]"></div>
         <div className="h-[1px] w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b]"></div>
         <div className="h-[1px] w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b]"></div>
         <div className="h-[1px] w-full bg-white dark:bg-[#121212] dark:border-[#1c1b1b]"></div>
        </div>
     ...
     {activeMode === 'transitivity' && (
      <div className="text-center z-10">
       ...
       <h2 className="text-3xl font-black tracking-widest text-gray-700 uppercase">{t('lab.e12verbsmodals_kinetic_transfer_offline')}</h2>
      </div>
     )}
