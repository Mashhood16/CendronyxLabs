            ...
            <div className="pt-4 border-t border-slate-200 dark:border-[#1c1b1b] space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                <input
                  ...
                  placeholder="e.g. 9.0"
                  className="flex-1 min-w-0 px-3 py-2 border border-slate-300 dark:border-[#1c1b1b] rounded-lg bg-white dark:bg-[#121212] text-slate-900 dark:text-[#ffffff]"
                />
  ...
  const renderSimulation = () => {
    switch (mode) {
      ...
      case 'compass-constructions':
        ...
        return (
          <svg viewBox="-100 -100 200 200" className="w-full h-full max-h-[60vh] bg-white dark:bg-[#121212] rounded-xl border border-slate-200 dark:border-[#1c1b1b]">
            <defs>
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:!bg-[#000000] font-sans select-none text-slate-900 dark:text-[#ffffff]">
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
        ...
        <div className="w-full lg:w-1/3 p-6 bg-white dark:bg-[#121212] shadow-lg lg:overflow-y-auto flex flex-col gap-6 border-r border-slate-200 dark:border-[#1c1b1b]">
          <div className="space-y-4">
