...
export default function LabS8ConservationMass({ onExit }: LabProps) {
 ...
 <div className="bg-slate-50 dark:!bg-[#121212] p-8 rounded-3xl shadow-lg border border-slate-200 dark:border-[#1c1b1b] max-w-2xl w-full flex flex-col items-center relative ">
