          ...
          <div className="bg-white dark:!bg-[#121212] rounded-2xl shadow-sm border border-slate-200 dark:border-[#1c1b1b]/50 dark:border-[#1c1b1b] overflow-hidden flex flex-col h-[calc(100vh-8rem)] relative">
            ...
            <div className="p-6 flex-1 flex flex-col justify-center relative z-10 lg:overflow-y-auto">
              <div className="flex flex-col items-center gap-4 mb-8">
                ...
                <div className="w-full bg-slate-100 dark:bg-[#121212] dark:bg-slate-700 border-2 border-slate-300 dark:border-[#1c1b1b] rounded-xl p-6 flex flex-col justify-center text-center shadow-inner relative">
                  <span className="text-xs font-bold text-slate-400 dark:text-[#a1a1aa] uppercase tracking-widest absolute top-3 left-0 w-full">Dependent Clause</span>
              ...
              {result !== 'idle' && (
                <div className={`mt-8 flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl animate-in fade-in zoom-in duration-300 gap-4 ${
                  ...
                  {result === 'success' && (
                    <button onClick={nextCollider} className="w-full sm:w-auto px-4 py-2 bg-green-600 hover:bg-green-50 text-white font-bold rounded-lg transition-colors whitespace-nowrap flex items-center justify-center gap-2 dark:text-white dark:text-white dark:bg-green-500 dark:hover:bg-green-400 dark:text-white dark:border-transparent dark:shadow-lg dark:shadow-green-500/40">
