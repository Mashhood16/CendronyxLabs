...
export default function LabE6SentencesAffixes({ onExit }: { onExit?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-slate-50 dark:bg-slate-950 font-sans select-none text-slate-900 dark:text-slate-100">
      {/* Header */}
      <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 shadow-sm border-b border-slate-200 dark:border-slate-800 z-10">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 truncate">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-1/3 p-6 overflow-y-auto border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-[2px_0_8px_-4px_rgba(0,0,0,0.1)] z-0">
        ...
        <div className="w-full lg:w-2/3 p-4 sm:p-8 overflow-y-auto bg-slate-50 dark:bg-slate-950 flex flex-col relative items-center justify-center">
          ...
          {activeTab === 'affixes' ? (
            <div className="w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center">
              ...
              {affixFeedback && (
                <div className={`w-full p-4 rounded-xl flex items-center justify-center space-x-3 text-lg font-medium animate-in fade-in slide-in-from-bottom-4 ${
                  affixFeedback.type === 'success' ? 'bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300' :
                  affixFeedback.type === 'error' ? 'bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300' :
            ...
            <div className="w-full max-w-3xl bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col items-center">
              ...
              {puncFeedback && (
                <div className={`w-full p-4 rounded-xl flex items-center justify-center space-x-3 text-lg font-medium animate-in fade-in slide-in-from-bottom-4 ${
                  puncFeedback.type === 'success' ? 'bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300' :
