        ...
        <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg">
          ...
          <div className="relative z-10 px-6 py-8 md:px-10 md:py-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Class 12 Physics</h1>
                <p className="text-white/80 text-sm">Gravitation, SHM, Diffraction, AC, Quantum & Nuclear Physics — with derivation-focused interactive labs</p>
              </div>
            </div>
          </div>
        </div>
                      ...
                      >
                        ...
                        <div className="p-6 flex-1 flex flex-col bg-transparent">
                          ...
                          <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                            ...
                            {isBuilt ? (
                              <span className="text-xs font-bold text-white px-3 py-1.5 rounded-lg bg-gradient-to-r from-purple-500 to-violet-600 group-hover:scale-105 transition-transform inline-flex items-center gap-1">Launch <ArrowRight className="w-3 h-3" /></span>
                            ) : (
