          ...
          <div className="relative z-10 px-6 py-8 md:px-10 md:py-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">{t("Gravitation, SHM, Diffraction, AC, Quantum & Nuclear Physics â€” with derivation-focused interactive labs")}</p>
              </div>
            </div>
          </div>
        </div>
