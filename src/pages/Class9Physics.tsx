        ...
        <div className={`flex gap-2 mb-6 ${theme.innerCard.bg} border ${theme.innerCard.border} p-1.5 rounded-xl w-full sm:w-fit`}>
          <button
            ...
            className={`flex flex-1 sm:flex-none justify-center items-center gap-2 px-3 sm:px-5 py-2.5 text-sm font-bold rounded-lg transition-all ${
              activeTab === 'labs' ? `${theme.card.bg} text-indigo-600 dark:text-indigo-400 shadow-sm` : `${theme.text.subtle} hover:text-indigo-600 dark:hover:text-indigo-400`
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-1 sm:flex-none justify-center items-center gap-2 px-3 sm:px-5 py-2.5 text-sm font-bold rounded-lg transition-all ${
              activeTab === 'derivations' ? `${theme.card.bg} text-indigo-600 dark:text-indigo-400 shadow-sm` : `${theme.text.subtle} hover:text-indigo-600 dark:hover:text-indigo-400`
            }`}
          >
