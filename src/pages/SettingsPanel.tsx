  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto space-y-6">          <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-800 font-outfit tracking-tight">{t('settings.title')}</h1>
            <p className="text-slate-500 text-sm md:text-base">{t('settings.subtitle')}</p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 dark:bg-[#000000] dark:border-[#1c1b1b]">
          ...
          {user ? (
                ...
                <div className="flex-1">
                  {isEditing ? (
                    <div className="flex gap-2">
                      ...
                      <button onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-100 text-slate-600 text-sm font-semibold rounded-xl hover:bg-slate-200 transition-colors">{t('settings.cancel')}</button>
                    </div>
                  ) : (
            ...
            <div className="text-center py-4">
              <p className="text-slate-500 mb-3">{t('settings.not_signed_in')}</p>
        ...
        <div className="bg-slate-50 rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 dark:bg-[#000000] dark:border-[#1c1b1b]">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600">{t('settings.theme')}</span>
            ...
            {storageInfo && (
              <div className="bg-slate-50 rounded-xl p-4 dark:bg-[#000000] dark:border-[#1c1b1b]">
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-slate-600">{t('settings.storage_used')}</span>
                  <span className="font-semibold text-slate-800">{t('settings.local_storage_used', { used: storageInfo.used, total: storageInfo.total })}</span>
                </div>
        ...
        <div className="bg-slate-50 rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 dark:bg-[#000000] dark:border-[#1c1b1b]">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between bg-slate-50 rounded-xl p-4 dark:bg-[#000000] dark:border-[#1c1b1b]">
              <div>
                <p className="text-sm font-semibold text-slate-800">{t('settings.pending_records')}</p>
                <p className="text-xs text-slate-500">{t('settings.waiting_to_sync', { count: unsyncedCount })}</p>
              </div>
        ...
        <div className="bg-slate-50 rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 dark:bg-[#000000] dark:border-[#1c1b1b]">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600">{t('settings.font_size')}</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600">{t('settings.reduce_animations')}</span>
              <button
