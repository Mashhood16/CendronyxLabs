...
export default function Class12Math() {
        ...
        <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg">
          ...
          <div className="relative z-10 px-6 py-8 md:px-10 md:py-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Class 12 Mathematics</h1>
                <p className="text-white/80 text-sm">Calculus, Differential Equations, Analytical Geometry & Conics — with interactive labs and step-by-step theorem proofs</p>
              </div>
            </div>
          </div>
        </div>
                      ...
                      >
                        ...
                        <div className="p-6 flex-1 flex flex-col bg-transparent">
                          ...
                          <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                            ...
                            {isBuilt ? (
                              <span className="text-xs font-bold text-white px-3 py-1.5 rounded-lg bg-gradient-to-r from-violet-500 to-indigo-600 group-hover:scale-105 transition-transform inline-flex items-center gap-1">Launch <ArrowRight className="w-3 h-3" /></span>
                            ) : (
          ...
          <div className="flex-1">
            {theoremModules.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 glass rounded-2xl border border-dashed border-slate-200/50 dark:border-neutral-900/50">
                ...
                <p className="text-slate-500 max-w-md text-center">We are developing interactive theorem proofs for Class 12 Mathematics. Check back soon!</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                          ...
                          {isBuilt ? (
                            <span className="text-xs font-bold text-white px-3 py-1.5 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 group-hover:scale-105 transition-transform inline-flex items-center gap-1">
                              Start Theorem <ArrowRight className="w-3 h-3" />
                            </span>
                          ) : (
                            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Soon</span>
                          )}
