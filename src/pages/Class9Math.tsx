        ...
        <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg">
          ...
          <div className="relative z-10 px-6 py-8 md:px-10 md:py-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Class 9 Mathematics</h1>
                <p className="text-white/80 text-sm">Algebra, Geometry, Statistics & Problem Solving — with interactive labs and step-by-step theorem walkthroughs</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1">
            {theoremModules.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 glass rounded-2xl border border-dashed border-slate-200/50 dark:border-neutral-900/50">
                ...
                <p className="text-slate-500 max-w-md text-center">We are developing interactive theorem walkthroughs for Class 9 Mathematics. Check back soon!</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
