        ...
        <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg">
          ...
          <div className="relative z-10 px-6 py-8 md:px-10 md:py-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Class 11 Physics</h1>
                <p className="text-white/80 text-sm">Measurements, Vectors, Motion, Fluids, Thermodynamics, Waves & Electricity — with derivation-focused interactive labs</p>
              </div>
            </div>
          </div>
        </div>
